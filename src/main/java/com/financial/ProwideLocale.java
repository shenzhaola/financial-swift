...
public final class ProwideLocale {
    ...
    /**
     * Get requested bundle or ENGLISH if missing resource for the given locale. Uses the calss FQN (with package) for
     ...
     * @param locale a locale
     * @return the bundle for the given resource name and locale or English if not found.
     * @since 7.9.7
     */
