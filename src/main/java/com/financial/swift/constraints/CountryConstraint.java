 ...
 */
package com.financial.swift.constraints;
 ...
 * the field is optional. If you require a country code to be mandatory, combine this
 * constraint with @NotBlank.
 *
 * @see com.financial.swift.utils.IsoUtils#isValidISOCountry(String) for implementation details
 * @since 7.10.3
 */
@Documented
