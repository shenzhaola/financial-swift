...
import com.financial.swift.model.mx.MxRead;
import com.financial.swift.model.mx.MxWrite;
...
public class Resolver {
	...
	public static MxWrite mxWrite() {
		try {
			return (MxWrite) Class.forName("com.financial.swift.model.mx.MxWriteIntegartorV1").newInstance();
	...
	public static MxRead mxRead() {
		try {
			return (MxRead) Class.forName("com.financial.swift.model.mx.MxReadIntegratorV1").newInstance();
		} catch (Exception ignored) {
