...
/**
 * <strong>MT 536 - Statement of Transactions</strong>
 *
 * <p>
 * SWIFT MT536 (ISO 15022) message structure:
 * <br>
 <div class="scheme"><ul>
<li class="sequence">
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT536 content, the parameter can not be null
	 * @see #MT536(String)
	 */
	...
	*/
	...
	public MT536(final int messageType, final String sender, final String receiver) {
		super(536, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT536(int, String, String)", "Use the constructor MT536(sender, receiver) instead.");
	}
    ...
    /**
	 * Creates an MT536 messages from its JSON representation.
	 * <p>
	 * For generic conversion of JSON into the corresopnding MT instance
	 * see {@link AbstractMT#fromJson(String)}
	 *
	 * @param json a JSON representation of an MT536 message
	 * @return a new instance of MT536
	 * @since 7.10.3
	 */
	public final static MT536 fromJson(String json) {
		return (MT536) AbstractMT.fromJson(json);
	}
...
// BaseSequenceCodeGenerator [seq=A]
	/**
	 * Class to model Sequence "A" in MT 536
	 */
...
// BaseSequenceCodeGenerator [seq=A1]
	/**
	 * Class to model Sequence "A1" in MT 536
	 */
	@SequenceStyle(Type.GENERATED_16RS)
    ...
    * @see com.financial.swift.model.mt.SequenceUtils
	...
	public List<SequenceA1> getSequenceA1List() {
		...
		return com.financial.swift.model.mt.SequenceUtils.resolveMT536GetSequenceA1List_sru2018(this);
	}
	/**
	 * Get the list of SequenceA1 delimited by 16R/16S with value specified in SequenceA1#START_END_16RS
	 * The presence of this method indicates that this sequence can occur more than once according to the Standard.
    ...
    * @see com.financial.swift.model.mt.SequenceUtils
	...
	public static List<SequenceA1> getSequenceA1List(final SwiftTagListBlock parentSequence) {
		 ...
		 * So we call a special method to resolve this situation until we find a better approach.
		 */
		return com.financial.swift.model.mt.SequenceUtils.resolveMT536GetSequenceA1List_sru2018(new MT536().append(parentSequence));
...
// BaseSequenceCodeGenerator [seq=B]
	/**
	 * Class to model Sequence "B" in MT 536
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=B1]
	/**
	 * Class to model Sequence "B1" in MT 536
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=B1a]
	/**
	 * Class to model Sequence "B1a" in MT 536
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=B1a1]
	/**
	 * Class to model Sequence "B1a1" in MT 536
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	@com.financial.swift.internal.NonUniqueSeparator
    ...
    * @see com.financial.swift.model.mt.SequenceUtils
	...
	public List<SequenceB1a1> getSequenceB1a1List() {
		...
		return com.financial.swift.model.mt.SequenceUtils.resolveMT536GetSequenceB1a1List_sru2018(this);
	}
	/**
	 * Get the list of SequenceB1a1 delimited by 16R/16S with value specified in SequenceB1a1#START_END_16RS
	 * The presence of this method indicates that this sequence can occur more than once according to the Standard.
    ...
    * @see com.financial.swift.model.mt.SequenceUtils
	...
	public static List<SequenceB1a1> getSequenceB1a1List(final SwiftTagListBlock parentSequence) {
		 ...
		 * So we call a special method to resolve this situation until we find a better approach.
		 */
		return com.financial.swift.model.mt.SequenceUtils.resolveMT536GetSequenceB1a1List_sru2018(new MT536().append(parentSequence));
...
// BaseSequenceCodeGenerator [seq=B1a2]
	/**
	 * Class to model Sequence "B1a2" in MT 536
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=B1a2A]
	/**
	 * Class to model Sequence "B1a2A" in MT 536
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	 ...
	 * The presence of this method indicates that this sequence can occur more than once according to the Standard.
	 * @see SequenceB1a2A#START_END_16RS
	 * @param parentSequence an optional parent sequence or null to find SequenceB1a2A within the complete message
	 * @return the found sequences or an empty list if none is found
	 * @since 7.7
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=C]
	/**
	 * Class to model Sequence "C" in MT 536
	 */
	@SequenceStyle(Type.GENERATED_16RS)
