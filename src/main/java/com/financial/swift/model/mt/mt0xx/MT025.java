...
/**
 * <strong>MT 025 - Bulk Retrieval Response</strong>
 *
 * <p>
 * SWIFT MT025 (ISO 15022) message structure:
 * <br>
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT025 content, the parameter can not be null
	 * @see #MT025(String)
	 */
	...
	*/
	...
	public MT025(final int messageType, final String sender, final String receiver) {
		super(25, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT025(int, String, String)", "Use the constructor MT025(sender, receiver) instead.");
	}
