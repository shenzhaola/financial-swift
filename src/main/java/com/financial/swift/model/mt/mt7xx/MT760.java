...
// end qualifiers constants	
	...
	*/
	...
	public MT760(final int messageType, final String sender, final String receiver) {
		super(760, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT760(int, String, String)", "Use the constructor MT760(sender, receiver) instead.");
	}
	 ...
	 * @since 7.10.3
	 */
	public final static MT760 fromJson(String json) {
	 ...
	 * 
	 * @return a Field40C object or null if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
