...
// end qualifiers constants	
    ...
    * @param sender the sender address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @param receiver the receiver address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @see #MT305(String, String)
	* @deprecated Use instead <code>new MT305(sender, receiver)</code> instead
	*/
	@Deprecated
	@com.financial.deprecation.ProwideDeprecated(phase4=com.financial.deprecation.TargetYear._2019)
	public MT305(final int messageType, final String sender, final String receiver) {
		super(305, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT305(int, String, String)", "Use the constructor MT305(sender, receiver) instead.");
	}
