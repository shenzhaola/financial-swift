...
// end qualifiers constants	
	...
	*/
	...
	public MT028(final int messageType, final String sender, final String receiver) {
		super(28, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT028(int, String, String)", "Use the constructor MT028(sender, receiver) instead.");
	}
	 ...
	 * @since 7.10.3
	 */
	public final static MT028 fromJson(String json) {
