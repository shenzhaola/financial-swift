...
/**
 * <strong>MT 543 - Deliver Against Payment Instruction</strong>
 *
 * <p>
 * SWIFT MT543 (ISO 15022) message structure:
 * <br>
 <div class="scheme"><ul>
<li class="sequence">
...
<li class="fieldset">
Fieldset 22
 (M) (repetitive)<ul><li>FieldsetItem 22 F (O) (repetitive)</li><li>FieldsetItem 22 F (M)</li><li>FieldsetItem 22 F (O)</li><li>FieldsetItem 22 F (O)</li><li>FieldsetItem 22 F (O)</li><li>FieldsetItem 22 F (O)</li><li>FieldsetItem 22 F (O)</li><li>FieldsetItem 22 F (O)</li><li>FieldsetItem 22 F (O)</li><li>FieldsetItem 22 F (O)</li><li>FieldsetItem 22 F (O)</li><li>FieldsetItem 22 F (O)</li><li>FieldsetItem 22 F (O)</li><li>FieldsetItem 22 F (O)</li><li>FieldsetItem 22 F (O)</li><li>FieldsetItem 22 F (O)</li><li>FieldsetItem 22 F (O)</li><li>FieldsetItem 22 F (O)</li><li>FieldsetItem 22 F (O) (repetitive)</li><li>FieldsetItem 22 F (O)</li><li>FieldsetItem 22 F (O)</li><li>FieldsetItem 22 F (O)</li><li>FieldsetItem 22 F (O)</li><li>FieldsetItem 22 F (O)</li><li>FieldsetItem 22 F (O)</li></ul></li><li class="sequence">
Sequence E1 - Settlement Parties (M) (repetitive)<ul><li class="field">Field 16 R (M)</li>
<li class="fieldset">
Fieldset 95
 (M) (repetitive)<ul><li>FieldsetItem 95 P,Q,R,C (M)</li><li>FieldsetItem 95 L,S (O)</li></ul></li><li class="field">Field 97 A,B (O)</li>
 ...
 */
@Generated
public class MT543 extends AbstractMT implements Serializable {
	/**
	 * Constant identifying the SRU to which this class belongs to.
	 */
	public static final int SRU = 2018;
	private static final long serialVersionUID = 1L;
	private static final transient java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT543.class.getName());
	
	/**
	* Constant for MT name, this is part of the classname, after <code>MT</code>
	*/
	public static final String NAME = "543";
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT543 content
	 */
	public MT543(SwiftMessage m) {
		super(m);
		sanityCheck(m);
	}
	 ...
	 * @param m swift message with the MT543 content, the parameter can not be null
	 * @see #MT543(String)
	 */
	public MT543(MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT543 parse(MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT543(m);
	...
	/**
	 * Creates and initializes a new MT543 input message setting TEST BICS as sender and receiver.<br>
	...
	/**
	 * Creates and initializes a new MT543 input message from sender to receiver.<br>
	 * All mandatory header attributes are completed with default values. 
	 ...
	 * @since 7.7
	 */
	public MT543(final String sender, final String receiver) {
		super(543, sender, receiver);
	}
    ...
    * @param sender the sender address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @param receiver the receiver address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @see #MT543(String, String)
	* @deprecated Use instead <code>new MT543(sender, receiver)</code> instead
	*/
	@Deprecated
	@com.financial.deprecation.ProwideDeprecated(phase4=com.financial.deprecation.TargetYear._2019)
	public MT543(final int messageType, final String sender, final String receiver) {
		super(543, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT543(int, String, String)", "Use the constructor MT543(sender, receiver) instead.");
	}
	
	/**
	 * Creates a new MT543 by parsing a String with the message content in its swift FIN format.<br>
    ...
    private void sanityCheck(final SwiftMessage param) {
    	if (param.isServiceMessage()) {
			log.warning("Creating an MT543 object from FIN content with a Service Message. Check if the MT543 you are intended to read is prepended with and ACK.");
		} else if (!StringUtils.equals(param.getType(), getMessageType())) {
			log.warning("Creating an MT543 object from FIN content with message type "+param.getType());
		}
    }
	
	/**
	 * Creates a new MT543 by parsing a String with the message content in its swift FIN format.<br>
	 * If the fin parameter cannot be parsed, the returned MT543 will have its internal message object
	 * initialized (blocks will be created) but empty.<br>
	 * If the string contains multiple messages, only the first one will be parsed. 
	 *
	 * @param fin a string with the MT message in its FIN swift format. <em>fin may be null in which case this method returns null</em>
	 * @return a new instance of MT543 or null if fin is null 
	 * @since 7.7
	 */
	public static MT543 parse(final String fin) {
		if (fin == null) {
			return null;
		}
		return new MT543(fin);
    }
    
    /**
	 * Creates a new MT543 by parsing a input stream with the message content in its swift FIN format, using "UTF-8" as encoding.<br>
	 ...
	 * @since 7.7
	 */
	public MT543(final InputStream stream) throws IOException {
	 ...
	 *
	 * @param stream an input stream in UTF-8 encoding with the MT message in its FIN swift format.
	 * @return a new instance of MT543 or null if stream is null or the message cannot be parsed 
	 * @throws IOException if the stream data cannot be read
	 * @since 7.7
	 */
	public static MT543 parse(final InputStream stream) throws IOException {
		if (stream == null) {
			return null;
		}
		return new MT543(stream);
    }
    
    /**
	 * Creates a new MT543 by parsing a file with the message content in its swift FIN format.<br>
	 ...
	 * @since 7.7
	 */
	public MT543(final File file) throws IOException {
	 ...
	 *
	 * @param file a file with the MT message in its FIN swift format.
	 * @return a new instance of MT543 or null if; file is null, does not exist, can't be read, is not a file or the message cannot be parsed
	 * @throws IOException if the file content cannot be read
	 * @since 7.7
	 */
	public static MT543 parse(final File file) throws IOException {
		if (file == null) {
			return null;
		}
		return new MT543(file);
    }
	 ...
	 */
	@Override
	public MT543 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT543 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT543 append(final Field ... fields) {
		super.append(fields);
		return this;
	}

    /**
	 * Creates an MT543 messages from its JSON representation.
	 * <p>
	 * For generic conversion of JSON into the corresopnding MT instance
	 * see {@link AbstractMT#fromJson(String)}
	 *
	 * @param json a JSON representation of an MT543 message
	 * @return a new instance of MT543
	 * @since 7.10.3
	 */
	public final static MT543 fromJson(String json) {
		return (MT543) AbstractMT.fromJson(json);
	}
...
// BaseSequenceCodeGenerator [seq=A]
	/**
	 * Class to model Sequence "A" in MT 543
	 */
...
// BaseSequenceCodeGenerator [seq=A1]
	/**
	 * Class to model Sequence "A1" in MT 543
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=B]
	/**
	 * Class to model Sequence "B" in MT 543
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=B1]
	/**
	 * Class to model Sequence "B1" in MT 543
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=C]
	/**
	 * Class to model Sequence "C" in MT 543
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=C1]
	/**
	 * Class to model Sequence "C1" in MT 543
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=D]
	/**
	 * Class to model Sequence "D" in MT 543
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=E]
	/**
	 * Class to model Sequence "E" in MT 543
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=E1]
	/**
	 * Class to model Sequence "E1" in MT 543
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=E2]
	/**
	 * Class to model Sequence "E2" in MT 543
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=E3]
	/**
	 * Class to model Sequence "E3" in MT 543
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	 ...
	 * The presence of this method indicates that this sequence can occur more than once according to the Standard.
	 * @see SequenceE3#START_END_16RS
	 * @param parentSequence an optional parent sequence or null to find SequenceE3 within the complete message
	 * @return the found sequences or an empty list if none is found
	 * @since 7.7
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=F]
	/**
	 * Class to model Sequence "F" in MT 543
	 */
	@SequenceStyle(Type.GENERATED_16RS)
