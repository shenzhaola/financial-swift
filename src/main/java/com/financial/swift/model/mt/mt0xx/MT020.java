...
<li class="sequence">
Sequence _A - GPA or FIN choices (O)<ul><li class="sequence">
 ...
 */
@Generated
public class MT020 extends AbstractMT implements Serializable {
	/**
...
// end qualifiers constants	
	 ...
	 * @since 7.7
	 */
	public MT020(final String sender, final String receiver) {
		super(20, sender, receiver);
	}
    ...
    * @param sender the sender address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @param receiver the receiver address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @see #MT020(String, String)
	* @deprecated Use instead <code>new MT020(sender, receiver)</code> instead
	*/
	@Deprecated
	@com.financial.deprecation.ProwideDeprecated(phase4=com.financial.deprecation.TargetYear._2019)
	public MT020(final int messageType, final String sender, final String receiver) {
		super(20, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT020(int, String, String)", "Use the constructor MT020(sender, receiver) instead.");
	}
	 ...
	 * @return a new instance of MT020 or null if fin is null 
	 * @since 7.7
	 */
	public static MT020 parse(final String fin) {
		if (fin == null) {
			return null;
		}
		return new MT020(fin);
    }
	 ...
	 * @since 7.7
	 */
	public MT020(final InputStream stream) throws IOException {
	 ...
	 *
	 * @param stream an input stream in UTF-8 encoding with the MT message in its FIN swift format.
	 * @return a new instance of MT020 or null if stream is null or the message cannot be parsed 
	 * @throws IOException if the stream data cannot be read
	 * @since 7.7
	 */
	public static MT020 parse(final InputStream stream) throws IOException {
		if (stream == null) {
			return null;
		}
		return new MT020(stream);
    }
	 ...
	 * @since 7.7
	 */
	public MT020(final File file) throws IOException {
	 ...
	 *
	 * @param file a file with the MT message in its FIN swift format.
	 * @return a new instance of MT020 or null if; file is null, does not exist, can't be read, is not a file or the message cannot be parsed
	 * @throws IOException if the file content cannot be read
	 * @since 7.7
	 */
	public static MT020 parse(final File file) throws IOException {
		if (file == null) {
			return null;
		}
		return new MT020(file);
    }
	 ...
	 */
	@Override
	public MT020 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 * @since 7.10.3
	 */
	public final static MT020 fromJson(String json) {
