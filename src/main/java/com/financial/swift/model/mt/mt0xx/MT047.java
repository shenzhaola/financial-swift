...
// end qualifiers constants	
	...
	*/
	...
	public MT047(final int messageType, final String sender, final String receiver) {
		super(47, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT047(int, String, String)", "Use the constructor MT047(sender, receiver) instead.");
	}
    ...
    /**
	 * Creates an MT047 messages from its JSON representation.
	 * <p>
