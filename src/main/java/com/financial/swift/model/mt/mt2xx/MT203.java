...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT203 content, the parameter can not be null
	 * @see #MT203(String)
	 */
	...
	*/
	...
	public MT203(final int messageType, final String sender, final String receiver) {
		super(203, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT203(int, String, String)", "Use the constructor MT203(sender, receiver) instead.");
	}
