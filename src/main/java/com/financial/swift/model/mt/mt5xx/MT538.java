...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT538 content, the parameter can not be null
	 * @see #MT538(String)
	 */
	...
	*/
	...
	public MT538(final int messageType, final String sender, final String receiver) {
		super(538, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT538(int, String, String)", "Use the constructor MT538(sender, receiver) instead.");
	}
    ...
    private void sanityCheck(final SwiftMessage param) {
    	if (param.isServiceMessage()) {
			...
			log.warning("Creating an MT538 object from FIN content with message type "+param.getType());
		}
    }
...
// BaseSequenceCodeGenerator [seq=A1]
    ...
    * @see com.financial.swift.model.mt.SequenceUtils
	...
	public List<SequenceA1> getSequenceA1List() {
		...
		return com.financial.swift.model.mt.SequenceUtils.resolveMT538GetSequenceA1List_sru2018(this);
	}
	/**
	 * Get the list of SequenceA1 delimited by 16R/16S with value specified in SequenceA1#START_END_16RS
	 * The presence of this method indicates that this sequence can occur more than once according to the Standard.
    ...
    * @see com.financial.swift.model.mt.SequenceUtils
	...
	public static List<SequenceA1> getSequenceA1List(final SwiftTagListBlock parentSequence) {
		 ...
		 * So we call a special method to resolve this situation until we find a better approach.
		 */
		return com.financial.swift.model.mt.SequenceUtils.resolveMT538GetSequenceA1List_sru2018(new MT538().append(parentSequence));
...
// BaseSequenceCodeGenerator [seq=B2a1]
    ...
    * @see com.financial.swift.model.mt.SequenceUtils
	...
	public List<SequenceB2a1> getSequenceB2a1List() {
		...
		return com.financial.swift.model.mt.SequenceUtils.resolveMT538GetSequenceB2a1List_sru2018(this);
	}
	/**
	 * Get the list of SequenceB2a1 delimited by 16R/16S with value specified in SequenceB2a1#START_END_16RS
	 * The presence of this method indicates that this sequence can occur more than once according to the Standard.
    ...
    * @see com.financial.swift.model.mt.SequenceUtils
	...
	public static List<SequenceB2a1> getSequenceB2a1List(final SwiftTagListBlock parentSequence) {
		 ...
		 * So we call a special method to resolve this situation until we find a better approach.
		 */
		return com.financial.swift.model.mt.SequenceUtils.resolveMT538GetSequenceB2a1List_sru2018(new MT538().append(parentSequence));
