...
// end qualifiers constants	
	...
	*/
	...
	public MT742(final int messageType, final String sender, final String receiver) {
		super(742, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT742(int, String, String)", "Use the constructor MT742(sender, receiver) instead.");
	}
	 ...
	 * @since 7.10.3
	 */
	public final static MT742 fromJson(String json) {
