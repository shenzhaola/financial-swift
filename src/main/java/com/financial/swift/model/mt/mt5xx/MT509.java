...
/**
 * <strong>MT 509 - Trade Status Message</strong>
 *
 * <p>
...
<li class="fieldset">
Fieldset 98
 (O)<ul><li>FieldsetItem 98 A,C (O)</li><li>FieldsetItem 98 A,C (O)</li><li>FieldsetItem 98 A,C (O)</li><li>FieldsetItem 98 A (O)</li><li>FieldsetItem 98 A (O)</li></ul></li><li class="field">Field 11 A (O)</li>
<li class="fieldset">
Fieldset 22
...
<li class="fieldset">
Fieldset 36
 (O)<ul><li>FieldsetItem 36 B (O)</li><li>FieldsetItem 36 B (O)</li><li>FieldsetItem 36 B (O)</li><li>FieldsetItem 36 B (O)</li><li>FieldsetItem 36 B (O)</li><li>FieldsetItem 36 B (O)</li></ul></li><li class="field">Field 35 B (M)</li>
<li class="field">Field 16 S (M)</li>
</ul></li>
<li class="sequence">
...
// end qualifiers constants	
	...
	* @deprecated Use instead <code>new MT509(sender, receiver)</code> instead
	*/
	@Deprecated
	@com.financial.deprecation.ProwideDeprecated(phase4=com.financial.deprecation.TargetYear._2019)
	public MT509(final int messageType, final String sender, final String receiver) {
		super(509, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT509(int, String, String)", "Use the constructor MT509(sender, receiver) instead.");
	}
	 ...
	 * @since 7.10.3
	 */
	public final static MT509 fromJson(String json) {
