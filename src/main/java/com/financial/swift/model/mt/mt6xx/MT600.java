...
// end qualifiers constants	
	...
	*/
	...
	public MT600(final int messageType, final String sender, final String receiver) {
		super(600, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT600(int, String, String)", "Use the constructor MT600(sender, receiver) instead.");
	}
