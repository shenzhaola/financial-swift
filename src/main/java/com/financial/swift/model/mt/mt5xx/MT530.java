...
// end qualifiers constants	
	...
	*/
	...
	public MT530(final int messageType, final String sender, final String receiver) {
		super(530, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT530(int, String, String)", "Use the constructor MT530(sender, receiver) instead.");
	}
