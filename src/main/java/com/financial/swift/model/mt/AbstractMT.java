...
import com.financial.swift.io.IConversionService;
...
public abstract class AbstractMT extends AbstractMessage implements JsonSerializable {
	 ...
	 * @see com.financial.swift.model.SwiftBlock2#getMessagePriority()
	 */
	 ...
	 */
    @Deprecated
    @com.financial.deprecation.ProwideDeprecated(phase2=com.financial.deprecation.TargetYear._2019)
	public String json() {
