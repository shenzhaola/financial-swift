...
// end qualifiers constants	
	...
	* @deprecated Use instead <code>new MT320(sender, receiver)</code> instead
	*/
	@Deprecated
	@com.financial.deprecation.ProwideDeprecated(phase4=com.financial.deprecation.TargetYear._2019)
	public MT320(final int messageType, final String sender, final String receiver) {
		super(320, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT320(int, String, String)", "Use the constructor MT320(sender, receiver) instead.");
	}
	 ...
	 * @since 7.10.3
	 */
	public final static MT320 fromJson(String json) {
