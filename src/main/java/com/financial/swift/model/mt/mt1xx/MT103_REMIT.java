...
// end qualifiers constants	
	...
	public MT103_REMIT(final String sender, final String receiver) {
		...
		m.setVariant(com.financial.swift.model.mt.MTVariant.REMIT);
	...
	*/
	...
	public MT103_REMIT(final int messageType, final String sender, final String receiver) {
		super(103, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT103_REMIT(int, String, String)", "Use the constructor MT103_REMIT(sender, receiver) instead.");
	}
