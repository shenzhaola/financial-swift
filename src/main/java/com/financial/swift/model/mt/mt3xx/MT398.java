...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT398 content, the parameter can not be null
	 * @see #MT398(String)
	 */
	...
	*/
	...
	public MT398(final int messageType, final String sender, final String receiver) {
		super(398, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT398(int, String, String)", "Use the constructor MT398(sender, receiver) instead.");
	}
    ...
    private void sanityCheck(final SwiftMessage param) {
    	if (param.isServiceMessage()) {
			...
			log.warning("Creating an MT398 object from FIN content with message type "+param.getType());
		}
    }
	 ...
	 *
	 * @param json a JSON representation of an MT398 message
	 * @return a new instance of MT398
	 * @since 7.10.3
	 */
	public final static MT398 fromJson(String json) {
