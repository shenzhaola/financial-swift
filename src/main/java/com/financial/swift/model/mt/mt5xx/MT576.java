...
// end qualifiers constants	
	...
	* @deprecated Use instead <code>new MT576(sender, receiver)</code> instead
	*/
	@Deprecated
	@com.financial.deprecation.ProwideDeprecated(phase4=com.financial.deprecation.TargetYear._2019)
	public MT576(final int messageType, final String sender, final String receiver) {
		super(576, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT576(int, String, String)", "Use the constructor MT576(sender, receiver) instead.");
	}
...
// BaseSequenceCodeGenerator [seq=A1]
    ...
    * @see com.financial.swift.model.mt.SequenceUtils
	...
	public List<SequenceA1> getSequenceA1List() {
		...
		return com.financial.swift.model.mt.SequenceUtils.resolveMT576GetSequenceA1List_sru2018(this);
	}
	/**
	 * Get the list of SequenceA1 delimited by 16R/16S with value specified in SequenceA1#START_END_16RS
	 * The presence of this method indicates that this sequence can occur more than once according to the Standard.
    ...
    * @see com.financial.swift.model.mt.SequenceUtils
	...
	public static List<SequenceA1> getSequenceA1List(final SwiftTagListBlock parentSequence) {
		 ...
		 * So we call a special method to resolve this situation until we find a better approach.
		 */
		return com.financial.swift.model.mt.SequenceUtils.resolveMT576GetSequenceA1List_sru2018(new MT576().append(parentSequence));
...
// BaseSequenceCodeGenerator [seq=B2a]
    ...
    * @see com.financial.swift.model.mt.SequenceUtils
	...
	public List<SequenceB2a> getSequenceB2aList() {
		...
		return com.financial.swift.model.mt.SequenceUtils.resolveMT576GetSequenceB2aList_sru2018(this);
	}
	/**
	 * Get the list of SequenceB2a delimited by 16R/16S with value specified in SequenceB2a#START_END_16RS
	 * The presence of this method indicates that this sequence can occur more than once according to the Standard.
    ...
    * @see com.financial.swift.model.mt.SequenceUtils
	...
	public static List<SequenceB2a> getSequenceB2aList(final SwiftTagListBlock parentSequence) {
		 ...
		 * So we call a special method to resolve this situation until we find a better approach.
		 */
		return com.financial.swift.model.mt.SequenceUtils.resolveMT576GetSequenceB2aList_sru2018(new MT576().append(parentSequence));
...
// BaseSequenceCodeGenerator [seq=B2c]
	 ...
	 * The presence of this method indicates that this sequence can occur more than once according to the Standard.
	 * @see SequenceB2c#START_END_16RS
	 * @param parentSequence an optional parent sequence or null to find SequenceB2c within the complete message
	 * @return the found sequences or an empty list if none is found
	 * @since 7.7
	 */
	@SequenceStyle(Type.GENERATED_16RS)
