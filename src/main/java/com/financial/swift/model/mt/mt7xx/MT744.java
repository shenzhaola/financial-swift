...
// begin qualifiers constants	
	...
	*/
	@Deprecated
	@com.financial.deprecation.ProwideDeprecated(phase4=com.financial.deprecation.TargetYear._2019)
	public static final String TTNA = "TTNA";
...
// end qualifiers constants	
    ...
    * @param sender the sender address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @param receiver the receiver address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @see #MT744(String, String)
	* @deprecated Use instead <code>new MT744(sender, receiver)</code> instead
	*/
	@Deprecated
	@com.financial.deprecation.ProwideDeprecated(phase4=com.financial.deprecation.TargetYear._2019)
	public MT744(final int messageType, final String sender, final String receiver) {
		super(744, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT744(int, String, String)", "Use the constructor MT744(sender, receiver) instead.");
	}
