...
/**
 * <strong>MT 558 - Triparty Collateral Status and Processing Advice</strong>
 *
 * <p>
...
<li class="fieldset">
Fieldset 19
 (O)<ul><li>FieldsetItem 19 A (O)</li><li>FieldsetItem 19 A (O)</li><li>FieldsetItem 19 A (O)</li><li>FieldsetItem 19 A (O)</li></ul></li><li class="fieldset">
Fieldset 92
...
<li class="fieldset">
Fieldset 17
 (M) (repetitive)<ul><li>FieldsetItem 17 B (M)</li><li>FieldsetItem 17 B (O)</li><li>FieldsetItem 17 B (O)</li></ul></li><li class="field">Field 97 A,B (O)</li>
<li class="fieldset">
Fieldset 20
...
// end qualifiers constants	
	...
	* @deprecated Use instead <code>new MT558(sender, receiver)</code> instead
	*/
	@Deprecated
	@com.financial.deprecation.ProwideDeprecated(phase4=com.financial.deprecation.TargetYear._2019)
	public MT558(final int messageType, final String sender, final String receiver) {
		super(558, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT558(int, String, String)", "Use the constructor MT558(sender, receiver) instead.");
	}
	 ...
	 * @since 7.10.3
	 */
	public final static MT558 fromJson(String json) {
...
// BaseSequenceCodeGenerator [seq=A3]
	 ...
	 * The presence of this method indicates that this sequence can occur more than once according to the Standard.
	 * @see SequenceA3#START_END_16RS
	 * @param parentSequence an optional parent sequence or null to find SequenceA3 within the complete message
	 * @return the found sequences or an empty list if none is found
	 * @since 7.7
	 */
	@SequenceStyle(Type.GENERATED_16RS)
