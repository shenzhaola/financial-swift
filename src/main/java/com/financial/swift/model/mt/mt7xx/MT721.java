...
// end qualifiers constants	
    ...
    * @param sender the sender address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @param receiver the receiver address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @see #MT721(String, String)
	* @deprecated Use instead <code>new MT721(sender, receiver)</code> instead
	*/
	@Deprecated
	...
	public MT721(final int messageType, final String sender, final String receiver) {
		super(721, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT721(int, String, String)", "Use the constructor MT721(sender, receiver) instead.");
	}
