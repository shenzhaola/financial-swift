...
/**
 * <strong>MT 069 - Daily Check Report Time Status</strong>
 *
 * <p>
 * SWIFT MT069 (ISO 15022) message structure:
 * <br>
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT069 content, the parameter can not be null
	 * @see #MT069(String)
	 */
	...
	*/
	...
	public MT069(final int messageType, final String sender, final String receiver) {
		super(69, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT069(int, String, String)", "Use the constructor MT069(sender, receiver) instead.");
	}
    ...
    /**
	 * Creates an MT069 messages from its JSON representation.
	 * <p>
	 * For generic conversion of JSON into the corresopnding MT instance
	 * see {@link AbstractMT#fromJson(String)}
	 *
	 * @param json a JSON representation of an MT069 message
	 * @return a new instance of MT069
	 * @since 7.10.3
	 */
	public final static MT069 fromJson(String json) {
		return (MT069) AbstractMT.fromJson(json);
	}
