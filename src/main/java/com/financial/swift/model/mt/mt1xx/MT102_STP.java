...
/**
 * <strong>MT 102_STP - Multiple Customer Credit Transfer</strong>
 *
 * <p>
 * SWIFT MT102_STP (ISO 15022) message structure:
 * <br>
 <div class="scheme"><ul>
<li class="sequence">
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT102_STP content, the parameter can not be null
	...
	public MT102_STP(final String sender, final String receiver) {
		...
		m.setVariant(com.financial.swift.model.mt.MTVariant.STP);
	}
	...
	*/
	...
	public MT102_STP(final int messageType, final String sender, final String receiver) {
		super(102, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT102_STP(int, String, String)", "Use the constructor MT102_STP(sender, receiver) instead.");
	}
...
// BaseSequenceCodeGenerator [seq=A]
	/**
	 * Class to model Sequence "A" in MT 102_STP
	 */
...
// BaseSequenceCodeGenerator [seq=B]
	/**
	 * Class to model Sequence "B" in MT 102_STP
	 */
...
// SliceHeurisitcCodeGenerator [tagnames=[32A], type=END_OF_MESSAGE, delimiterIncludedInSequence=true ]
	/**
	 * Class to model Sequence "C" in MT 102_STP
	 */
