...
// end qualifiers constants	
	...
	*/
	...
	public MT300(final int messageType, final String sender, final String receiver) {
		super(300, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT300(int, String, String)", "Use the constructor MT300(sender, receiver) instead.");
	}
