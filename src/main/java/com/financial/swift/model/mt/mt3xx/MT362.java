...
// end qualifiers constants	
	...
	*/
	...
	public MT362(final int messageType, final String sender, final String receiver) {
		super(362, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT362(int, String, String)", "Use the constructor MT362(sender, receiver) instead.");
	}
