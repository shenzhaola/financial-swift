...
/**
 * <strong>MT 670 - Standing Settlement Instruction Update Notification Request</strong>
 *
 * <p>
 * SWIFT MT670 (ISO 15022) message structure:
 * <br>
 <div class="scheme"><ul>
<li class="sequence">
...
<li class="sequence">
Sequence A2 - Distribution Parameter (M)<ul><li class="field">Field 16 R (M)</li>
<li class="field">Field 95 P (O) (repetitive)</li>
<li class="field">Field 94 C (O) (repetitive)</li>
...
<li class="sequence">
Sequence B - Standing Settlement Instruction Details (M) (repetitive)<ul><li class="field">Field 16 R (M)</li>
...
<li class="fieldset">
Fieldset 22
 (M) (repetitive)<ul><li>FieldsetItem 22 F (O) (repetitive)</li><li>FieldsetItem 22 F (M) (repetitive)</li></ul></li><li class="sequence">
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT670 content, the parameter can not be null
	 * @see #MT670(String)
	 */
	 ...
	 * @since 7.7
	 */
	public static MT670 parse(MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT670(m);
	 ...
	 * @since 7.7
	 */
	public MT670(final String sender, final String receiver) {
    ...
    * @param sender the sender address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @param receiver the receiver address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @see #MT670(String, String)
	* @deprecated Use instead <code>new MT670(sender, receiver)</code> instead
	*/
	@Deprecated
	@com.financial.deprecation.ProwideDeprecated(phase4=com.financial.deprecation.TargetYear._2019)
	public MT670(final int messageType, final String sender, final String receiver) {
		super(670, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT670(int, String, String)", "Use the constructor MT670(sender, receiver) instead.");
	}
	
	/**
	 * Creates a new MT670 by parsing a String with the message content in its swift FIN format.<br>
    ...
    private void sanityCheck(final SwiftMessage param) {
    	if (param.isServiceMessage()) {
			log.warning("Creating an MT670 object from FIN content with a Service Message. Check if the MT670 you are intended to read is prepended with and ACK.");
		} else if (!StringUtils.equals(param.getType(), getMessageType())) {
			log.warning("Creating an MT670 object from FIN content with message type "+param.getType());
		}
    }
	
	/**
	 * Creates a new MT670 by parsing a String with the message content in its swift FIN format.<br>
	 * If the fin parameter cannot be parsed, the returned MT670 will have its internal message object
	 * initialized (blocks will be created) but empty.<br>
	 * If the string contains multiple messages, only the first one will be parsed. 
	 *
	 * @param fin a string with the MT message in its FIN swift format. <em>fin may be null in which case this method returns null</em>
	 * @return a new instance of MT670 or null if fin is null 
	 * @since 7.7
	 */
	public static MT670 parse(final String fin) {
		if (fin == null) {
			return null;
		}
		return new MT670(fin);
    }
    
    /**
	 * Creates a new MT670 by parsing a input stream with the message content in its swift FIN format, using "UTF-8" as encoding.<br>
	 ...
	 * @since 7.7
	 */
	public MT670(final InputStream stream) throws IOException {
	 ...
	 *
	 * @param stream an input stream in UTF-8 encoding with the MT message in its FIN swift format.
	 * @return a new instance of MT670 or null if stream is null or the message cannot be parsed 
	 * @throws IOException if the stream data cannot be read
	 * @since 7.7
	 */
	public static MT670 parse(final InputStream stream) throws IOException {
		if (stream == null) {
			return null;
		}
		return new MT670(stream);
    }
    
    /**
	 * Creates a new MT670 by parsing a file with the message content in its swift FIN format.<br>
	 ...
	 * @since 7.7
	 */
	public MT670(final File file) throws IOException {
	 ...
	 *
	 * @param file a file with the MT message in its FIN swift format.
	 * @return a new instance of MT670 or null if; file is null, does not exist, can't be read, is not a file or the message cannot be parsed
	 * @throws IOException if the file content cannot be read
	 * @since 7.7
	 */
	public static MT670 parse(final File file) throws IOException {
		if (file == null) {
			return null;
		}
		return new MT670(file);
    }
    ...
    /**
	 * Creates an MT670 messages from its JSON representation.
	 * <p>
	 * For generic conversion of JSON into the corresopnding MT instance
	 * see {@link AbstractMT#fromJson(String)}
	 *
	 * @param json a JSON representation of an MT670 message
	 * @return a new instance of MT670
	 * @since 7.10.3
	 */
	public final static MT670 fromJson(String json) {
		return (MT670) AbstractMT.fromJson(json);
	}
...
// BaseSequenceCodeGenerator [seq=A]
	/**
	 * Class to model Sequence "A" in MT 670
	 */
...
// BaseSequenceCodeGenerator [seq=A1]
	/**
	 * Class to model Sequence "A1" in MT 670
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=A2]
	/**
	 * Class to model Sequence "A2" in MT 670
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=B]
	/**
	 * Class to model Sequence "B" in MT 670
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=B1]
	/**
	 * Class to model Sequence "B1" in MT 670
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=B2]
	/**
	 * Class to model Sequence "B2" in MT 670
	 */
	@SequenceStyle(Type.GENERATED_16RS)
    ...
    * @see com.financial.swift.model.mt.SequenceUtils
	...
	public List<SequenceB2> getSequenceB2List() {
		...
		return com.financial.swift.model.mt.SequenceUtils.resolveMT670GetSequenceB2List_sru2018(this);
	}
	/**
	 * Get the list of SequenceB2 delimited by 16R/16S with value specified in SequenceB2#START_END_16RS
	 * The presence of this method indicates that this sequence can occur more than once according to the Standard.
    ...
    * @see com.financial.swift.model.mt.SequenceUtils
	...
	public static List<SequenceB2> getSequenceB2List(final SwiftTagListBlock parentSequence) {
		 ...
		 * So we call a special method to resolve this situation until we find a better approach.
		 */
		return com.financial.swift.model.mt.SequenceUtils.resolveMT670GetSequenceB2List_sru2018(new MT670().append(parentSequence));
...
// BaseSequenceCodeGenerator [seq=C]
	/**
	 * Class to model Sequence "C" in MT 670
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	@com.financial.swift.internal.NonUniqueSeparator
    ...
    * @see com.financial.swift.model.mt.SequenceUtils
	...
	public SequenceC getSequenceC() {
		...
		return com.financial.swift.model.mt.SequenceUtils.resolveMT670GetSequenceC_sru2018(this);
	}
    ...
    * @see com.financial.swift.model.mt.SequenceUtils
	...
	public static SequenceC getSequenceC(SwiftTagListBlock parentSequence) {
		 ...
		 * In Sequence C
		 */
		return com.financial.swift.model.mt.SequenceUtils.resolveMT670GetSequenceC_sru2018(new MT670().append(parentSequence));
	}
 	// Slice debug: com.financial.swift.codegen.velocity.mt.DelimitedSequenceCodeGenerator
