...
/**
 * <strong>MT 056 - Logical Terminal History Report</strong>
 *
 * <p>
...
// end qualifiers constants	
	...
	/**
	 * Creates and initializes a new MT056 input message setting TEST BICS as sender and receiver.<br>
	...
	/**
	 * Creates and initializes a new MT056 input message from sender to receiver.<br>
	 * All mandatory header attributes are completed with default values. 
    ...
    * @param sender the sender address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @param receiver the receiver address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @see #MT056(String, String)
	* @deprecated Use instead <code>new MT056(sender, receiver)</code> instead
	*/
	@Deprecated
	@com.financial.deprecation.ProwideDeprecated(phase4=com.financial.deprecation.TargetYear._2019)
	public MT056(final int messageType, final String sender, final String receiver) {
		super(56, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT056(int, String, String)", "Use the constructor MT056(sender, receiver) instead.");
	}
	
	/**
	 * Creates a new MT056 by parsing a String with the message content in its swift FIN format.<br>
    ...
    /**
	 * Creates a new MT056 by parsing a input stream with the message content in its swift FIN format, using "UTF-8" as encoding.<br>
    ...
    /**
	 * Creates a new MT056 by parsing a file with the message content in its swift FIN format.<br>
	...
	public List<Field270> getField270() {
		final List<Field270> result = new ArrayList<Field270>();
