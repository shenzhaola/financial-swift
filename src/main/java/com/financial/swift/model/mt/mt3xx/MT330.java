...
// begin qualifiers constants	
	...
	*/
	...
	/**
	* Constant for qualifier with value CHNG 
	*/
	@Deprecated
	@com.financial.deprecation.ProwideDeprecated(phase4=com.financial.deprecation.TargetYear._2019)
...
// end qualifiers constants	
    ...
    * @param sender the sender address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @param receiver the receiver address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @see #MT330(String, String)
	* @deprecated Use instead <code>new MT330(sender, receiver)</code> instead
	*/
	@Deprecated
	@com.financial.deprecation.ProwideDeprecated(phase4=com.financial.deprecation.TargetYear._2019)
	public MT330(final int messageType, final String sender, final String receiver) {
		super(330, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT330(int, String, String)", "Use the constructor MT330(sender, receiver) instead.");
	}
