...
// end qualifiers constants	
    ...
    * @param sender the sender address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @param receiver the receiver address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @see #MT074(String, String)
	* @deprecated Use instead <code>new MT074(sender, receiver)</code> instead
	*/
	@Deprecated
	@com.financial.deprecation.ProwideDeprecated(phase4=com.financial.deprecation.TargetYear._2019)
	public MT074(final int messageType, final String sender, final String receiver) {
		super(74, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT074(int, String, String)", "Use the constructor MT074(sender, receiver) instead.");
	}
	...
	public List<Field304> getField304() {
		final List<Field304> result = new ArrayList<Field304>();
