...
// end qualifiers constants	
	 ...
	 * @since 7.7
	 */
	public static MT995 parse(MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT995(m);
    ...
    * @param sender the sender address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @param receiver the receiver address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @see #MT995(String, String)
	* @deprecated Use instead <code>new MT995(sender, receiver)</code> instead
	*/
	@Deprecated
	...
	public MT995(final int messageType, final String sender, final String receiver) {
		super(995, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT995(int, String, String)", "Use the constructor MT995(sender, receiver) instead.");
	}
	
	/**
	 * Creates a new MT995 by parsing a String with the message content in its swift FIN format.<br>
    ...
    /**
	 * Creates a new MT995 by parsing a input stream with the message content in its swift FIN format, using "UTF-8" as encoding.<br>
    ...
    /**
	 * Creates a new MT995 by parsing a file with the message content in its swift FIN format.<br>
	 ...
	 * @since 7.10.3
	 */
	public final static MT995 fromJson(String json) {
