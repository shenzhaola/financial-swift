 ...
 */
@Generated
public class MT381 extends AbstractMT implements Serializable {
	/**
...
// end qualifiers constants	
	 ...
	 * @since 7.7
	 */
	public MT381(final String sender, final String receiver) {
		super(381, sender, receiver);
	}
    ...
    * @param sender the sender address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @param receiver the receiver address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @see #MT381(String, String)
	* @deprecated Use instead <code>new MT381(sender, receiver)</code> instead
	*/
	@Deprecated
	@com.financial.deprecation.ProwideDeprecated(phase4=com.financial.deprecation.TargetYear._2019)
	public MT381(final int messageType, final String sender, final String receiver) {
		super(381, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT381(int, String, String)", "Use the constructor MT381(sender, receiver) instead.");
	}
	 ...
	 * @return a new instance of MT381 or null if fin is null 
	 * @since 7.7
	 */
	public static MT381 parse(final String fin) {
		if (fin == null) {
			return null;
		}
	 ...
	 * @since 7.7
	 */
	public MT381(final InputStream stream) throws IOException {
	 ...
	 *
	 * @param stream an input stream in UTF-8 encoding with the MT message in its FIN swift format.
	 * @return a new instance of MT381 or null if stream is null or the message cannot be parsed 
	 * @throws IOException if the stream data cannot be read
	 * @since 7.7
	 */
	public static MT381 parse(final InputStream stream) throws IOException {
		if (stream == null) {
			return null;
		}
	 ...
	 * @since 7.7
	 */
	public MT381(final File file) throws IOException {
	 ...
	 *
	 * @param file a file with the MT message in its FIN swift format.
	 * @return a new instance of MT381 or null if; file is null, does not exist, can't be read, is not a file or the message cannot be parsed
	 * @throws IOException if the file content cannot be read
	 * @since 7.7
	 */
	public static MT381 parse(final File file) throws IOException {
		if (file == null) {
			return null;
		}
	 ...
	 */
	@Override
	public MT381 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 * @since 7.10.3
	 */
	public final static MT381 fromJson(String json) {
