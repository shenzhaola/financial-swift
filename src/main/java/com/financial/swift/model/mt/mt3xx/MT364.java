...
// end qualifiers constants	
	...
	* @deprecated Use instead <code>new MT364(sender, receiver)</code> instead
	*/
	@Deprecated
	@com.financial.deprecation.ProwideDeprecated(phase4=com.financial.deprecation.TargetYear._2019)
	public MT364(final int messageType, final String sender, final String receiver) {
		super(364, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT364(int, String, String)", "Use the constructor MT364(sender, receiver) instead.");
	}
