...
// end qualifiers constants	
	...
	* @deprecated Use instead <code>new MT455(sender, receiver)</code> instead
	*/
	@Deprecated
	...
	public MT455(final int messageType, final String sender, final String receiver) {
		super(455, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT455(int, String, String)", "Use the constructor MT455(sender, receiver) instead.");
	}
