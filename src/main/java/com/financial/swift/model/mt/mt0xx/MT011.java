...
/**
 * <strong>MT 011 - Delivery Notification</strong>
 *
 * <p>
 * SWIFT MT011 (ISO 15022) message structure:
 * <br>
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT011 content, the parameter can not be null
	 * @see #MT011(String)
	 */
	...
	*/
	...
	public MT011(final int messageType, final String sender, final String receiver) {
		super(11, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT011(int, String, String)", "Use the constructor MT011(sender, receiver) instead.");
	}
	...
	public List<Field175> getField175() {
		...
		if (tags != null && tags.length > 0) {
            for (Tag tag : tags) {
                result.add(new Field175(tag.getValue()));
            }
		}
		return result;
	}
