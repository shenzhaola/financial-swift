...
/**
 * <strong>MT 696 - Answers</strong>
 *
 * <p>
 * SWIFT MT696 (ISO 15022) message structure:
 * <br>
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT696 content, the parameter can not be null
	 * @see #MT696(String)
	 */
	...
	* @deprecated Use instead <code>new MT696(sender, receiver)</code> instead
	*/
	@Deprecated
	...
	public MT696(final int messageType, final String sender, final String receiver) {
		super(696, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT696(int, String, String)", "Use the constructor MT696(sender, receiver) instead.");
	}
    ...
    private void sanityCheck(final SwiftMessage param) {
    	if (param.isServiceMessage()) {
			log.warning("Creating an MT696 object from FIN content with a Service Message. Check if the MT696 you are intended to read is prepended with and ACK.");
		} else if (!StringUtils.equals(param.getType(), getMessageType())) {
			log.warning("Creating an MT696 object from FIN content with message type "+param.getType());
		}
    }
    ...
    /**
	 * Creates an MT696 messages from its JSON representation.
	 * <p>
	 * For generic conversion of JSON into the corresopnding MT instance
	 * see {@link AbstractMT#fromJson(String)}
	 *
	 * @param json a JSON representation of an MT696 message
	 * @return a new instance of MT696
	 * @since 7.10.3
	 */
	public final static MT696 fromJson(String json) {
		return (MT696) AbstractMT.fromJson(json);
	}
