...
public class MT515 extends AbstractMT implements Serializable {
	...
	private static final transient java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT515.class.getName());
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT515 content, the parameter can not be null
	 * @see #MT515(String)
	 */
	 ...
	 * @since 7.7
	 */
	public MT515(final String sender, final String receiver) {
	...
	*/
	...
	public MT515(final int messageType, final String sender, final String receiver) {
		super(515, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT515(int, String, String)", "Use the constructor MT515(sender, receiver) instead.");
	}
    ...
    private void sanityCheck(final SwiftMessage param) {
    	if (param.isServiceMessage()) {
			...
			log.warning("Creating an MT515 object from FIN content with message type "+param.getType());
		}
    }
	 ...
	 * @return a new instance of MT515 or null if fin is null 
	 * @since 7.7
	 */
	public static MT515 parse(final String fin) {
		if (fin == null) {
			return null;
		}
	 ...
	 * @since 7.7
	 */
	public MT515(final InputStream stream) throws IOException {
	 ...
	 *
	 * @param stream an input stream in UTF-8 encoding with the MT message in its FIN swift format.
	 * @return a new instance of MT515 or null if stream is null or the message cannot be parsed 
	 * @throws IOException if the stream data cannot be read
	 * @since 7.7
	 */
	public static MT515 parse(final InputStream stream) throws IOException {
		if (stream == null) {
			return null;
		}
	 ...
	 * @since 7.7
	 */
	public MT515(final File file) throws IOException {
	 ...
	 *
	 * @param file a file with the MT message in its FIN swift format.
	 * @return a new instance of MT515 or null if; file is null, does not exist, can't be read, is not a file or the message cannot be parsed
	 * @throws IOException if the file content cannot be read
	 * @since 7.7
	 */
	public static MT515 parse(final File file) throws IOException {
		if (file == null) {
			return null;
		}
	 ...
	 *
	 * @param json a JSON representation of an MT515 message
	 * @return a new instance of MT515
	 * @since 7.10.3
	 */
	public final static MT515 fromJson(String json) {
