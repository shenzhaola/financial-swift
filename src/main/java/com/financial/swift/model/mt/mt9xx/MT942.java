...
// end qualifiers constants	
    ...
    * @param sender the sender address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @param receiver the receiver address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @see #MT942(String, String)
	* @deprecated Use instead <code>new MT942(sender, receiver)</code> instead
	*/
	@Deprecated
	@com.financial.deprecation.ProwideDeprecated(phase4=com.financial.deprecation.TargetYear._2019)
	public MT942(final int messageType, final String sender, final String receiver) {
		super(942, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT942(int, String, String)", "Use the constructor MT942(sender, receiver) instead.");
	}
