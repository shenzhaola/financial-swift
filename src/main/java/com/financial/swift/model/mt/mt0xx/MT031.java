...
/**
 * <strong>MT 031 - Session History Request</strong>
 *
 * <p>
...
public class MT031 extends AbstractMT implements Serializable {
	...
	private static final transient java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT031.class.getName());
...
// end qualifiers constants	
	...
	/**
	 * Creates and initializes a new MT031 input message setting TEST BICS as sender and receiver.<br>
	...
	/**
	 * Creates and initializes a new MT031 input message from sender to receiver.<br>
	 * All mandatory header attributes are completed with default values. 
    ...
    * @param sender the sender address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @param receiver the receiver address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @see #MT031(String, String)
	* @deprecated Use instead <code>new MT031(sender, receiver)</code> instead
	*/
	@Deprecated
	@com.financial.deprecation.ProwideDeprecated(phase4=com.financial.deprecation.TargetYear._2019)
	public MT031(final int messageType, final String sender, final String receiver) {
		super(31, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT031(int, String, String)", "Use the constructor MT031(sender, receiver) instead.");
	}
	
	/**
	 * Creates a new MT031 by parsing a String with the message content in its swift FIN format.<br>
    ...
    /**
	 * Creates a new MT031 by parsing a input stream with the message content in its swift FIN format, using "UTF-8" as encoding.<br>
    ...
    /**
	 * Creates a new MT031 by parsing a file with the message content in its swift FIN format.<br>
	 ...
	 * @since 7.10.3
	 */
	public final static MT031 fromJson(String json) {
