...
/**
 * <strong>MT 019 - Abort Notification</strong>
 *
 * <p>
 * SWIFT MT019 (ISO 15022) message structure:
 * <br>
 <div class="scheme"><ul>
...
<li class="field">Field 107  (O)</li>
<li class="field">Field 432  (M)</li>
<li class="field">Field 619  (O)</li>
</ul></div>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT019 content, the parameter can not be null
	 * @see #MT019(String)
	 */
	...
	* @deprecated Use instead <code>new MT019(sender, receiver)</code> instead
	*/
	@Deprecated
	...
	public MT019(final int messageType, final String sender, final String receiver) {
		super(19, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT019(int, String, String)", "Use the constructor MT019(sender, receiver) instead.");
	}
    ...
    /**
	 * Creates an MT019 messages from its JSON representation.
	 * <p>
	 * For generic conversion of JSON into the corresopnding MT instance
	 * see {@link AbstractMT#fromJson(String)}
	 *
	 * @param json a JSON representation of an MT019 message
	 * @return a new instance of MT019
	 * @since 7.10.3
	 */
	public final static MT019 fromJson(String json) {
	 ...
	 * 
	 * @return a Field107 object or null if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	 ...
	 * 
	 * @return a Field619 object or null if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
