...
/**
 * <strong>MT 077 - Additional Selection Criteria for FIN</strong>
 *
 * <p>
 * SWIFT MT077 (ISO 15022) message structure:
 * <br>
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT077 content, the parameter can not be null
	 * @see #MT077(String)
	 */
	...
	*/
	...
	public MT077(final int messageType, final String sender, final String receiver) {
		super(77, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT077(int, String, String)", "Use the constructor MT077(sender, receiver) instead.");
	}
