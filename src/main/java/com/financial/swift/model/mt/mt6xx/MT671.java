...
/**
 * <strong>MT 671 - Standing Settlement Instruction Update Notification</strong>
 *
 * <p>
...
public class MT671 extends AbstractMT implements Serializable {
	...
	private static final transient java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT671.class.getName());
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT671 content, the parameter can not be null
	 * @see #MT671(String)
	 */
	 ...
	 * @since 7.7
	 */
	public MT671(final String sender, final String receiver) {
    ...
    * @param sender the sender address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @param receiver the receiver address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @see #MT671(String, String)
	* @deprecated Use instead <code>new MT671(sender, receiver)</code> instead
	*/
	@Deprecated
	@com.financial.deprecation.ProwideDeprecated(phase4=com.financial.deprecation.TargetYear._2019)
	public MT671(final int messageType, final String sender, final String receiver) {
		super(671, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT671(int, String, String)", "Use the constructor MT671(sender, receiver) instead.");
	}
	
	/**
	 * Creates a new MT671 by parsing a String with the message content in its swift FIN format.<br>
	...
	/**
	 * Creates a new MT671 by parsing a String with the message content in its swift FIN format.<br>
	 * If the fin parameter cannot be parsed, the returned MT671 will have its internal message object
	 * initialized (blocks will be created) but empty.<br>
	 * If the string contains multiple messages, only the first one will be parsed. 
	 *
	 * @param fin a string with the MT message in its FIN swift format. <em>fin may be null in which case this method returns null</em>
	 * @return a new instance of MT671 or null if fin is null 
	 * @since 7.7
	 */
	public static MT671 parse(final String fin) {
		if (fin == null) {
			return null;
		}
    ...
    /**
	 * Creates a new MT671 by parsing a input stream with the message content in its swift FIN format, using "UTF-8" as encoding.<br>
	 ...
	 * @since 7.7
	 */
	public MT671(final InputStream stream) throws IOException {
	 ...
	 *
	 * @param stream an input stream in UTF-8 encoding with the MT message in its FIN swift format.
	 * @return a new instance of MT671 or null if stream is null or the message cannot be parsed 
	 * @throws IOException if the stream data cannot be read
	 * @since 7.7
	 */
	public static MT671 parse(final InputStream stream) throws IOException {
		if (stream == null) {
			return null;
		}
    ...
    /**
	 * Creates a new MT671 by parsing a file with the message content in its swift FIN format.<br>
	 ...
	 * @since 7.7
	 */
	public MT671(final File file) throws IOException {
	 ...
	 *
	 * @param file a file with the MT message in its FIN swift format.
	 * @return a new instance of MT671 or null if; file is null, does not exist, can't be read, is not a file or the message cannot be parsed
	 * @throws IOException if the file content cannot be read
	 * @since 7.7
	 */
	public static MT671 parse(final File file) throws IOException {
		if (file == null) {
			return null;
		}
	 ...
	 *
	 * @param json a JSON representation of an MT671 message
	 * @return a new instance of MT671
	 * @since 7.10.3
	 */
	public final static MT671 fromJson(String json) {
...
// BaseSequenceCodeGenerator [seq=A]
	/**
	 * Class to model Sequence "A" in MT 671
	 */
...
// BaseSequenceCodeGenerator [seq=A1]
	/**
	 * Class to model Sequence "A1" in MT 671
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=B]
	/**
	 * Class to model Sequence "B" in MT 671
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=B1]
	/**
	 * Class to model Sequence "B1" in MT 671
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=B2]
	/**
	 * Class to model Sequence "B2" in MT 671
	 */
	@SequenceStyle(Type.GENERATED_16RS)
    ...
    * @see com.financial.swift.model.mt.SequenceUtils
	...
	public List<SequenceB2> getSequenceB2List() {
		...
		return com.financial.swift.model.mt.SequenceUtils.resolveMT671GetSequenceB2List_sru2018(this);
	}
	/**
	 * Get the list of SequenceB2 delimited by 16R/16S with value specified in SequenceB2#START_END_16RS
	 * The presence of this method indicates that this sequence can occur more than once according to the Standard.
    ...
    * @see com.financial.swift.model.mt.SequenceUtils
	...
	public static List<SequenceB2> getSequenceB2List(final SwiftTagListBlock parentSequence) {
		 ...
		 * So we call a special method to resolve this situation until we find a better approach.
		 */
		return com.financial.swift.model.mt.SequenceUtils.resolveMT671GetSequenceB2List_sru2018(new MT671().append(parentSequence));
...
// BaseSequenceCodeGenerator [seq=C]
	/**
	 * Class to model Sequence "C" in MT 671
	 */
	@SequenceStyle(Type.GENERATED_16RS)
	@com.financial.swift.internal.NonUniqueSeparator
    ...
    * @see com.financial.swift.model.mt.SequenceUtils
	...
	public SequenceC getSequenceC() {
		...
		return com.financial.swift.model.mt.SequenceUtils.resolveMT671GetSequenceC_sru2018(this);
	}
    ...
    * @see com.financial.swift.model.mt.SequenceUtils
	...
	public static SequenceC getSequenceC(SwiftTagListBlock parentSequence) {
		 ...
		 * In Sequence C
		 */
		return com.financial.swift.model.mt.SequenceUtils.resolveMT671GetSequenceC_sru2018(new MT671().append(parentSequence));
	}
 	// Slice debug: com.financial.swift.codegen.velocity.mt.DelimitedSequenceCodeGenerator
