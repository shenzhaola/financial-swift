...
/**
 * <strong>MT 950 - Statement Message</strong>
 *
 * <p>
 * SWIFT MT950 (ISO 15022) message structure:
 * <br>
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT950 content, the parameter can not be null
	 * @see #MT950(String)
	 */
	...
	* @deprecated Use instead <code>new MT950(sender, receiver)</code> instead
	*/
	@Deprecated
	@com.financial.deprecation.ProwideDeprecated(phase4=com.financial.deprecation.TargetYear._2019)
	public MT950(final int messageType, final String sender, final String receiver) {
		super(950, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT950(int, String, String)", "Use the constructor MT950(sender, receiver) instead.");
	}
    ...
    private void sanityCheck(final SwiftMessage param) {
    	if (param.isServiceMessage()) {
			log.warning("Creating an MT950 object from FIN content with a Service Message. Check if the MT950 you are intended to read is prepended with and ACK.");
		} else if (!StringUtils.equals(param.getType(), getMessageType())) {
			log.warning("Creating an MT950 object from FIN content with message type "+param.getType());
		}
    }
    ...
    /**
	 * Creates an MT950 messages from its JSON representation.
	 * <p>
	 * For generic conversion of JSON into the corresopnding MT instance
	 * see {@link AbstractMT#fromJson(String)}
	 *
	 * @param json a JSON representation of an MT950 message
	 * @return a new instance of MT950
	 * @since 7.10.3
	 */
	public final static MT950 fromJson(String json) {
		return (MT950) AbstractMT.fromJson(json);
	}
