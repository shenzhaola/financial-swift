...
// end qualifiers constants	
	...
	*/
	...
	public MT066(final int messageType, final String sender, final String receiver) {
		super(66, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT066(int, String, String)", "Use the constructor MT066(sender, receiver) instead.");
	}
	 ...
	 * @since 7.10.3
	 */
	public final static MT066 fromJson(String json) {
