...
/**
 * <strong>MT 400 - Advice of Payment</strong>
 *
 * <p>
 * SWIFT MT400 (ISO 15022) message structure:
 * <br>
 <div class="scheme"><ul>
...
<li class="field">Field 58 A,B,D (O)</li>
 ...
 */
@Generated
public class MT400 extends AbstractMT implements Serializable {
	/**
	 * Constant identifying the SRU to which this class belongs to.
	 */
	public static final int SRU = 2018;
	private static final long serialVersionUID = 1L;
	private static final transient java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT400.class.getName());
	
	/**
	* Constant for MT name, this is part of the classname, after <code>MT</code>
	*/
	public static final String NAME = "400";
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT400 content
	 */
	 ...
	 * @param m swift message with the MT400 content, the parameter can not be null
	 * @see #MT400(String)
	 */
	public MT400(MtSwiftMessage m) {
		this(m.message());
	}
	 ...
	 * @since 7.7
	 */
	public static MT400 parse(MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT400(m);
	...
	/**
	 * Creates and initializes a new MT400 input message setting TEST BICS as sender and receiver.<br>
	...
	/**
	 * Creates and initializes a new MT400 input message from sender to receiver.<br>
	 * All mandatory header attributes are completed with default values. 
	 ...
	 * @since 7.7
	 */
	public MT400(final String sender, final String receiver) {
		super(400, sender, receiver);
	}
    ...
    * @param sender the sender address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @param receiver the receiver address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @see #MT400(String, String)
	* @deprecated Use instead <code>new MT400(sender, receiver)</code> instead
	*/
	@Deprecated
	@com.financial.deprecation.ProwideDeprecated(phase4=com.financial.deprecation.TargetYear._2019)
	public MT400(final int messageType, final String sender, final String receiver) {
		super(400, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT400(int, String, String)", "Use the constructor MT400(sender, receiver) instead.");
	}
	
	/**
	 * Creates a new MT400 by parsing a String with the message content in its swift FIN format.<br>
    ...
    private void sanityCheck(final SwiftMessage param) {
    	if (param.isServiceMessage()) {
			log.warning("Creating an MT400 object from FIN content with a Service Message. Check if the MT400 you are intended to read is prepended with and ACK.");
		} else if (!StringUtils.equals(param.getType(), getMessageType())) {
			log.warning("Creating an MT400 object from FIN content with message type "+param.getType());
		}
    }
	
	/**
	 * Creates a new MT400 by parsing a String with the message content in its swift FIN format.<br>
	 * If the fin parameter cannot be parsed, the returned MT400 will have its internal message object
	 * initialized (blocks will be created) but empty.<br>
	 * If the string contains multiple messages, only the first one will be parsed. 
	 *
	 * @param fin a string with the MT message in its FIN swift format. <em>fin may be null in which case this method returns null</em>
	 * @return a new instance of MT400 or null if fin is null 
	 * @since 7.7
	 */
	public static MT400 parse(final String fin) {
		if (fin == null) {
			return null;
		}
		return new MT400(fin);
    }
    
    /**
	 * Creates a new MT400 by parsing a input stream with the message content in its swift FIN format, using "UTF-8" as encoding.<br>
	 ...
	 * @since 7.7
	 */
	public MT400(final InputStream stream) throws IOException {
	 ...
	 *
	 * @param stream an input stream in UTF-8 encoding with the MT message in its FIN swift format.
	 * @return a new instance of MT400 or null if stream is null or the message cannot be parsed 
	 * @throws IOException if the stream data cannot be read
	 * @since 7.7
	 */
	public static MT400 parse(final InputStream stream) throws IOException {
		if (stream == null) {
			return null;
		}
		return new MT400(stream);
    }
    
    /**
	 * Creates a new MT400 by parsing a file with the message content in its swift FIN format.<br>
	 ...
	 * @since 7.7
	 */
	public MT400(final File file) throws IOException {
	 ...
	 *
	 * @param file a file with the MT message in its FIN swift format.
	 * @return a new instance of MT400 or null if; file is null, does not exist, can't be read, is not a file or the message cannot be parsed
	 * @throws IOException if the file content cannot be read
	 * @since 7.7
	 */
	public static MT400 parse(final File file) throws IOException {
		if (file == null) {
			return null;
		}
		return new MT400(file);
    }
	 ...
	 */
	@Override
	public MT400 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT400 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT400 append(final Field ... fields) {
		super.append(fields);
		return this;
	}

    /**
	 * Creates an MT400 messages from its JSON representation.
	 * <p>
	 * For generic conversion of JSON into the corresopnding MT instance
	 * see {@link AbstractMT#fromJson(String)}
	 *
	 * @param json a JSON representation of an MT400 message
	 * @return a new instance of MT400
	 * @since 7.10.3
	 */
	public final static MT400 fromJson(String json) {
		return (MT400) AbstractMT.fromJson(json);
	}
	...
	/**
	 * Iterates through block4 fields and return the first one whose name matches 32K, 
	 * or null if none is found.<br>
	 * The first occurrence of field 32K at MT400 is expected to be the only one.
	 * 
	 * @return a Field32K object or null if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	public Field32K getField32K() {
		final Tag t = tag("32K");
		if (t != null) {
			return new Field32K(t.getValue());
		} else {
			return null;
		}
	}
	 ...
	 * 
	 * @return a Field58B object or null if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
	 ...
	 * 
	 * @return a Field73 object or null if the field is not found
	 * @see SwiftTagListBlock#getTagByName(String)
	 * @throws IllegalStateException if SwiftMessage object is not initialized
	 */
