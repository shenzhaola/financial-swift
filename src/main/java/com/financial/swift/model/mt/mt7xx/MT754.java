...
// end qualifiers constants	
	...
	*/
	...
	public MT754(final int messageType, final String sender, final String receiver) {
		super(754, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT754(int, String, String)", "Use the constructor MT754(sender, receiver) instead.");
	}
