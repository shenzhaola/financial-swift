...
/**
 * <strong>MT 052 - Delivery Subset Status Report</strong>
 *
 * <p>
...
public class MT052 extends AbstractMT implements Serializable {
	...
	private static final transient java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT052.class.getName());
...
// end qualifiers constants	
	 ...
	 * @since 7.7
	 */
	public static MT052 parse(MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT052(m);
	...
	/**
	 * Creates and initializes a new MT052 input message setting TEST BICS as sender and receiver.<br>
	...
	/**
	 * Creates and initializes a new MT052 input message from sender to receiver.<br>
	 * All mandatory header attributes are completed with default values. 
    ...
    * @param sender the sender address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @param receiver the receiver address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @see #MT052(String, String)
	* @deprecated Use instead <code>new MT052(sender, receiver)</code> instead
	*/
	@Deprecated
	@com.financial.deprecation.ProwideDeprecated(phase4=com.financial.deprecation.TargetYear._2019)
	public MT052(final int messageType, final String sender, final String receiver) {
		super(52, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT052(int, String, String)", "Use the constructor MT052(sender, receiver) instead.");
	}
	
	/**
	 * Creates a new MT052 by parsing a String with the message content in its swift FIN format.<br>
    ...
    /**
	 * Creates a new MT052 by parsing a input stream with the message content in its swift FIN format, using "UTF-8" as encoding.<br>
    ...
    /**
	 * Creates a new MT052 by parsing a file with the message content in its swift FIN format.<br>
	 ...
	 * @since 7.10.3
	 */
	public final static MT052 fromJson(String json) {
	...
	public List<Field336> getField336() {
		final List<Field336> result = new ArrayList<Field336>();
