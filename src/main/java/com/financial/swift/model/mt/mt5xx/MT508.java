...
/**
 * <strong>MT 508 - Intra-Position Advice</strong>
 *
 * <p>
 * SWIFT MT508 (ISO 15022) message structure:
 * <br>
 <div class="scheme"><ul>
<li class="sequence">
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT508 content, the parameter can not be null
	 * @see #MT508(String)
	 */
	...
	*/
	...
	public MT508(final int messageType, final String sender, final String receiver) {
		super(508, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT508(int, String, String)", "Use the constructor MT508(sender, receiver) instead.");
	}
...
// BaseSequenceCodeGenerator [seq=A]
	/**
	 * Class to model Sequence "A" in MT 508
	 */
...
// BaseSequenceCodeGenerator [seq=A1]
	/**
	 * Class to model Sequence "A1" in MT 508
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=B]
	/**
	 * Class to model Sequence "B" in MT 508
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=B1]
	/**
	 * Class to model Sequence "B1" in MT 508
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=C]
	/**
	 * Class to model Sequence "C" in MT 508
	 */
	@SequenceStyle(Type.GENERATED_16RS)
