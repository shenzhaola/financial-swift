...
// end qualifiers constants	
	...
	*/
	...
	public MT205COV(final int messageType, final String sender, final String receiver) {
		super(205, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT205COV(int, String, String)", "Use the constructor MT205COV(sender, receiver) instead.");
	}
