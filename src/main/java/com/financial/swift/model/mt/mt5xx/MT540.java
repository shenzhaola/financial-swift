...
/**
 * <strong>MT 540 - Receive Free</strong>
 *
 * <p>
 * SWIFT MT540 (ISO 15022) message structure:
 * <br>
 <div class="scheme"><ul>
<li class="sequence">
...
public class MT540 extends AbstractMT implements Serializable {
	...
	private static final transient java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT540.class.getName());
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT540 content, the parameter can not be null
	 * @see #MT540(String)
	 */
	 ...
	 * @since 7.7
	 */
	public static MT540 parse(MtSwiftMessage m) {
		if (m == null) {
			return null;
		}
		return new MT540(m);
	 ...
	 * @since 7.7
	 */
	public MT540(final String sender, final String receiver) {
    ...
    * @param sender the sender address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @param receiver the receiver address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @see #MT540(String, String)
	* @deprecated Use instead <code>new MT540(sender, receiver)</code> instead
	*/
	@Deprecated
	@com.financial.deprecation.ProwideDeprecated(phase4=com.financial.deprecation.TargetYear._2019)
	public MT540(final int messageType, final String sender, final String receiver) {
		super(540, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT540(int, String, String)", "Use the constructor MT540(sender, receiver) instead.");
	}
	
	/**
	 * Creates a new MT540 by parsing a String with the message content in its swift FIN format.<br>
    ...
    private void sanityCheck(final SwiftMessage param) {
    	if (param.isServiceMessage()) {
			log.warning("Creating an MT540 object from FIN content with a Service Message. Check if the MT540 you are intended to read is prepended with and ACK.");
		} else if (!StringUtils.equals(param.getType(), getMessageType())) {
			log.warning("Creating an MT540 object from FIN content with message type "+param.getType());
		}
    }
	
	/**
	 * Creates a new MT540 by parsing a String with the message content in its swift FIN format.<br>
	 * If the fin parameter cannot be parsed, the returned MT540 will have its internal message object
	 * initialized (blocks will be created) but empty.<br>
	 * If the string contains multiple messages, only the first one will be parsed. 
	 *
	 * @param fin a string with the MT message in its FIN swift format. <em>fin may be null in which case this method returns null</em>
	 * @return a new instance of MT540 or null if fin is null 
	 * @since 7.7
	 */
	public static MT540 parse(final String fin) {
		if (fin == null) {
			return null;
		}
		return new MT540(fin);
    }
    
    /**
	 * Creates a new MT540 by parsing a input stream with the message content in its swift FIN format, using "UTF-8" as encoding.<br>
	 ...
	 * @since 7.7
	 */
	public MT540(final InputStream stream) throws IOException {
	 ...
	 *
	 * @param stream an input stream in UTF-8 encoding with the MT message in its FIN swift format.
	 * @return a new instance of MT540 or null if stream is null or the message cannot be parsed 
	 * @throws IOException if the stream data cannot be read
	 * @since 7.7
	 */
	public static MT540 parse(final InputStream stream) throws IOException {
		if (stream == null) {
			return null;
		}
		return new MT540(stream);
    }
    
    /**
	 * Creates a new MT540 by parsing a file with the message content in its swift FIN format.<br>
	 ...
	 * @since 7.7
	 */
	public MT540(final File file) throws IOException {
	 ...
	 *
	 * @param file a file with the MT message in its FIN swift format.
	 * @return a new instance of MT540 or null if; file is null, does not exist, can't be read, is not a file or the message cannot be parsed
	 * @throws IOException if the file content cannot be read
	 * @since 7.7
	 */
	public static MT540 parse(final File file) throws IOException {
		if (file == null) {
			return null;
		}
		return new MT540(file);
    }
    ...
    /**
	 * Creates an MT540 messages from its JSON representation.
	 * <p>
	 * For generic conversion of JSON into the corresopnding MT instance
	 * see {@link AbstractMT#fromJson(String)}
	 *
	 * @param json a JSON representation of an MT540 message
	 * @return a new instance of MT540
	 * @since 7.10.3
	 */
	public final static MT540 fromJson(String json) {
		return (MT540) AbstractMT.fromJson(json);
	}
...
// BaseSequenceCodeGenerator [seq=A]
	/**
	 * Class to model Sequence "A" in MT 540
	 */
...
// BaseSequenceCodeGenerator [seq=A1]
	/**
	 * Class to model Sequence "A1" in MT 540
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=B]
	/**
	 * Class to model Sequence "B" in MT 540
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=B1]
	/**
	 * Class to model Sequence "B1" in MT 540
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=C]
	/**
	 * Class to model Sequence "C" in MT 540
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=C1]
	/**
	 * Class to model Sequence "C1" in MT 540
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=D]
	/**
	 * Class to model Sequence "D" in MT 540
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=E]
	/**
	 * Class to model Sequence "E" in MT 540
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=E1]
	/**
	 * Class to model Sequence "E1" in MT 540
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=E2]
	/**
	 * Class to model Sequence "E2" in MT 540
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=E3]
	/**
	 * Class to model Sequence "E3" in MT 540
	 */
	@SequenceStyle(Type.GENERATED_16RS)
...
// BaseSequenceCodeGenerator [seq=F]
	/**
	 * Class to model Sequence "F" in MT 540
	 */
	@SequenceStyle(Type.GENERATED_16RS)
