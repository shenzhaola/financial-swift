...
/**
 * <strong>MT 910 - Confirmation of Credit</strong>
 *
 * <p>
 * SWIFT MT910 (ISO 15022) message structure:
 * <br>
 <div class="scheme"><ul>
<li class="field">Field 20  (M)</li>
<li class="field">Field 21  (M)</li>
<li class="field">Field 25 P,NONE (M)</li>
<li class="field">Field 13 D (O)</li>
 ...
 */
@Generated
public class MT910 extends AbstractMT implements Serializable {
	/**
	 * Constant identifying the SRU to which this class belongs to.
	 */
	public static final int SRU = 2018;
	private static final long serialVersionUID = 1L;
	private static final transient java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT910.class.getName());
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT910 content
	 */
	 ...
	 * @param m swift message with the MT910 content, the parameter can not be null
	 * @see #MT910(String)
	 */
	...
	/**
	 * Creates and initializes a new MT910 input message setting TEST BICS as sender and receiver.<br>
	...
	/**
	 * Creates and initializes a new MT910 input message from sender to receiver.<br>
	 * All mandatory header attributes are completed with default values. 
	 ...
	 * @since 7.7
	 */
	public MT910(final String sender, final String receiver) {
    ...
    * @param sender the sender address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @param receiver the receiver address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @see #MT910(String, String)
	* @deprecated Use instead <code>new MT910(sender, receiver)</code> instead
	*/
	@Deprecated
	@com.financial.deprecation.ProwideDeprecated(phase4=com.financial.deprecation.TargetYear._2019)
	public MT910(final int messageType, final String sender, final String receiver) {
		super(910, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT910(int, String, String)", "Use the constructor MT910(sender, receiver) instead.");
	}
	
	/**
	 * Creates a new MT910 by parsing a String with the message content in its swift FIN format.<br>
	...
	/**
	 * Creates a new MT910 by parsing a String with the message content in its swift FIN format.<br>
	 * If the fin parameter cannot be parsed, the returned MT910 will have its internal message object
	 * initialized (blocks will be created) but empty.<br>
	 * If the string contains multiple messages, only the first one will be parsed. 
	 *
	 * @param fin a string with the MT message in its FIN swift format. <em>fin may be null in which case this method returns null</em>
	 * @return a new instance of MT910 or null if fin is null 
	 * @since 7.7
	 */
	public static MT910 parse(final String fin) {
		if (fin == null) {
			return null;
		}
    ...
    /**
	 * Creates a new MT910 by parsing a input stream with the message content in its swift FIN format, using "UTF-8" as encoding.<br>
	 ...
	 * @since 7.7
	 */
	public MT910(final InputStream stream) throws IOException {
	 ...
	 *
	 * @param stream an input stream in UTF-8 encoding with the MT message in its FIN swift format.
	 * @return a new instance of MT910 or null if stream is null or the message cannot be parsed 
	 * @throws IOException if the stream data cannot be read
	 * @since 7.7
	 */
	public static MT910 parse(final InputStream stream) throws IOException {
		if (stream == null) {
			return null;
		}
    ...
    /**
	 * Creates a new MT910 by parsing a file with the message content in its swift FIN format.<br>
	 ...
	 * @since 7.7
	 */
	public MT910(final File file) throws IOException {
	 ...
	 *
	 * @param file a file with the MT message in its FIN swift format.
	 * @return a new instance of MT910 or null if; file is null, does not exist, can't be read, is not a file or the message cannot be parsed
	 * @throws IOException if the file content cannot be read
	 * @since 7.7
	 */
	public static MT910 parse(final File file) throws IOException {
		if (file == null) {
			return null;
		}
	 ...
	 */
	@Override
	public MT910 append(final SwiftTagListBlock block) {
		super.append(block);
		return this;
	}
	 ...
	 */
	@Override
	public MT910 append(final Tag ... tags) {
		super.append(tags);
		return this;
	}
	 ...
	 */
	@Override
	public MT910 append(final Field ... fields) {
		super.append(fields);
		return this;
	}

    /**
	 * Creates an MT910 messages from its JSON representation.
	 * <p>
	 * For generic conversion of JSON into the corresopnding MT instance
	 * see {@link AbstractMT#fromJson(String)}
	 *
	 * @param json a JSON representation of an MT910 message
	 * @return a new instance of MT910
	 * @since 7.10.3
	 */
	public final static MT910 fromJson(String json) {
