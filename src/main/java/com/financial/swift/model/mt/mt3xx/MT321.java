...
// end qualifiers constants	
    ...
    * @param sender the sender address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @param receiver the receiver address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @see #MT321(String, String)
	* @deprecated Use instead <code>new MT321(sender, receiver)</code> instead
	*/
	@Deprecated
	@com.financial.deprecation.ProwideDeprecated(phase4=com.financial.deprecation.TargetYear._2019)
	public MT321(final int messageType, final String sender, final String receiver) {
		super(321, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT321(int, String, String)", "Use the constructor MT321(sender, receiver) instead.");
	}
