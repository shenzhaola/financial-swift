...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT101_RUR6 content, the parameter can not be null
	...
	*/
	...
	public MT101_RUR6(final int messageType, final String sender, final String receiver) {
		super(101, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT101_RUR6(int, String, String)", "Use the constructor MT101_RUR6(sender, receiver) instead.");
	}
	 ...
	 *
	 * @param json a JSON representation of an MT101_RUR6 message
	 * @return a new instance of MT101_RUR6
	 * @since 7.10.3
	 */
	public final static MT101_RUR6 fromJson(String json) {
