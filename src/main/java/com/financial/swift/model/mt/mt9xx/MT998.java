...
public class MT998 extends AbstractMT implements Serializable {
	...
	private static final transient java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT998.class.getName());
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT998 content, the parameter can not be null
	 * @see #MT998(String)
	 */
	 ...
	 * @since 7.7
	 */
	public MT998(final String sender, final String receiver) {
	...
	*/
	...
	public MT998(final int messageType, final String sender, final String receiver) {
		super(998, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT998(int, String, String)", "Use the constructor MT998(sender, receiver) instead.");
	}
	 ...
	 * @return a new instance of MT998 or null if fin is null 
	 * @since 7.7
	 */
	public static MT998 parse(final String fin) {
		if (fin == null) {
			return null;
		}
	 ...
	 * @since 7.7
	 */
	public MT998(final InputStream stream) throws IOException {
	 ...
	 *
	 * @param stream an input stream in UTF-8 encoding with the MT message in its FIN swift format.
	 * @return a new instance of MT998 or null if stream is null or the message cannot be parsed 
	 * @throws IOException if the stream data cannot be read
	 * @since 7.7
	 */
	public static MT998 parse(final InputStream stream) throws IOException {
		if (stream == null) {
			return null;
		}
	 ...
	 * @since 7.7
	 */
	public MT998(final File file) throws IOException {
	 ...
	 *
	 * @param file a file with the MT message in its FIN swift format.
	 * @return a new instance of MT998 or null if; file is null, does not exist, can't be read, is not a file or the message cannot be parsed
	 * @throws IOException if the file content cannot be read
	 * @since 7.7
	 */
	public static MT998 parse(final File file) throws IOException {
		if (file == null) {
			return null;
		}
	 ...
	 *
	 * @param json a JSON representation of an MT998 message
	 * @return a new instance of MT998
	 * @since 7.10.3
	 */
	public final static MT998 fromJson(String json) {
