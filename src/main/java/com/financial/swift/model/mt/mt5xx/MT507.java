...
// end qualifiers constants	
	...
	* @deprecated Use instead <code>new MT507(sender, receiver)</code> instead
	*/
	@Deprecated
	@com.financial.deprecation.ProwideDeprecated(phase4=com.financial.deprecation.TargetYear._2019)
	public MT507(final int messageType, final String sender, final String receiver) {
		super(507, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT507(int, String, String)", "Use the constructor MT507(sender, receiver) instead.");
	}
