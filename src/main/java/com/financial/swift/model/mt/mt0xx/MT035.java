...
/**
 * <strong>MT 035 - Delivery Instruction Request</strong>
 *
 * <p>
 * SWIFT MT035 (ISO 15022) message structure:
 * <br>
 <div class="scheme"><ul>
</ul></div>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT035 content, the parameter can not be null
	 * @see #MT035(String)
	 */
	...
	*/
	...
	public MT035(final int messageType, final String sender, final String receiver) {
		super(35, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT035(int, String, String)", "Use the constructor MT035(sender, receiver) instead.");
	}
