...
/**
 * <strong>MT 081 - Daily Check Report</strong>
 *
 * <p>
 * SWIFT MT081 (ISO 15022) message structure:
 * <br>
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT081 content, the parameter can not be null
	 * @see #MT081(String)
	 */
	...
	*/
	...
	public MT081(final int messageType, final String sender, final String receiver) {
		super(81, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT081(int, String, String)", "Use the constructor MT081(sender, receiver) instead.");
	}
    ...
    /**
	 * Creates an MT081 messages from its JSON representation.
	 * <p>
	 * For generic conversion of JSON into the corresopnding MT instance
	 * see {@link AbstractMT#fromJson(String)}
	 *
	 * @param json a JSON representation of an MT081 message
	 * @return a new instance of MT081
	 * @since 7.10.3
	 */
	public final static MT081 fromJson(String json) {
