...
// end qualifiers constants	
    ...
    * @param sender the sender address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @param receiver the receiver address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @see #MT063(String, String)
	* @deprecated Use instead <code>new MT063(sender, receiver)</code> instead
	*/
	@Deprecated
	@com.financial.deprecation.ProwideDeprecated(phase4=com.financial.deprecation.TargetYear._2019)
	public MT063(final int messageType, final String sender, final String receiver) {
		super(63, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT063(int, String, String)", "Use the constructor MT063(sender, receiver) instead.");
	}
