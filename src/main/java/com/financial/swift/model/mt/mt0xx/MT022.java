...
public class MT022 extends AbstractMT implements Serializable {
	...
	private static final transient java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT022.class.getName());
...
// end qualifiers constants	
	...
	*/
	...
	public MT022(final int messageType, final String sender, final String receiver) {
		super(22, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT022(int, String, String)", "Use the constructor MT022(sender, receiver) instead.");
	}
	 ...
	 * @since 7.10.3
	 */
	public final static MT022 fromJson(String json) {
