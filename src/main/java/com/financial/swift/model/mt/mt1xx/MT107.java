...
<li class="sequence">
Sequence C (M)<ul><li class="field">Field 32 B (M)</li>
...
// end qualifiers constants	
	...
	* @deprecated Use instead <code>new MT107(sender, receiver)</code> instead
	*/
	@Deprecated
	@com.financial.deprecation.ProwideDeprecated(phase4=com.financial.deprecation.TargetYear._2019)
	public MT107(final int messageType, final String sender, final String receiver) {
		super(107, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT107(int, String, String)", "Use the constructor MT107(sender, receiver) instead.");
	}
	 ...
	 * @since 7.10.3
	 */
	public final static MT107 fromJson(String json) {
