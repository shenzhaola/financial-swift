...
/**
 * <strong>MT 970 - Netting Statement</strong>
 *
 * <p>
 * SWIFT MT970 (ISO 15022) message structure:
 * <br>
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT970 content, the parameter can not be null
	 * @see #MT970(String)
	 */
	...
	*/
	...
	public MT970(final int messageType, final String sender, final String receiver) {
		super(970, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT970(int, String, String)", "Use the constructor MT970(sender, receiver) instead.");
	}
    ...
    /**
	 * Creates an MT970 messages from its JSON representation.
	 * <p>
	 * For generic conversion of JSON into the corresopnding MT instance
	 * see {@link AbstractMT#fromJson(String)}
	 *
	 * @param json a JSON representation of an MT970 message
	 * @return a new instance of MT970
	 * @since 7.10.3
	 */
	public final static MT970 fromJson(String json) {
		return (MT970) AbstractMT.fromJson(json);
	}
