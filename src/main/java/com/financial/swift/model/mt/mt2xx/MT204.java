...
// end qualifiers constants	
	...
	*/
	...
	public MT204(final int messageType, final String sender, final String receiver) {
		super(204, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT204(int, String, String)", "Use the constructor MT204(sender, receiver) instead.");
	}
	 ...
	 * @since 7.10.3
	 */
	public final static MT204 fromJson(String json) {
	...
	public List<Field53B> getField53B() {
		final List<Field53B> result = new ArrayList<Field53B>();
