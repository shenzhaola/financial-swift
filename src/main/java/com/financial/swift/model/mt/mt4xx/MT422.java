...
public class MT422 extends AbstractMT implements Serializable {
	...
	private static final transient java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT422.class.getName());
...
// end qualifiers constants	
	...
	*/
	...
	public MT422(final int messageType, final String sender, final String receiver) {
		super(422, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT422(int, String, String)", "Use the constructor MT422(sender, receiver) instead.");
	}
	 ...
	 * @since 7.10.3
	 */
	public final static MT422 fromJson(String json) {
