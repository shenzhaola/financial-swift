...
// end qualifiers constants	
    ...
    * @param sender the sender address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @param receiver the receiver address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @see #MT055(String, String)
	* @deprecated Use instead <code>new MT055(sender, receiver)</code> instead
	*/
	@Deprecated
	@com.financial.deprecation.ProwideDeprecated(phase4=com.financial.deprecation.TargetYear._2019)
	public MT055(final int messageType, final String sender, final String receiver) {
		super(55, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT055(int, String, String)", "Use the constructor MT055(sender, receiver) instead.");
	}
