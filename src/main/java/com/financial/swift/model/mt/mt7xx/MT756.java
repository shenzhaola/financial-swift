...
/**
 * <strong>MT 756 - Advice of Reimbursement or Payment</strong>
 *
 * <p>
...
// end qualifiers constants	
    ...
    * @param sender the sender address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @param receiver the receiver address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @see #MT756(String, String)
	* @deprecated Use instead <code>new MT756(sender, receiver)</code> instead
	*/
	@Deprecated
	...
	public MT756(final int messageType, final String sender, final String receiver) {
		super(756, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT756(int, String, String)", "Use the constructor MT756(sender, receiver) instead.");
	}
	
	/**
	 * Creates a new MT756 by parsing a String with the message content in its swift FIN format.<br>
    ...
    /**
	 * Creates a new MT756 by parsing a input stream with the message content in its swift FIN format, using "UTF-8" as encoding.<br>
    ...
    /**
	 * Creates a new MT756 by parsing a file with the message content in its swift FIN format.<br>
	 ...
	 * @since 7.10.3
	 */
	public final static MT756 fromJson(String json) {
