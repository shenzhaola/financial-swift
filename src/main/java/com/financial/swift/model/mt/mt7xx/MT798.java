...
/**
 * <strong>MT 798 - Proprietary Message</strong>
 *
 * <p>
...
public class MT798 extends AbstractMT implements Serializable {
	...
	private static final transient java.util.logging.Logger log = java.util.logging.Logger.getLogger(MT798.class.getName());
...
// end qualifiers constants	
    ...
    * @param sender the sender address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @param receiver the receiver address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @see #MT798(String, String)
	* @deprecated Use instead <code>new MT798(sender, receiver)</code> instead
	*/
	@Deprecated
	...
	public MT798(final int messageType, final String sender, final String receiver) {
		super(798, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT798(int, String, String)", "Use the constructor MT798(sender, receiver) instead.");
	}
	
	/**
	 * Creates a new MT798 by parsing a String with the message content in its swift FIN format.<br>
    ...
    /**
	 * Creates a new MT798 by parsing a input stream with the message content in its swift FIN format, using "UTF-8" as encoding.<br>
    ...
    /**
	 * Creates a new MT798 by parsing a file with the message content in its swift FIN format.<br>
	 ...
	 * @since 7.10.3
	 */
	public final static MT798 fromJson(String json) {
