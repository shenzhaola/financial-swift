...
// end qualifiers constants	
    ...
    * @param sender the sender address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @param receiver the receiver address as a bic8, bic11 or full logical terminal consisting of 12 characters
	* @see #MT065(String, String)
	* @deprecated Use instead <code>new MT065(sender, receiver)</code> instead
	*/
	@Deprecated
	@com.financial.deprecation.ProwideDeprecated(phase4=com.financial.deprecation.TargetYear._2019)
	public MT065(final int messageType, final String sender, final String receiver) {
		super(65, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT065(int, String, String)", "Use the constructor MT065(sender, receiver) instead.");
	}
	 ...
	 * @since 7.10.3
	 */
	public final static MT065 fromJson(String json) {
