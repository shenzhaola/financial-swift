...
/**
 * <strong>MT 986 - Status Report</strong>
 *
 * <p>
 * SWIFT MT986 (ISO 15022) message structure:
 * <br>
 <div class="scheme"><ul>
...
// end qualifiers constants	
	 ...
	 * @param m swift message with the MT986 content, the parameter can not be null
	 * @see #MT986(String)
	 */
	...
	* @deprecated Use instead <code>new MT986(sender, receiver)</code> instead
	*/
	@Deprecated
	...
	public MT986(final int messageType, final String sender, final String receiver) {
		super(986, sender, receiver);
		com.financial.deprecation.DeprecationUtils.phase3(getClass(), "MT986(int, String, String)", "Use the constructor MT986(sender, receiver) instead.");
	}
    ...
    private void sanityCheck(final SwiftMessage param) {
    	if (param.isServiceMessage()) {
			log.warning("Creating an MT986 object from FIN content with a Service Message. Check if the MT986 you are intended to read is prepended with and ACK.");
		} else if (!StringUtils.equals(param.getType(), getMessageType())) {
			log.warning("Creating an MT986 object from FIN content with message type "+param.getType());
		}
    }
    ...
    /**
	 * Creates an MT986 messages from its JSON representation.
	 * <p>
	 * For generic conversion of JSON into the corresopnding MT instance
	 * see {@link AbstractMT#fromJson(String)}
	 *
	 * @param json a JSON representation of an MT986 message
	 * @return a new instance of MT986
	 * @since 7.10.3
	 */
	public final static MT986 fromJson(String json) {
		return (MT986) AbstractMT.fromJson(json);
	}
