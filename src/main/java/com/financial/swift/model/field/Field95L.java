...
/**
 * <strong>SWIFT MT Field 95L</strong>
 * <p>
...
@Generated
public class Field95L extends Field implements Serializable, com.financial.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field95L> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field95L> result = new ArrayList<Field95L>(arr.length);
			for (final Tag f : arr) {
