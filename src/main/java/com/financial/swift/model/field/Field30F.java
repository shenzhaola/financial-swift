...
/**
 * <strong>SWIFT MT Field 30F</strong>
 * <p>
 * Model and parser for field 30F of a SWIFT MT message.
 *
...
@Generated
public class Field30F extends Field implements Serializable, DateContainer {
	/**
	 ...
	 */
	public Field30F(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field30F(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "30F")) {
	...
	*/
	 ...
	 */
	public Field30F setComponent1(java.util.Calendar component1) {
	 ...
	 */
	public Field30F setDate(java.util.Calendar component1) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field30F.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field30F.COMPONENTS_PATTERN
	 */
	@Override
	 ...
	 */
	public static Field30F get(final SwiftTagListBlock block) {
	...
	/**
	 * Gets the first instance of Field30F in the given message.
	 * @param msg may be empty or null
	 * @return null if not found or msg is empty or null
	 * @see #get(SwiftTagListBlock)
	 */
	public static Field30F get(final SwiftMessage msg) {
	...
	/**
	 * Gets a list of all occurrences of the field Field30F in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field30F> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field30F from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field30F> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field30F> result = new ArrayList<Field30F>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field30F object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field30F fromJson(final String json) {
