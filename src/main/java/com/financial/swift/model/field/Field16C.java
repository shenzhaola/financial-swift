...
/**
 * <strong>SWIFT MT Field 16C</strong>
 * <p>
 * Model and parser for field 16C of a SWIFT MT message.
 *
...
@Generated
public class Field16C extends Field implements Serializable {
	/**
	 ...
	 */
    public static final String NAME = "16C";
    /**
	 ...
	 */
	public Field16C(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field16C(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "16C")) {
			throw new IllegalArgumentException("cannot create field 16C from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	...
	*/
	 ...
	 */
	public Field16C setComponent1(String component1) {
	 ...
	 */
	public Field16C setNumber(String component1) {
		setComponent(1, component1);
		return this;
	}
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field16C.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field16C.COMPONENTS_PATTERN
	 */
	@Override
	 ...
	 */
	public static Field16C get(final SwiftTagListBlock block) {
		...
		return new Field16C(t) ;
	}
	
	/**
	 * Gets the first instance of Field16C in the given message.
	 * @param msg may be empty or null
	 * @return null if not found or msg is empty or null
	 * @see #get(SwiftTagListBlock)
	 */
	public static Field16C get(final SwiftMessage msg) {
	...
	/**
	 * Gets a list of all occurrences of the field Field16C in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field16C> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field16C from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field16C> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field16C> result = new ArrayList<Field16C>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field16C object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field16C fromJson(final String json) {
		Field16C field = new Field16C();
