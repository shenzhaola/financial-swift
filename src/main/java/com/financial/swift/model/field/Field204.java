...
public class Field204 extends Field implements Serializable {
	 ...
	 */
	public Field204(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field204(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "204")) {
			throw new IllegalArgumentException("cannot create field 204 from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field204 newInstance(Field204 source) {
		Field204 cp = new Field204();
	...
	*/
	 ...
	 * @param component1 the Logical Terminal Select State to set
	 */
	public Field204 setLogicalTerminalSelectState(String component1) {
		setComponent(1, component1);
		return this;
	}
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field204.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field204 in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field204 in the given message
	...
	/**
	 * Gets a list of all occurrences of the field Field204 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field204> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field204> result = new ArrayList<Field204>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 1) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 204");
		}
		if (component == 1) {
	...
	protected List<String> getComponentLabels() {
		...
		result.add("Logical Terminal Select State");
		return result;
	}
	...
	protected Map<Integer, String> getComponentMap() {
		...
		result.put(1, "logicalTerminalSelectState");
		return result;
	}

	/**
	 * This method deserializes the JSON data into a Field204 object.
	...
	public static Field204 fromJson(final String json) {
		...
		if (jsonObject.get("logicalTerminalSelectState") != null) {
			field.setComponent1(jsonObject.get("logicalTerminalSelectState").getAsString());
		}
		return field;
	}
