...
public class Field335 extends Field implements Serializable {
	...
	*/
	 ...
	 */
	public com.financial.swift.model.MIR getComponent2AsMIR() {
	 ...
	 */
	public Field335 setComponent2(com.financial.swift.model.MIR component2) {
	 ...
	 * @see #setComponent2(com.financial.swift.model.MIR)
	 * @param component2 MIR with the MIR content to set
	 */
	public Field335 setMIR(com.financial.swift.model.MIR component2) {
	 ...
	 */
	public com.financial.swift.model.LogicalTerminalAddress getComponent4AsLogicalTerminalAddress() {
	 ...
	 */
	public com.financial.swift.model.LogicalTerminalAddress getReceiverAsLogicalTerminalAddress() {
		return SwiftFormatUtils.getLTAddress(getComponent(4));
	}
	 ...
	 */
	public Field335 setComponent4(com.financial.swift.model.LogicalTerminalAddress component4) {
	 ...
	 * @see #setComponent4(com.financial.swift.model.LogicalTerminalAddress)
	 * @param component4 LogicalTerminalAddress with the Receiver content to set
	 */
	public Field335 setReceiver(com.financial.swift.model.LogicalTerminalAddress component4) {
   ...
   public String parserPattern() {
	...
	public static List<Field335> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field335> result = new ArrayList<Field335>(arr.length);
			for (final Tag f : arr) {
