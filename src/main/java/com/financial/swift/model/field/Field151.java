...
/**
 * <strong>SWIFT MT Field 151</strong>
 * <p>
 * Model and parser for field 151 of a SWIFT MT message.
 *
...
public class Field151 extends Field implements Serializable {
	 ...
	 */
	public Field151(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field151(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "151")) {
			throw new IllegalArgumentException("cannot create field 151 from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field151 newInstance(Field151 source) {
		Field151 cp = new Field151();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field151.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field151.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field151 get(final SwiftTagListBlock block) {
		...
		return new Field151(t) ;
	}
	
	/**
	 * Gets the first instance of Field151 in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field151 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field151> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field151 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field151> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field151> result = new ArrayList<Field151>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field151 object.
