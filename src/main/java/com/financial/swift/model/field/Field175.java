...
/**
 * <strong>SWIFT MT Field 175</strong>
 * <p>
 * Model and parser for field 175 of a SWIFT MT message.
 *
 ...
 * <ul>
 * 		<li>validation pattern: <code>&lt;HHMM&gt;</code></li>
 * 		<li>parser pattern: <code>S</code></li>
 * 		<li>components pattern: <code>H</code></li>
 * </ul>
 *		 
 * <p>
...
public class Field175 extends Field implements Serializable {
	 ...
	 */
	public Field175(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field175(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "175")) {
			throw new IllegalArgumentException("cannot create field 175 from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field175 newInstance(Field175 source) {
		Field175 cp = new Field175();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field175.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field175.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field175 get(final SwiftTagListBlock block) {
		...
		return new Field175(t) ;
	}
	
	/**
	 * Gets the first instance of Field175 in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field175 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field175> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field175 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field175> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field175> result = new ArrayList<Field175>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field175(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	/**
	 * This method deserializes the JSON data into a Field175 object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field175 fromJson(final String json) {
		Field175 field = new Field175();
