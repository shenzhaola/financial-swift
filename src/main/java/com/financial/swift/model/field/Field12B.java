...
/**
 * <strong>SWIFT MT Field 12B</strong>
 * <p>
 * Model and parser for field 12B of a SWIFT MT message.
 *
...
@Generated
public class Field12B extends Field implements Serializable, com.financial.swift.model.field.GenericField {
	/**
	 ...
	 */
	public Field12B(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field12B(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "12B")) {
			throw new IllegalArgumentException("cannot create field 12B from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field12B newInstance(Field12B source) {
		Field12B cp = new Field12B();
	...
	*/
	...
	/**
	 * Gets the Instrument Type Code (component3).
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field12B.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field12B.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field12B get(final SwiftTagListBlock block) {
		...
		return new Field12B(t) ;
	}
	
	/**
	 * Gets the first instance of Field12B in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field12B in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field12B> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field12B from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field12B> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field12B> result = new ArrayList<Field12B>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 3) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 12B");
		}
		if (component == 1) {
	...
	protected List<String> getComponentLabels() {
		...
		result.add("Instrument Type Code");
		return result;
	}
	...
	protected Map<Integer, String> getComponentMap() {
		...
		result.put(3, "instrumentTypeCode");
		return result;
	}

	/**
	 * This method deserializes the JSON data into a Field12B object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field12B fromJson(final String json) {
		Field12B field = new Field12B();
