...
/**
 * <strong>SWIFT MT Field 14F</strong>
 * <p>
...
public class Field14F extends Field implements Serializable {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field14F.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field14F> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field14F> result = new ArrayList<Field14F>(arr.length);
			for (final Tag f : arr) {
