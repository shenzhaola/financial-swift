...
@Generated
public class Field79Z extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field79Z> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field79Z> result = new ArrayList<Field79Z>(arr.length);
			for (final Tag f : arr) {
