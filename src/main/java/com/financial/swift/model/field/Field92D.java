...
/**
 * <strong>SWIFT MT Field 92D</strong>
 * <p>
...
@Generated
public class Field92D extends Field implements Serializable, AmountContainer, com.financial.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field92D> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field92D> result = new ArrayList<Field92D>(arr.length);
			for (final Tag f : arr) {
