...
/**
 * <strong>SWIFT MT Field 110</strong>
 * <p>
 * Model and parser for field 110 of a SWIFT MT message.
 *
...
public class Field110 extends Field implements Serializable {
	 ...
	 */
	public Field110(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field110(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "110")) {
			throw new IllegalArgumentException("cannot create field 110 from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field110 newInstance(Field110 source) {
		Field110 cp = new Field110();
	...
	*/
	...
	/**
	 * Gets the Window Size (component1).
	 ...
	 * @return the Window Size from component1 converted to Number or null if cannot be converted
	 */
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field110.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field110.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field110 get(final SwiftTagListBlock block) {
		...
		return new Field110(t) ;
	}
	
	/**
	 * Gets the first instance of Field110 in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field110 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field110> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field110 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field110> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field110> result = new ArrayList<Field110>(arr.length);
			for (final Tag f : arr) {
	...
	protected Map<Integer, String> getComponentMap() {
		...
		result.put(1, "windowSize");
		return result;
	}

	/**
	 * This method deserializes the JSON data into a Field110 object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field110 fromJson(final String json) {
		Field110 field = new Field110();
		JsonParser parser = new JsonParser();
		JsonObject jsonObject = (JsonObject) parser.parse(json);
		if (jsonObject.get("windowSize") != null) {
			field.setComponent1(jsonObject.get("windowSize").getAsString());
		}
		return field;
	}
