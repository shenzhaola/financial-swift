...
/**
 * <strong>SWIFT MT Field 54A</strong>
 * <p>
 * Model and parser for field 54A of a SWIFT MT message.
 *
...
@Generated
public class Field54A extends Field implements Serializable, BICContainer, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field54A(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field54A(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "54A")) {
			throw new IllegalArgumentException("cannot create field 54A from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field54A newInstance(Field54A source) {
		Field54A cp = new Field54A();
	...
	*/
	 ...
	 */
	public com.financial.swift.model.BIC getComponent3AsBIC() {
	 ...
	 */
	public Field54A setComponent3(com.financial.swift.model.BIC component3) {
	 ...
	 * @see #setComponent3(com.financial.swift.model.BIC)
	 * @param component3 BIC with the BIC content to set
	 */
	public Field54A setBIC(com.financial.swift.model.BIC component3) {
		setComponent3(component3);
		return this;
	}

	public List<BIC> bics () {
		final List<BIC> result = new ArrayList<com.financial.swift.model.BIC>();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field54A.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field54A.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field54A get(final SwiftTagListBlock block) {
		...
		return new Field54A(t) ;
	}
	
	/**
	 * Gets the first instance of Field54A in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field54A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field54A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field54A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field54A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field54A> result = new ArrayList<Field54A>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field54A(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 3) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 54A");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field54A object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field54A fromJson(final String json) {
		Field54A field = new Field54A();
