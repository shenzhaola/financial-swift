 ...
 * <ul>
 * 		<li>validation pattern: <code>&lt;TIME2&gt;</code></li>
 * 		<li>parser pattern: <code>S</code></li>
 * 		<li>components pattern: <code>T</code></li>
 * </ul>
 *		 
 * <p>
...
public class Field179 extends Field implements Serializable {
	 ...
	 */
	public Field179(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field179(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "179")) {
			throw new IllegalArgumentException("cannot create field 179 from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field179 newInstance(Field179 source) {
		Field179 cp = new Field179();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field179.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field179 in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field179 in the given message
	...
	/**
	 * Gets a list of all occurrences of the field Field179 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field179> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field179> result = new ArrayList<Field179>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field179 object.
