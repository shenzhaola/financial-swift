...
/**
 * <strong>SWIFT MT Field 71G</strong>
 * <p>
 * Model and parser for field 71G of a SWIFT MT message.
 *
...
public class Field71G extends Field implements Serializable, CurrencyContainer, AmountContainer {
	 ...
	 */
	public Field71G(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field71G(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "71G")) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field71G.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field71G.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field71G in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field71G in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field71G> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return java.util.Collections.emptyList();
	...
	/**
	 * Gets a list of all occurrences of the field Field71G from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field71G> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field71G> result = new ArrayList<Field71G>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field71G object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field71G fromJson(final String json) {
