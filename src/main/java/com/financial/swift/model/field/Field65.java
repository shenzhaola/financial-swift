...
/**
 * <strong>SWIFT MT Field 65</strong>
 * <p>
 * Model and parser for field 65 of a SWIFT MT message.
 *
...
public class Field65 extends Field implements Serializable, DateContainer, AmountContainer {
	 ...
	 */
	public Field65(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field65(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "65")) {
			throw new IllegalArgumentException("cannot create field 65 from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field65 newInstance(Field65 source) {
		Field65 cp = new Field65();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field65.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field65.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field65 get(final SwiftTagListBlock block) {
		...
		return new Field65(t) ;
	}
	
	/**
	 * Gets the first instance of Field65 in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field65 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field65> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field65 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field65> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field65> result = new ArrayList<Field65>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field65(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 4) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 65");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field65 object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field65 fromJson(final String json) {
		Field65 field = new Field65();
