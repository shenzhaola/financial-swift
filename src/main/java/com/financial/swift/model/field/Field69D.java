...
@Generated
public class Field69D extends Field implements Serializable, DateContainer, com.financial.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field69D> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field69D> result = new ArrayList<Field69D>(arr.length);
			for (final Tag f : arr) {
