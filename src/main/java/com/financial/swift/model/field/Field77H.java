...
@Generated
public class Field77H extends Field implements Serializable, DateContainer, com.financial.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field77H> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field77H> result = new ArrayList<Field77H>(arr.length);
			for (final Tag f : arr) {
