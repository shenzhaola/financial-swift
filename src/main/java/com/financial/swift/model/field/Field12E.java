...
/**
 * <strong>SWIFT MT Field 12E</strong>
 * <p>
 * Model and parser for field 12E of a SWIFT MT message.
 *
...
public class Field12E extends Field implements Serializable {
	 ...
	 */
	public Field12E(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field12E(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "12E")) {
			throw new IllegalArgumentException("cannot create field 12E from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field12E newInstance(Field12E source) {
		Field12E cp = new Field12E();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field12E.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field12E.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field12E get(final SwiftTagListBlock block) {
		...
		return new Field12E(t) ;
	}
	
	/**
	 * Gets the first instance of Field12E in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field12E in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field12E> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field12E from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field12E> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field12E> result = new ArrayList<Field12E>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field12E object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field12E fromJson(final String json) {
		Field12E field = new Field12E();
