...
public class Field257 extends Field implements Serializable, DateContainer {
	...
	*/
	 ...
	 */
	public Field257 setComponent1(com.financial.swift.model.LogicalTerminalAddress component1) {
	 ...
	 */
	public Field257 setLTAddress(com.financial.swift.model.LogicalTerminalAddress component1) {
   ...
   public String parserPattern() {
	...
	public static List<Field257> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field257> result = new ArrayList<Field257>(arr.length);
			for (final Tag f : arr) {
