...
@Generated
public class Field25P extends Field implements Serializable, BICContainer, com.financial.swift.model.field.MultiLineField {
	/**
	...
	*/
	 ...
	 */
	public Field25P setComponent2(com.financial.swift.model.BIC component2) {
	 ...
	 */
	public Field25P setBIC(com.financial.swift.model.BIC component2) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field25P.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field25P> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field25P> result = new ArrayList<Field25P>(arr.length);
			for (final Tag f : arr) {
