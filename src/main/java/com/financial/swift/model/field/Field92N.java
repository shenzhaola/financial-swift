...
/**
 * <strong>SWIFT MT Field 92N</strong>
 * <p>
 * Model and parser for field 92N of a SWIFT MT message.
 *
 ...
 * <ul>
 * 		<li>validation pattern: <code>:4!c//&lt;AMOUNT&gt;15/&lt;CUR&gt;&lt;AMOUNT&gt;15</code></li>
 * 		<li>parser pattern: <code>:S//N/SN</code></li>
 * 		<li>components pattern: <code>SNCN</code></li>
 * </ul>
 *		 
 * <p>
...
@Generated
public class Field92N extends Field implements Serializable, CurrencyContainer, AmountContainer, com.financial.swift.model.field.GenericField {
	/**
	...
	*/
	 ...
	 * @return the Quantity from component2 converted to Number or null if cannot be converted
	 */
   ...
   public String parserPattern() {
	...
	/**
	 * Gets the first instance of Field92N in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field92N in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field92N> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return java.util.Collections.emptyList();
	...
	/**
	 * Gets a list of all occurrences of the field Field92N from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field92N> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field92N> result = new ArrayList<Field92N>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field92N object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field92N fromJson(final String json) {
