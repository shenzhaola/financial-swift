...
/**
 * <strong>SWIFT MT Field 37V</strong>
 * <p>
 * Model and parser for field 37V of a SWIFT MT message.
 *
...
@Generated
public class Field37V extends Field implements Serializable, AmountContainer {
	/**
	 ...
	 */
	public Field37V(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field37V(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "37V")) {
	...
	*/
	 ...
	 */
	public Field37V setComponent2(java.lang.Number component2) {
	 ...
	 */
	public Field37V setRate(java.lang.Number component2) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field37V.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field37V.COMPONENTS_PATTERN
	 */
	@Override
	 ...
	 */
	public static Field37V get(final SwiftTagListBlock block) {
	...
	/**
	 * Gets the first instance of Field37V in the given message.
	 * @param msg may be empty or null
	 * @return null if not found or msg is empty or null
	 * @see #get(SwiftTagListBlock)
	 */
	public static Field37V get(final SwiftMessage msg) {
	...
	/**
	 * Gets a list of all occurrences of the field Field37V in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field37V> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field37V from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field37V> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field37V> result = new ArrayList<Field37V>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field37V object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field37V fromJson(final String json) {
