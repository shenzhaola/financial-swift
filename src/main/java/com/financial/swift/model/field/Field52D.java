...
/**
 * <strong>SWIFT MT Field 52D</strong>
 * <p>
 * Model and parser for field 52D of a SWIFT MT message.
 *
...
@Generated
public class Field52D extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field52D(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field52D(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "52D")) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field52D.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field52D.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field52D in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field52D in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field52D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field52D from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field52D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field52D> result = new ArrayList<Field52D>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field52D object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field52D fromJson(final String json) {
		Field52D field = new Field52D();
