...
/**
 * <strong>SWIFT MT Field 165</strong>
 * <p>
 * Model and parser for field 165 of a SWIFT MT message.
 *
 ...
 * <ul>
 * 		<li>validation pattern: <code>/3!c/34x</code></li>
...
@Generated
public class Field165 extends Field implements Serializable {
	/**
	 ...
	 */
	public Field165(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field165(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "165")) {
	...
	*/
	 ...
	 * @param component1 the Service Code to set
	 */
	 ...
	 * @param component2 the Payment Information to set
	 */
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field165.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field165.COMPONENTS_PATTERN
	 */
	@Override
	 ...
	 */
	public static Field165 get(final SwiftTagListBlock block) {
	...
	/**
	 * Gets the first instance of Field165 in the given message.
	 * @param msg may be empty or null
	 * @return null if not found or msg is empty or null
	 * @see #get(SwiftTagListBlock)
	 */
	public static Field165 get(final SwiftMessage msg) {
	...
	/**
	 * Gets a list of all occurrences of the field Field165 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field165> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field165 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field165> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field165> result = new ArrayList<Field165>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field165 object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field165 fromJson(final String json) {
