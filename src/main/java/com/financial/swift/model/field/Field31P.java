...
/**
 * <strong>SWIFT MT Field 31P</strong>
 * <p>
...
public class Field31P extends Field implements Serializable, DateContainer {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field31P.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field31P> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field31P> result = new ArrayList<Field31P>(arr.length);
			for (final Tag f : arr) {
