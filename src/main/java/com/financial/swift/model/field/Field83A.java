...
/**
 * <strong>SWIFT MT Field 83A</strong>
 * <p>
 * Model and parser for field 83A of a SWIFT MT message.
 *
...
@Generated
public class Field83A extends Field implements Serializable, BICContainer, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field83A(final String value) {
		super(value);
	}
	 ...
	 * @since 7.7
	 */
	public static Field83A newInstance(Field83A source) {
		Field83A cp = new Field83A();
	...
	*/
	 ...
	 */
	public Field83A setComponent3(com.financial.swift.model.BIC component3) {
	 ...
	 */
	public Field83A setBIC(com.financial.swift.model.BIC component3) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field83A.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field83A.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field83A get(final SwiftTagListBlock block) {
		...
		return new Field83A(t) ;
	}
	
	/**
	 * Gets the first instance of Field83A in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field83A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field83A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field83A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field83A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field83A> result = new ArrayList<Field83A>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field83A(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 3) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 83A");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field83A object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field83A fromJson(final String json) {
		Field83A field = new Field83A();
