...
/**
 * <strong>SWIFT MT Field 24D</strong>
 * <p>
...
public class Field24D extends Field implements Serializable {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field24D.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field24D> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field24D> result = new ArrayList<Field24D>(arr.length);
			for (final Tag f : arr) {
