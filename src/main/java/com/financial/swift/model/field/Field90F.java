...
@Generated
public class Field90F extends Field implements Serializable, CurrencyContainer, AmountContainer, com.financial.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field90F> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field90F> result = new ArrayList<Field90F>(arr.length);
			for (final Tag f : arr) {
