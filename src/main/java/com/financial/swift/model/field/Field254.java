...
public class Field254 extends Field implements Serializable {
	...
	*/
	 ...
	 */
	public com.financial.swift.model.MOR getStartMORAsMOR() {
		return SwiftFormatUtils.getMOR(getComponent(1));
	}
	 ...
	 */
	public Field254 setComponent1(com.financial.swift.model.MOR component1) {
	 ...
	 */
	public Field254 setStartMOR(com.financial.swift.model.MOR component1) {
	 ...
	 */
	public com.financial.swift.model.MOR getComponent2AsMOR() {
	 ...
	 */
	public com.financial.swift.model.MOR getEndMORAsMOR() {
		return SwiftFormatUtils.getMOR(getComponent(2));
	}
	 ...
	 */
	public Field254 setComponent2(com.financial.swift.model.MOR component2) {
	 ...
	 * @see #setComponent2(com.financial.swift.model.MOR)
	 * @param component2 MOR with the End MOR content to set
	 */
	public Field254 setEndMOR(com.financial.swift.model.MOR component2) {
   ...
   public String parserPattern() {
	...
	public static List<Field254> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field254> result = new ArrayList<Field254>(arr.length);
			for (final Tag f : arr) {
