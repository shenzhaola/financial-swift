...
/**
 * <strong>SWIFT MT Field 71F</strong>
 * <p>
...
public class Field71F extends Field implements Serializable, CurrencyContainer, AmountContainer {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field71F.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field71F> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field71F> result = new ArrayList<Field71F>(arr.length);
			for (final Tag f : arr) {
