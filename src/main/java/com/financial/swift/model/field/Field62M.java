...
/**
 * <strong>SWIFT MT Field 62M</strong>
 * <p>
 * Model and parser for field 62M of a SWIFT MT message.
 *
...
public class Field62M extends Field implements Serializable, DateContainer, AmountContainer {
	 ...
	 */
	public Field62M(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field62M(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "62M")) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field62M.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field62M.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field62M in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field62M in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field62M> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field62M from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field62M> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field62M> result = new ArrayList<Field62M>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field62M object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field62M fromJson(final String json) {
