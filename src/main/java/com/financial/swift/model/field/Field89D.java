...
/**
 * <strong>SWIFT MT Field 89D</strong>
 * <p>
...
@Generated
public class Field89D extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field89D(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field89D(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "89D")) {
			throw new IllegalArgumentException("cannot create field 89D from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field89D newInstance(Field89D source) {
		Field89D cp = new Field89D();
	...
	*/
	 ...
	 */
	public Field89D setNameAndAddressLine1(String component3) {
		setComponent(3, component3);
		return this;
	}
	 ...
	 */
	public Field89D setNameAndAddressLine2(String component4) {
	 ...
	 */
	public Field89D setNameAndAddressLine3(String component5) {
	 ...
	 */
	public Field89D setNameAndAddressLine4(String component6) {
	 ...
	 */
	public Field89D setNameAndAddress(String value) {
		List<String> lines = SwiftParseUtils.getLines(value);
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field89D.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field89D.COMPONENTS_PATTERN
	 */
	@Override
	 ...
	 */ 
	public static List<Field89D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	 ...
	 */ 
	public static List<Field89D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field89D> result = new ArrayList<Field89D>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field89D(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 6) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 89D");
		}
		if (component == 1) {
	 ...
	 */
	public static Field89D fromJson(final String json) {
		Field89D field = new Field89D();
