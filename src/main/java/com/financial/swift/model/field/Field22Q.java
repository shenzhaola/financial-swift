 ...
 * <ul>
 * 		<li>validation pattern: <code>10x</code></li>
...
public class Field22Q extends Field implements Serializable {
	 ...
	 */
	public Field22Q(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field22Q(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "22Q")) {
			throw new IllegalArgumentException("cannot create field 22Q from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field22Q newInstance(Field22Q source) {
		Field22Q cp = new Field22Q();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field22Q.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field22Q in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field22Q in the given message
	...
	/**
	 * Gets a list of all occurrences of the field Field22Q from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field22Q> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field22Q> result = new ArrayList<Field22Q>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 1) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 22Q");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field22Q object.
