...
@Generated
public class Field50F extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field50F> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field50F> result = new ArrayList<Field50F>(arr.length);
			for (final Tag f : arr) {
