...
/**
 * <strong>SWIFT MT Field 85B</strong>
 * <p>
 * Model and parser for field 85B of a SWIFT MT message.
 *
...
@Generated
public class Field85B extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field85B(final String value) {
		super(value);
	}
	 ...
	 * @since 7.7
	 */
	public static Field85B newInstance(Field85B source) {
		Field85B cp = new Field85B();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field85B.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field85B.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field85B get(final SwiftTagListBlock block) {
		...
		return new Field85B(t) ;
	}
	
	/**
	 * Gets the first instance of Field85B in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field85B in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field85B> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field85B from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field85B> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field85B> result = new ArrayList<Field85B>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field85B(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 3) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 85B");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field85B object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field85B fromJson(final String json) {
		Field85B field = new Field85B();
