...
/**
 * <strong>SWIFT MT Field 86B</strong>
 * <p>
...
@Generated
public class Field86B extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field86B.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field86B> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field86B> result = new ArrayList<Field86B>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 3) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 86B");
		}
		if (component == 1) {
