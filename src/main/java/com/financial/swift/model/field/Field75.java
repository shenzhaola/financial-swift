...
/**
 * <strong>SWIFT MT Field 75</strong>
 * <p>
...
@Generated
public class Field75 extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	...
	*/
	 ...
	 */
	public Field75 setNarrativeLine1(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field75 setNarrativeLine2(String component2) {
	 ...
	 */
	public Field75 setNarrativeLine3(String component3) {
	 ...
	 */
	public Field75 setNarrativeLine4(String component4) {
	 ...
	 */
	public Field75 setNarrativeLine5(String component5) {
	 ...
	 */
	public Field75 setNarrativeLine6(String component6) {
	 ...
	 */
	public Field75 setNarrative(String value) {
		List<String> lines = SwiftParseUtils.getLines(value);
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field75.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field75> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field75> result = new ArrayList<Field75>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 6) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 75");
		}
		if (component == 1) {
