...
/**
 * <strong>SWIFT MT Field 42P</strong>
 * <p>
 * Model and parser for field 42P of a SWIFT MT message.
 *
...
@Generated
public class Field42P extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field42P(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field42P(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "42P")) {
			throw new IllegalArgumentException("cannot create field 42P from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field42P newInstance(Field42P source) {
		Field42P cp = new Field42P();
	...
	*/
	 ...
	 */
	public Field42P setNarrativeLine1(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field42P setNarrativeLine2(String component2) {
	 ...
	 */
	public Field42P setNarrativeLine3(String component3) {
	 ...
	 */
	public Field42P setNarrativeLine4(String component4) {
	 ...
	 */
	public Field42P setNarrative(String value) {
		List<String> lines = SwiftParseUtils.getLines(value);
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field42P.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field42P.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field42P get(final SwiftTagListBlock block) {
		...
		return new Field42P(t) ;
	}
	
	/**
	 * Gets the first instance of Field42P in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field42P in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field42P> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field42P from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field42P> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field42P> result = new ArrayList<Field42P>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field42P(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 4) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 42P");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field42P object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field42P fromJson(final String json) {
		Field42P field = new Field42P();
