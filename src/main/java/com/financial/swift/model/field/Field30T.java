...
/**
 * <strong>SWIFT MT Field 30T</strong>
 * <p>
 * Model and parser for field 30T of a SWIFT MT message.
 *
...
public class Field30T extends Field implements Serializable, DateContainer {
	 ...
	 */
	public Field30T(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field30T(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "30T")) {
			throw new IllegalArgumentException("cannot create field 30T from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field30T newInstance(Field30T source) {
		Field30T cp = new Field30T();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field30T.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field30T.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field30T get(final SwiftTagListBlock block) {
		...
		return new Field30T(t) ;
	}
	
	/**
	 * Gets the first instance of Field30T in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field30T in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field30T> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field30T from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field30T> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field30T> result = new ArrayList<Field30T>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field30T(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 1) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 30T");
		}
		if (component == 1) {
			//date
	...
	/**
	 * This method deserializes the JSON data into a Field30T object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field30T fromJson(final String json) {
		Field30T field = new Field30T();
