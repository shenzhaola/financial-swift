...
/**
 * <strong>SWIFT MT Field 98F</strong>
 * <p>
 * Model and parser for field 98F of a SWIFT MT message.
 *
 ...
 * <ul>
 * 		<li>validation pattern: <code>:4!c/[8c]/4!c&lt;TIME2&gt;</code></li>
 * 		<li>parser pattern: <code>:S/[S]/S&lt;TIME2&gt;</code></li>
 * 		<li>components pattern: <code>SSST</code></li>
 * </ul>
 *		 
 * <p>
...
@Generated
public class Field98F extends Field implements Serializable, com.financial.swift.model.field.GenericField {
	/**
	 ...
	 */
	public Field98F(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field98F(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "98F")) {
	...
	public void parse(final String value) {
		...
		if (toparse2 != null) {
		    if (toparse2.length() >= 6) {
				setComponent3(StringUtils.substring(toparse2, 0, toparse2.length()-6));
				setComponent4(StringUtils.substring(toparse2, toparse2.length()-6));
		    } else {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field98F.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field98F.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field98F in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field98F in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field98F> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field98F from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field98F> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field98F> result = new ArrayList<Field98F>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field98F object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field98F fromJson(final String json) {
		Field98F field = new Field98F();
