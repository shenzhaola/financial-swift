...
@Generated
public class Field70E extends Field implements Serializable, com.financial.swift.model.field.GenericField, com.financial.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field70E> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field70E> result = new ArrayList<Field70E>(arr.length);
			for (final Tag f : arr) {
