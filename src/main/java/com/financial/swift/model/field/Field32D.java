...
/**
 * <strong>SWIFT MT Field 32D</strong>
 * <p>
 * Model and parser for field 32D of a SWIFT MT message.
 *
...
public class Field32D extends Field implements Serializable, CurrencyContainer, DateContainer, AmountContainer {
	 ...
	 */
	public Field32D(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field32D(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "32D")) {
			throw new IllegalArgumentException("cannot create field 32D from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field32D newInstance(Field32D source) {
		Field32D cp = new Field32D();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field32D.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field32D.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field32D get(final SwiftTagListBlock block) {
		...
		return new Field32D(t) ;
	}
	
	/**
	 * Gets the first instance of Field32D in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field32D in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field32D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return java.util.Collections.emptyList();
	...
	/**
	 * Gets a list of all occurrences of the field Field32D from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field32D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field32D> result = new ArrayList<Field32D>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field32D(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	/**
	 * This method deserializes the JSON data into a Field32D object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field32D fromJson(final String json) {
		Field32D field = new Field32D();
