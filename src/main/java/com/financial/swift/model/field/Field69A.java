...
/**
 * <strong>SWIFT MT Field 69A</strong>
 * <p>
...
@Generated
public class Field69A extends Field implements Serializable, DateContainer, com.financial.swift.model.field.GenericField {
	/**
	...
	*/
	...
	/**
	 * Gets the Date1 (component2).
	 * @return the Date1 from component2
	 */
	 ...
	 * @return the Date1 from component2 converted to Calendar or null if cannot be converted
	 */
	...
	/**
	 * Gets the Date2 (component3).
	 * @return the Date2 from component3
	 */
	 ...
	 * @return the Date2 from component3 converted to Calendar or null if cannot be converted
	 */
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field69A.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field69A> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field69A> result = new ArrayList<Field69A>(arr.length);
			for (final Tag f : arr) {
