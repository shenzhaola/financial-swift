...
/**
 * <strong>SWIFT MT Field 33D</strong>
 * <p>
...
@Generated
public class Field33D extends Field implements Serializable, CurrencyContainer, DateContainer, AmountContainer {
	/**
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field33D.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field33D> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field33D> result = new ArrayList<Field33D>(arr.length);
			for (final Tag f : arr) {
