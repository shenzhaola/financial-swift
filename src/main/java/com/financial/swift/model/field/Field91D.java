...
/**
 * <strong>SWIFT MT Field 91D</strong>
 * <p>
...
@Generated
public class Field91D extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field91D(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field91D(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "91D")) {
			throw new IllegalArgumentException("cannot create field 91D from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	...
	*/
	 ...
	 */
	public Field91D setNameAndAddressLine1(String component3) {
		setComponent(3, component3);
		return this;
	}
	 ...
	 */
	public Field91D setNameAndAddressLine2(String component4) {
	 ...
	 */
	public Field91D setNameAndAddressLine3(String component5) {
	 ...
	 */
	public Field91D setNameAndAddressLine4(String component6) {
	 ...
	 */
	public Field91D setNameAndAddress(String value) {
		List<String> lines = SwiftParseUtils.getLines(value);
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field91D.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field91D.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets a list of all occurrences of the field Field91D in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field91D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field91D from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field91D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field91D> result = new ArrayList<Field91D>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field91D(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 6) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 91D");
		}
		if (component == 1) {
	 ...
	 */
	public static Field91D fromJson(final String json) {
		Field91D field = new Field91D();
