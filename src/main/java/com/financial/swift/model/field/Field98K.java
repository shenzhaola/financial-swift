...
@Generated
public class Field98K extends Field implements Serializable, DateContainer, com.financial.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field98K> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field98K> result = new ArrayList<Field98K>(arr.length);
			for (final Tag f : arr) {
