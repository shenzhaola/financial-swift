...
/**
 * <strong>SWIFT MT Field 140</strong>
 * <p>
 * Model and parser for field 140 of a SWIFT MT message.
 *
 ...
 * <ul>
 * 		<li>validation pattern: <code>15!n</code></li>
...
public class Field140 extends Field implements Serializable {
	 ...
	 */
	public static final Integer IDENTIFIER = 1;
	 ...
	 */
	public Field140(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field140(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "140")) {
			throw new IllegalArgumentException("cannot create field 140 from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field140 newInstance(Field140 source) {
		Field140 cp = new Field140();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field140.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field140.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field140 get(final SwiftTagListBlock block) {
		...
		return new Field140(t) ;
	}
	
	/**
	 * Gets the first instance of Field140 in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field140 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field140> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field140 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field140> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field140> result = new ArrayList<Field140>(arr.length);
			for (final Tag f : arr) {
	...
	protected Map<Integer, String> getComponentMap() {
		...
		result.put(1, "identifier");
		return result;
	}

	/**
	 * This method deserializes the JSON data into a Field140 object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field140 fromJson(final String json) {
		Field140 field = new Field140();
		JsonParser parser = new JsonParser();
		JsonObject jsonObject = (JsonObject) parser.parse(json);
		if (jsonObject.get("identifier") != null) {
			field.setComponent1(jsonObject.get("identifier").getAsString());
		}
		return field;
	}
