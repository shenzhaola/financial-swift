...
/**
 * <strong>SWIFT MT Field 81D</strong>
 * <p>
 * Model and parser for field 81D of a SWIFT MT message.
 *
...
@Generated
public class Field81D extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field81D(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field81D(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "81D")) {
			throw new IllegalArgumentException("cannot create field 81D from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field81D newInstance(Field81D source) {
		Field81D cp = new Field81D();
	...
	*/
	 ...
	 */
	public Field81D setNameAndAddressLine1(String component3) {
		setComponent(3, component3);
		return this;
	}
	 ...
	 */
	public Field81D setNameAndAddressLine2(String component4) {
	 ...
	 */
	public Field81D setNameAndAddressLine3(String component5) {
	 ...
	 */
	public Field81D setNameAndAddressLine4(String component6) {
	 ...
	 */
	public Field81D setNameAndAddress(String value) {
		List<String> lines = SwiftParseUtils.getLines(value);
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field81D.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field81D.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field81D get(final SwiftTagListBlock block) {
		...
		return new Field81D(t) ;
	}
	
	/**
	 * Gets the first instance of Field81D in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field81D in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field81D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field81D from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field81D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field81D> result = new ArrayList<Field81D>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field81D(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 6) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 81D");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field81D object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field81D fromJson(final String json) {
		Field81D field = new Field81D();
