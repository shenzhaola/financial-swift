...
/**
 * <strong>SWIFT MT Field 34J</strong>
 * <p>
 * Model and parser for field 34J of a SWIFT MT message.
 *
...
public class Field34J extends Field implements Serializable, AmountContainer {
	 ...
	 */
	public Field34J(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field34J(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "34J")) {
			throw new IllegalArgumentException("cannot create field 34J from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field34J newInstance(Field34J source) {
		Field34J cp = new Field34J();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field34J.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field34J.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field34J get(final SwiftTagListBlock block) {
		...
		return new Field34J(t) ;
	}
	
	/**
	 * Gets the first instance of Field34J in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field34J in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field34J> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field34J from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field34J> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field34J> result = new ArrayList<Field34J>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field34J(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	/**
	 * This method deserializes the JSON data into a Field34J object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field34J fromJson(final String json) {
		Field34J field = new Field34J();
