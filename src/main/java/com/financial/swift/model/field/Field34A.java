...
/**
 * <strong>SWIFT MT Field 34A</strong>
 * <p>
 * Model and parser for field 34A of a SWIFT MT message.
 *
...
public class Field34A extends Field implements Serializable, CurrencyContainer, DateContainer, AmountContainer {
	 ...
	 */
	public Field34A(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field34A(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "34A")) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field34A.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field34A.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field34A in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field34A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field34A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return java.util.Collections.emptyList();
	...
	/**
	 * Gets a list of all occurrences of the field Field34A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field34A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field34A> result = new ArrayList<Field34A>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field34A object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field34A fromJson(final String json) {
