...
/**
 * <strong>SWIFT MT Field 50</strong>
 * <p>
 * Model and parser for field 50 of a SWIFT MT message.
 *
...
@Generated
public class Field50 extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field50(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field50(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "50")) {
			throw new IllegalArgumentException("cannot create field 50 from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field50 newInstance(Field50 source) {
		Field50 cp = new Field50();
	...
	*/
	 ...
	 */
	public Field50 setNameAndAddressLine1(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field50 setNameAndAddressLine2(String component2) {
	 ...
	 */
	public Field50 setNameAndAddressLine3(String component3) {
	 ...
	 */
	public Field50 setNameAndAddressLine4(String component4) {
	 ...
	 */
	public Field50 setNameAndAddress(String value) {
		List<String> lines = SwiftParseUtils.getLines(value);
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field50.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field50.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field50 get(final SwiftTagListBlock block) {
		...
		return new Field50(t) ;
	}
	
	/**
	 * Gets the first instance of Field50 in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field50 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field50> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field50 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field50> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field50> result = new ArrayList<Field50>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field50(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 4) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 50");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field50 object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field50 fromJson(final String json) {
