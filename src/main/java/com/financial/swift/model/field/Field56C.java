...
/**
 * <strong>SWIFT MT Field 56C</strong>
 * <p>
...
public class Field56C extends Field implements Serializable {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field56C.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field56C> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field56C> result = new ArrayList<Field56C>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 1) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 56C");
		}
		if (component == 1) {
