...
/**
 * <strong>SWIFT MT Field 253</strong>
 * <p>
 * Model and parser for field 253 of a SWIFT MT message.
 *
 ...
 * 		<li>components pattern: <code>V</code></li>
 * </ul>
 *		 
 * <p>
...
public class Field253 extends Field implements Serializable {
	...
	*/
	 ...
	 */
	public com.financial.swift.model.MOR getComponent1AsMOR() {
	 ...
	 */
	public com.financial.swift.model.MOR getMORAsMOR() {
		return SwiftFormatUtils.getMOR(getComponent(1));
	}
	 ...
	 */
	public Field253 setComponent1(com.financial.swift.model.MOR component1) {
	 ...
	 * @see #setComponent1(com.financial.swift.model.MOR)
	 * @param component1 MOR with the MOR content to set
	 */
	public Field253 setMOR(com.financial.swift.model.MOR component1) {
   ...
   public String parserPattern() {
	...
	/**
	 * Gets the first instance of Field253 in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field253 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field253> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field253 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field253> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field253> result = new ArrayList<Field253>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field253 object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field253 fromJson(final String json) {
		Field253 field = new Field253();
