...
/**
 * <strong>SWIFT MT Field 12</strong>
 * <p>
...
public class Field12 extends Field implements Serializable {
	...
	*/
	...
	/**
	 * Gets the Message Type (component1).
	 * @return the Message Type from component1
	 */
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field12.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field12> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field12> result = new ArrayList<Field12>(arr.length);
			for (final Tag f : arr) {
