...
/**
 * <strong>SWIFT MT Field 342</strong>
 * <p>
...
public class Field342 extends Field implements Serializable {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field342.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field342> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field342> result = new ArrayList<Field342>(arr.length);
			for (final Tag f : arr) {
