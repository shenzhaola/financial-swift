...
/**
 * <strong>SWIFT MT Field 329</strong>
 * <p>
 * Model and parser for field 329 of a SWIFT MT message.
 *
...
public class Field329 extends Field implements Serializable {
	 ...
	 */
	public Field329(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field329(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "329")) {
			throw new IllegalArgumentException("cannot create field 329 from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field329 newInstance(Field329 source) {
		Field329 cp = new Field329();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field329.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field329.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field329 get(final SwiftTagListBlock block) {
		...
		return new Field329(t) ;
	}
	
	/**
	 * Gets the first instance of Field329 in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field329 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field329> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field329 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field329> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field329> result = new ArrayList<Field329>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field329(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	protected Map<Integer, String> getComponentMap() {
		...
		result.put(1, "reconnectAllowedOption");
		return result;
	}

	/**
	 * This method deserializes the JSON data into a Field329 object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field329 fromJson(final String json) {
		Field329 field = new Field329();
		JsonParser parser = new JsonParser();
		JsonObject jsonObject = (JsonObject) parser.parse(json);
		if (jsonObject.get("reconnectAllowedOption") != null) {
			field.setComponent1(jsonObject.get("reconnectAllowedOption").getAsString());
		}
		return field;
	}
