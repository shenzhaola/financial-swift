...
/**
 * <strong>SWIFT MT Field 31C</strong>
 * <p>
 * Model and parser for field 31C of a SWIFT MT message.
 *
...
public class Field31C extends Field implements Serializable, DateContainer {
	 ...
	 */
	public Field31C(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field31C(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "31C")) {
			throw new IllegalArgumentException("cannot create field 31C from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field31C newInstance(Field31C source) {
		Field31C cp = new Field31C();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field31C.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field31C.COMPONENTS_PATTERN
	 */
	@Override
	 ...
	 */ 
	public static List<Field31C> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	 ...
	 */ 
	public static List<Field31C> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field31C> result = new ArrayList<Field31C>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field31C(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 1) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 31C");
		}
		if (component == 1) {
			//date
