...
@Generated
public class Field29N extends Field implements Serializable, DateContainer {
	/**
	 ...
	 */
	public Field29N(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field29N(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "29N")) {
	...
	*/
	 ...
	 */
	public Field29N setComponent1(java.util.Calendar component1) {
	 ...
	 */
	public Field29N setDate(java.util.Calendar component1) {
	 ...
	 */
	public Field29N setLocation(String component2) {
		setComponent(2, component2);
		return this;
	}
	/**
	 ...
	 */
	public Field29N setComponent3(java.util.Calendar component3) {
	 ...
	 */
	public Field29N setTime(java.util.Calendar component3) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field29N.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field29N.COMPONENTS_PATTERN
	 */
	@Override
	 ...
	 */
	public static Field29N get(final SwiftTagListBlock block) {
	...
	/**
	 * Gets the first instance of Field29N in the given message.
	 * @param msg may be empty or null
	 * @return null if not found or msg is empty or null
	 * @see #get(SwiftTagListBlock)
	 */
	public static Field29N get(final SwiftMessage msg) {
	 ...
	 */ 
	public static List<Field29N> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	 ...
	 */ 
	public static List<Field29N> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field29N> result = new ArrayList<Field29N>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field29N object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field29N fromJson(final String json) {
