...
/**
 * <strong>SWIFT MT Field 31E</strong>
 * <p>
 * Model and parser for field 31E of a SWIFT MT message.
 *
...
public class Field31E extends Field implements Serializable, DateContainer {
	 ...
	 */
	public Field31E(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field31E(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "31E")) {
			throw new IllegalArgumentException("cannot create field 31E from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field31E newInstance(Field31E source) {
		Field31E cp = new Field31E();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field31E.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field31E.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field31E get(final SwiftTagListBlock block) {
		...
		return new Field31E(t) ;
	}
	
	/**
	 * Gets the first instance of Field31E in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field31E in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field31E> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field31E from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field31E> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field31E> result = new ArrayList<Field31E>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field31E(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 1) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 31E");
		}
		if (component == 1) {
			//date
	...
	/**
	 * This method deserializes the JSON data into a Field31E object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field31E fromJson(final String json) {
		Field31E field = new Field31E();
