...
@Generated
public class Field59A extends Field implements Serializable, BICContainer, com.financial.swift.model.field.MultiLineField {
	/**
	...
	*/
	 ...
	 */
	public Field59A setComponent2(com.financial.swift.model.BIC component2) {
	 ...
	 */
	public Field59A setBIC(com.financial.swift.model.BIC component2) {
   ...
   public String parserPattern() {
	...
	public static List<Field59A> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field59A> result = new ArrayList<Field59A>(arr.length);
			for (final Tag f : arr) {
