...
@Generated
public class Field41D extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	...
	*/
	 ...
	 */
	public Field41D setCode(String component2) {
		setComponent(2, component2);
		return this;
	}
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field41D> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field41D> result = new ArrayList<Field41D>(arr.length);
			for (final Tag f : arr) {
