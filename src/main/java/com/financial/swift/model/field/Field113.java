...
/**
 * <strong>SWIFT MT Field 113</strong>
 * <p>
 * Model and parser for field 113 of a SWIFT MT message.
 *
 ...
 * <ul>
 * 		<li>validation pattern: <code>4!x</code></li>
...
public class Field113 extends Field implements Serializable {
	 ...
	 */
	public Field113(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field113(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "113")) {
			throw new IllegalArgumentException("cannot create field 113 from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field113.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field113.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field113 get(final SwiftTagListBlock block) {
		...
		return new Field113(t) ;
	}
	
	/**
	 * Gets the first instance of Field113 in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field113 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field113> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field113 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field113> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field113> result = new ArrayList<Field113>(arr.length);
			for (final Tag f : arr) {
	...
	protected Map<Integer, String> getComponentMap() {
		...
		result.put(1, "bankingPriority");
		return result;
	}

	/**
	 * This method deserializes the JSON data into a Field113 object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field113 fromJson(final String json) {
		Field113 field = new Field113();
		JsonParser parser = new JsonParser();
		JsonObject jsonObject = (JsonObject) parser.parse(json);
		if (jsonObject.get("bankingPriority") != null) {
			field.setComponent1(jsonObject.get("bankingPriority").getAsString());
		}
		return field;
	}
