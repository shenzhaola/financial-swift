...
/**
 * <strong>SWIFT MT Field 71B</strong>
 * <p>
 * Model and parser for field 71B of a SWIFT MT message.
 *
...
@Generated
public class Field71B extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field71B(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field71B(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "71B")) {
			throw new IllegalArgumentException("cannot create field 71B from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field71B newInstance(Field71B source) {
		Field71B cp = new Field71B();
	...
	*/
	 ...
	 */
	public Field71B setNarrativeLine1(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field71B setNarrativeLine2(String component2) {
	 ...
	 */
	public Field71B setNarrativeLine3(String component3) {
	 ...
	 */
	public Field71B setNarrativeLine4(String component4) {
	 ...
	 */
	public Field71B setNarrativeLine5(String component5) {
	 ...
	 */
	public Field71B setNarrativeLine6(String component6) {
	 ...
	 */
	public Field71B setNarrative(String value) {
		List<String> lines = SwiftParseUtils.getLines(value);
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field71B.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field71B.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field71B get(final SwiftTagListBlock block) {
		...
		return new Field71B(t) ;
	}
	
	/**
	 * Gets the first instance of Field71B in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field71B in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field71B> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field71B from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field71B> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field71B> result = new ArrayList<Field71B>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field71B(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 6) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 71B");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field71B object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field71B fromJson(final String json) {
		Field71B field = new Field71B();
