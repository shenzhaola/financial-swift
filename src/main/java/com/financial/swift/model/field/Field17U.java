...
public class Field17U extends Field implements Serializable {
	 ...
	 */
	public Field17U(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field17U(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "17U")) {
			throw new IllegalArgumentException("cannot create field 17U from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field17U.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field17U.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field17U in the given message.
	 ...
	 */ 
	public static List<Field17U> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	 ...
	 */ 
	public static List<Field17U> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field17U> result = new ArrayList<Field17U>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 1) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 17U");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field17U object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field17U fromJson(final String json) {
