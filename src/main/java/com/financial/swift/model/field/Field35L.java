...
/**
 * <strong>SWIFT MT Field 35L</strong>
 * <p>
...
@Generated
public class Field35L extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field35L> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field35L> result = new ArrayList<Field35L>(arr.length);
			for (final Tag f : arr) {
