...
/**
 * <strong>SWIFT MT Field 35C</strong>
 * <p>
...
public class Field35C extends Field implements Serializable {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field35C.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field35C> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field35C> result = new ArrayList<Field35C>(arr.length);
			for (final Tag f : arr) {
