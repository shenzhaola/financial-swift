...
/**
 * <strong>SWIFT MT Field 17Z</strong>
 * <p>
...
public class Field17Z extends Field implements Serializable {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field17Z.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field17Z> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field17Z> result = new ArrayList<Field17Z>(arr.length);
			for (final Tag f : arr) {
