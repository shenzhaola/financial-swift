...
/**
 * <strong>SWIFT MT Field 94H</strong>
 * <p>
...
@Generated
public class Field94H extends Field implements Serializable, BICContainer, com.financial.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field94H> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field94H> result = new ArrayList<Field94H>(arr.length);
			for (final Tag f : arr) {
