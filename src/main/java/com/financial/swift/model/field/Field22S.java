...
/**
 * <strong>SWIFT MT Field 22S</strong>
 * <p>
 * Model and parser for field 22S of a SWIFT MT message.
 *
 ...
 * <ul>
 * 		<li>validation pattern: <code>1!a/35x</code></li>
...
public class Field22S extends Field implements Serializable {
	 ...
	 */
	public Field22S(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field22S(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "22S")) {
	...
	*/
	 ...
	 * @param component1 the Side Indicator to set
	 */
	 ...
	 * @param component2 the Identification to set
	 */
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field22S.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field22S.COMPONENTS_PATTERN
	 */
	@Override
	 ...
	 */ 
	public static List<Field22S> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	 ...
	 */ 
	public static List<Field22S> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field22S> result = new ArrayList<Field22S>(arr.length);
			for (final Tag f : arr) {
