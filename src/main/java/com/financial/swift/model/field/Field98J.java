...
@Generated
public class Field98J extends Field implements Serializable, DateContainer, BICContainer, com.financial.swift.model.field.GenericField {
	/**
	...
	*/
	 ...
	 */
	public com.financial.swift.model.BIC getComponent4AsBIC() {
	 ...
	 */
	public Field98J setComponent4(com.financial.swift.model.BIC component4) {
	 ...
	 * @see #setComponent4(com.financial.swift.model.BIC)
   ...
   public String parserPattern() {
	...
	public static List<Field98J> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field98J> result = new ArrayList<Field98J>(arr.length);
			for (final Tag f : arr) {
