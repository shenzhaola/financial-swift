...
/**
 * <strong>SWIFT MT Field 332</strong>
 * <p>
 * Model and parser for field 332 of a SWIFT MT message.
 *
 ...
 * <ul>
 * 		<li>validation pattern: <code>6!n6!n</code></li>
 * 		<li>parser pattern: <code>6!N6!N</code></li>
...
public class Field332 extends Field implements Serializable {
	 ...
	 */
	public Field332(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field332(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "332")) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field332.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field332.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field332 in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field332 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field332> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field332 from the given block
	 * an empty list is returned if none found.
	 *
	...
	public static List<Field332> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field332> result = new ArrayList<Field332>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field332 object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field332 fromJson(final String json) {
