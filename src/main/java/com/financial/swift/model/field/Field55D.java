...
/**
 * <strong>SWIFT MT Field 55D</strong>
 * <p>
 * Model and parser for field 55D of a SWIFT MT message.
 *
...
@Generated
public class Field55D extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field55D(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field55D(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "55D")) {
			throw new IllegalArgumentException("cannot create field 55D from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field55D newInstance(Field55D source) {
		Field55D cp = new Field55D();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field55D.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field55D.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field55D get(final SwiftTagListBlock block) {
		...
		return new Field55D(t) ;
	}
	
	/**
	 * Gets the first instance of Field55D in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field55D in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field55D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field55D from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field55D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field55D> result = new ArrayList<Field55D>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field55D(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 6) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 55D");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field55D object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field55D fromJson(final String json) {
		Field55D field = new Field55D();
