...
/**
 * <strong>SWIFT MT Field 208</strong>
 * <p>
 * Model and parser for field 208 of a SWIFT MT message.
 *
...
public class Field208 extends Field implements Serializable {
	 ...
	 */
	public Field208(final String value) {
		super(value);
	}
	 ...
	 * @since 7.7
	 */
	public static Field208 newInstance(Field208 source) {
		Field208 cp = new Field208();
	...
	*/
	 ...
	 * @param component1 the LT Directed Queue to set
	 */
	public Field208 setLTDirectedQueue(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 * @param component1 Boolean with the LT Directed Queue content to set
	 */
	public Field208 setLTDirectedQueue(java.lang.Boolean component1) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field208.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field208.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field208 get(final SwiftTagListBlock block) {
		...
		return new Field208(t) ;
	}
	
	/**
	 * Gets the first instance of Field208 in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field208 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field208> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field208 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field208> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field208> result = new ArrayList<Field208>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field208(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 1) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 208");
		}
		if (component == 1) {
	...
	protected Map<Integer, String> getComponentMap() {
		...
		result.put(1, "lTDirectedQueue");
		return result;
	}

	/**
	 * This method deserializes the JSON data into a Field208 object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field208 fromJson(final String json) {
		Field208 field = new Field208();
		JsonParser parser = new JsonParser();
		JsonObject jsonObject = (JsonObject) parser.parse(json);
		if (jsonObject.get("lTDirectedQueue") != null) {
			field.setComponent1(jsonObject.get("lTDirectedQueue").getAsString());
		}
		return field;
	}
