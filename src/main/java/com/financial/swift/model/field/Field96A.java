...
/**
 * <strong>SWIFT MT Field 96A</strong>
 * <p>
...
@Generated
public class Field96A extends Field implements Serializable, BICContainer, com.financial.swift.model.field.MultiLineField {
	/**
	...
	*/
	 ...
	 */
	public Field96A setComponent3(com.financial.swift.model.BIC component3) {
	 ...
	 */
	public Field96A setBIC(com.financial.swift.model.BIC component3) {
   ...
   public String parserPattern() {
	...
	public static List<Field96A> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field96A> result = new ArrayList<Field96A>(arr.length);
			for (final Tag f : arr) {
