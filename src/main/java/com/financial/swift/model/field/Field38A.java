...
/**
 * <strong>SWIFT MT Field 38A</strong>
 * <p>
 * Model and parser for field 38A of a SWIFT MT message.
 *
...
public class Field38A extends Field implements Serializable {
	 ...
	 */
	public Field38A(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field38A(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "38A")) {
			throw new IllegalArgumentException("cannot create field 38A from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field38A newInstance(Field38A source) {
		Field38A cp = new Field38A();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field38A.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field38A.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field38A get(final SwiftTagListBlock block) {
		...
		return new Field38A(t) ;
	}
	
	/**
	 * Gets the first instance of Field38A in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field38A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field38A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field38A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field38A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field38A> result = new ArrayList<Field38A>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field38A(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	/**
	 * This method deserializes the JSON data into a Field38A object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field38A fromJson(final String json) {
		Field38A field = new Field38A();
