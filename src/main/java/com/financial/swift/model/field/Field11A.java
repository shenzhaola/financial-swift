...
/**
 * <strong>SWIFT MT Field 11A</strong>
 * <p>
 * Model and parser for field 11A of a SWIFT MT message.
 *
 ...
 * <ul>
 * 		<li>validation pattern: <code>:4!c//&lt;CUR&gt;</code></li>
 * 		<li>parser pattern: <code>:S//S</code></li>
 * 		<li>components pattern: <code>SC</code></li>
 * </ul>
 *		 
 * <p>
...
@Generated
public class Field11A extends Field implements Serializable, CurrencyContainer, com.financial.swift.model.field.GenericField {
	/**
	 ...
	 */
	public Field11A(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field11A(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "11A")) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field11A.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field11A.COMPONENTS_PATTERN
	 */
	@Override
	 ...
	 */ 
	public static List<Field11A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return java.util.Collections.emptyList();
	 ...
	 */ 
	public static List<Field11A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field11A> result = new ArrayList<Field11A>(arr.length);
			for (final Tag f : arr) {
