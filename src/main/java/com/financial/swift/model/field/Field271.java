...
/**
 * <strong>SWIFT MT Field 271</strong>
 * <p>
 * Model and parser for field 271 of a SWIFT MT message.
 *
...
public class Field271 extends Field implements Serializable {
	 ...
	 */
	public Field271(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field271(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "271")) {
	...
	*/
	...
	/**
	 * Gets the Logout Block (component2).
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field271.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field271.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field271 in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field271 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field271> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field271 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field271> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field271> result = new ArrayList<Field271>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field271 object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field271 fromJson(final String json) {
