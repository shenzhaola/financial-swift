...
/**
 * <strong>SWIFT MT Field 44F</strong>
 * <p>
...
public class Field44F extends Field implements Serializable {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field44F.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field44F> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field44F> result = new ArrayList<Field44F>(arr.length);
			for (final Tag f : arr) {
