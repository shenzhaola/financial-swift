...
/**
 * <strong>SWIFT MT Field 70</strong>
 * <p>
 * Model and parser for field 70 of a SWIFT MT message.
 *
...
@Generated
public class Field70 extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field70(final String value) {
		super(value);
	}
	 ...
	 * @since 7.7
	 */
	public static Field70 newInstance(Field70 source) {
		Field70 cp = new Field70();
	...
	*/
	 ...
	 */
	public Field70 setNarrativeLine1(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field70 setNarrativeLine2(String component2) {
	 ...
	 */
	public Field70 setNarrativeLine3(String component3) {
	 ...
	 */
	public Field70 setNarrativeLine4(String component4) {
	 ...
	 */
	public Field70 setNarrative(String value) {
		List<String> lines = SwiftParseUtils.getLines(value);
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field70.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field70.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field70 get(final SwiftTagListBlock block) {
		...
		return new Field70(t) ;
	}
	
	/**
	 * Gets the first instance of Field70 in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field70 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field70> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field70 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field70> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field70> result = new ArrayList<Field70>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field70(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 4) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 70");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field70 object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field70 fromJson(final String json) {
