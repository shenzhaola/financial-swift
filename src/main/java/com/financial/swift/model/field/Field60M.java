...
/**
 * <strong>SWIFT MT Field 60M</strong>
 * <p>
...
public class Field60M extends Field implements Serializable, DateContainer, AmountContainer {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field60M.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field60M> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field60M> result = new ArrayList<Field60M>(arr.length);
			for (final Tag f : arr) {
