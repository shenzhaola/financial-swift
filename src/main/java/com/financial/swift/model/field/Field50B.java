...
/**
 * <strong>SWIFT MT Field 50B</strong>
 * <p>
...
@Generated
public class Field50B extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field50B.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field50B> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field50B> result = new ArrayList<Field50B>(arr.length);
			for (final Tag f : arr) {
