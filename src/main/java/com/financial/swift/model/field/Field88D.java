...
/**
 * <strong>SWIFT MT Field 88D</strong>
 * <p>
...
@Generated
public class Field88D extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field88D(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field88D(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "88D")) {
			throw new IllegalArgumentException("cannot create field 88D from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field88D newInstance(Field88D source) {
		Field88D cp = new Field88D();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field88D.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field88D.COMPONENTS_PATTERN
	 */
	@Override
	 ...
	 */ 
	public static List<Field88D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	 ...
	 */ 
	public static List<Field88D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field88D> result = new ArrayList<Field88D>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field88D(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 6) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 88D");
		}
		if (component == 1) {
	 ...
	 */
	public static Field88D fromJson(final String json) {
		Field88D field = new Field88D();
