...
/**
 * <strong>SWIFT MT Field 313</strong>
 * <p>
 * Model and parser for field 313 of a SWIFT MT message.
 *
...
public class Field313 extends Field implements Serializable {
	 ...
	 */
	public Field313(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field313(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "313")) {
			throw new IllegalArgumentException("cannot create field 313 from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field313 newInstance(Field313 source) {
		Field313 cp = new Field313();
	...
	*/
	 ...
	 * @return the Count from component1 converted to Number or null if cannot be converted
	 */
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field313.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field313.COMPONENTS_PATTERN
	 */
	@Override
	 ...
	 */ 
	public static List<Field313> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	public static List<Field313> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field313> result = new ArrayList<Field313>(arr.length);
			for (final Tag f : arr) {
