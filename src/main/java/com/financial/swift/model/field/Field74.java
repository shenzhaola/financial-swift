...
/**
 * <strong>SWIFT MT Field 74</strong>
 * <p>
 * Model and parser for field 74 of a SWIFT MT message.
 *
...
@Generated
public class Field74 extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field74(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field74(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "74")) {
	 ...
	 * @since 7.7
	 */
	public static Field74 newInstance(Field74 source) {
		Field74 cp = new Field74();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field74.NAME
	 */
	@Override
	...
	public static Field74 get(final SwiftTagListBlock block) {
		...
		return new Field74(t) ;
	}
	
	/**
	 * Gets the first instance of Field74 in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field74 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field74> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field74 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field74> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field74> result = new ArrayList<Field74>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field74(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	/**
	 * This method deserializes the JSON data into a Field74 object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field74 fromJson(final String json) {
		Field74 field = new Field74();
