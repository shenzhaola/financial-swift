...
public class Field451 extends Field implements Serializable {
	...
	*/
	...
	/**
	 * Gets the Accept Reject Option (component1).
	 * @return the Accept Reject Option from component1
	 */
	 ...
	 * @return the Accept Reject Option from component1 converted to Number or null if cannot be converted
	 */
	 ...
	 * @param component1 Number with the Accept Reject Option content to set
	 */
   ...
   public String parserPattern() {
	...
	public static List<Field451> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field451> result = new ArrayList<Field451>(arr.length);
			for (final Tag f : arr) {
