...
public class Field82J extends Field implements Serializable {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field82J.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field82J> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field82J> result = new ArrayList<Field82J>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 1) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 82J");
		}
		if (component == 1) {
