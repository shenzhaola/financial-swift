...
/**
 * <strong>SWIFT MT Field 85A</strong>
 * <p>
 * Model and parser for field 85A of a SWIFT MT message.
 *
...
@Generated
public class Field85A extends Field implements Serializable, BICContainer, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field85A(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field85A(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "85A")) {
	...
	*/
	 ...
	 */
	public Field85A setComponent3(com.financial.swift.model.BIC component3) {
	 ...
	 */
	public Field85A setBIC(com.financial.swift.model.BIC component3) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field85A.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field85A.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field85A in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field85A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field85A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field85A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field85A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field85A> result = new ArrayList<Field85A>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 3) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 85A");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field85A object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field85A fromJson(final String json) {
