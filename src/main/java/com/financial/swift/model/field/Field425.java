...
public class Field425 extends Field implements Serializable {
	...
	*/
	...
	public java.lang.String getComponent31AsString() {
		com.financial.deprecation.DeprecationUtils.phase2(getClass(), "getComponent31AsString()", "Use use #getComponent(int) instead.");
		return getComponent(31);
	}
	...
	public java.lang.String getComponent32AsString() {
		com.financial.deprecation.DeprecationUtils.phase2(getClass(), "getComponent32AsString()", "Use use #getComponent(int) instead.");
		return getComponent(32);
	}
	...
	public java.lang.String getComponent33AsString() {
		com.financial.deprecation.DeprecationUtils.phase2(getClass(), "getComponent33AsString()", "Use use #getComponent(int) instead.");
		return getComponent(33);
	}
	...
	public java.lang.String getComponent34AsString() {
		com.financial.deprecation.DeprecationUtils.phase2(getClass(), "getComponent34AsString()", "Use use #getComponent(int) instead.");
		return getComponent(34);
	}
	...
	public java.lang.String getComponent35AsString() {
		com.financial.deprecation.DeprecationUtils.phase2(getClass(), "getComponent35AsString()", "Use use #getComponent(int) instead.");
		return getComponent(35);
	}
	...
	public java.lang.String getComponent36AsString() {
		com.financial.deprecation.DeprecationUtils.phase2(getClass(), "getComponent36AsString()", "Use use #getComponent(int) instead.");
		return getComponent(36);
	}
	...
	public java.lang.String getComponent37AsString() {
		com.financial.deprecation.DeprecationUtils.phase2(getClass(), "getComponent37AsString()", "Use use #getComponent(int) instead.");
		return getComponent(37);
	}
	...
	public java.lang.String getComponent38AsString() {
		com.financial.deprecation.DeprecationUtils.phase2(getClass(), "getComponent38AsString()", "Use use #getComponent(int) instead.");
		return getComponent(38);
	}
	...
	public java.lang.String getComponent39AsString() {
		com.financial.deprecation.DeprecationUtils.phase2(getClass(), "getComponent39AsString()", "Use use #getComponent(int) instead.");
		return getComponent(39);
	}
	...
	public java.lang.String getComponent40AsString() {
		com.financial.deprecation.DeprecationUtils.phase2(getClass(), "getComponent40AsString()", "Use use #getComponent(int) instead.");
		return getComponent(40);
	}
   ...
   public String parserPattern() {
	...
	public static List<Field425> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field425> result = new ArrayList<Field425>(arr.length);
			for (final Tag f : arr) {
