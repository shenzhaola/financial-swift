...
public class Field280 extends Field implements Serializable {
	...
	*/
	 ...
	 */
	public Field280 setComponent2(com.financial.swift.model.MIR component2) {
	 ...
	 */
	public Field280 setMIR(com.financial.swift.model.MIR component2) {
   ...
   public String parserPattern() {
	...
	public static List<Field280> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field280> result = new ArrayList<Field280>(arr.length);
			for (final Tag f : arr) {
