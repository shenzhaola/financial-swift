 ...
 * <ul>
 * 		<li>validation pattern: <code>:4!c//[&lt;N&gt;]3!n</code></li>
 * 		<li>parser pattern: <code>:S//[c]N</code></li>
...
@Generated
public class Field99A extends Field implements Serializable, AmountContainer, com.financial.swift.model.field.GenericField {
	/**
	 ...
	 */
	public Field99A(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field99A(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "99A")) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field99A.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field99A> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field99A> result = new ArrayList<Field99A>(arr.length);
			for (final Tag f : arr) {
