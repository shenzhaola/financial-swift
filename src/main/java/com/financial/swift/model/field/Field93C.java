...
@Generated
public class Field93C extends Field implements Serializable, AmountContainer, com.financial.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field93C> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field93C> result = new ArrayList<Field93C>(arr.length);
			for (final Tag f : arr) {
