...
/**
 * <strong>SWIFT MT Field 92H</strong>
 * <p>
 * Model and parser for field 92H of a SWIFT MT message.
 *
 ...
 * <ul>
 * 		<li>validation pattern: <code>:4!c//&lt;CUR&gt;&lt;AMOUNT&gt;15/4!c</code></li>
 * 		<li>parser pattern: <code>:S//SN/S</code></li>
 * 		<li>components pattern: <code>SCNS</code></li>
 * </ul>
 *		 
 * <p>
...
@Generated
public class Field92H extends Field implements Serializable, CurrencyContainer, AmountContainer, com.financial.swift.model.field.GenericField {
	/**
	 ...
	 */
	public Field92H(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field92H(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "92H")) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field92H.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field92H.COMPONENTS_PATTERN
	 */
	@Override
	 ...
	 */
	public static Field92H get(final SwiftTagListBlock block) {
	...
	/**
	 * Gets the first instance of Field92H in the given message.
	 * @param msg may be empty or null
	 * @return null if not found or msg is empty or null
	 * @see #get(SwiftTagListBlock)
	 */
	public static Field92H get(final SwiftMessage msg) {
	...
	/**
	 * Gets a list of all occurrences of the field Field92H in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field92H> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return java.util.Collections.emptyList();
	...
	/**
	 * Gets a list of all occurrences of the field Field92H from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field92H> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field92H> result = new ArrayList<Field92H>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field92H object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field92H fromJson(final String json) {
