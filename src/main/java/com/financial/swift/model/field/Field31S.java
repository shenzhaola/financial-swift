...
/**
 * <strong>SWIFT MT Field 31S</strong>
 * <p>
...
public class Field31S extends Field implements Serializable, DateContainer {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field31S.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field31S> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field31S> result = new ArrayList<Field31S>(arr.length);
			for (final Tag f : arr) {
