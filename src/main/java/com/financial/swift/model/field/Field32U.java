...
/**
 * <strong>SWIFT MT Field 32U</strong>
 * <p>
 * Model and parser for field 32U of a SWIFT MT message.
 *
...
public class Field32U extends Field implements Serializable, CurrencyContainer, AmountContainer {
	 ...
	 */
	public Field32U(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field32U(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "32U")) {
			throw new IllegalArgumentException("cannot create field 32U from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field32U newInstance(Field32U source) {
		Field32U cp = new Field32U();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field32U.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field32U.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field32U get(final SwiftTagListBlock block) {
		...
		return new Field32U(t) ;
	}
	
	/**
	 * Gets the first instance of Field32U in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field32U in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field32U> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return java.util.Collections.emptyList();
	...
	/**
	 * Gets a list of all occurrences of the field Field32U from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field32U> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field32U> result = new ArrayList<Field32U>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field32U object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field32U fromJson(final String json) {
		Field32U field = new Field32U();
