...
/**
 * <strong>SWIFT MT Field 27</strong>
 * <p>
 * Model and parser for field 27 of a SWIFT MT message.
 *
 ...
 * <ul>
 * 		<li>validation pattern: <code>1n/1n</code></li>
...
public class Field27 extends Field implements Serializable {
	 ...
	 */
	public Field27(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field27(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "27")) {
	...
	*/
	 ...
	 */
	public Field27 setNumber(java.lang.Number component1) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field27.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field27.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field27 in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field27 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field27> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field27 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field27> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field27> result = new ArrayList<Field27>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field27 object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field27 fromJson(final String json) {
