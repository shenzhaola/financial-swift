...
@Generated
public class Field45A extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field45A(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field45A(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "45A")) {
			throw new IllegalArgumentException("cannot create field 45A from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field45A newInstance(Field45A source) {
		Field45A cp = new Field45A();
	...
	*/
	 ...
	 */
	public Field45A setNarrative(String component1) {
		setComponent(1, component1);
		return this;
	}
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field45A.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field45A in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field45A in the given message
	...
	/**
	 * Gets a list of all occurrences of the field Field45A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field45A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field45A> result = new ArrayList<Field45A>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 1) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 45A");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field45A object.
