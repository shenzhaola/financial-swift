...
/**
 * <strong>SWIFT MT Field 92R</strong>
 * <p>
...
@Generated
public class Field92R extends Field implements Serializable, AmountContainer, com.financial.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field92R.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field92R> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field92R> result = new ArrayList<Field92R>(arr.length);
			for (final Tag f : arr) {
