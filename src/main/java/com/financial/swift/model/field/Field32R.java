 ...
 * 		<li>parser pattern: <code>[c]SN</code></li>
...
public class Field32R extends Field implements Serializable, AmountContainer {
	 ...
	 */
	public Field32R(final String value) {
		super(value);
	}
	...
	*/
	 ...
	 */
	public Field32R setUnit(String component2) {
		setComponent(2, component2);
		return this;
	}
	/**
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field32R.COMPONENTS_PATTERN
	 */
	@Override
	 ...
	 */ 
	public static List<Field32R> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field32R> result = new ArrayList<Field32R>(arr.length);
			for (final Tag f : arr) {
