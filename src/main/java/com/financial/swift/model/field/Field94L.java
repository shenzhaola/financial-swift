...
@Generated
public class Field94L extends Field implements Serializable, com.financial.swift.model.field.GenericField {
	/**
	 ...
	 */
	public Field94L(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field94L(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "94L")) {
			throw new IllegalArgumentException("cannot create field 94L from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field94L newInstance(Field94L source) {
		Field94L cp = new Field94L();
	...
	*/
	 ...
	 */
	public Field94L setComponent1(String component1) {
	 ...
	 */
	public Field94L setQualifier(String component1) {
		setComponent(1, component1);
		return this;
	}
	/**
	 ...
	 */
	public Field94L setComponent3(String component3) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field94L.COMPONENTS_PATTERN
	 */
	@Override
	 ...
	 */
	public static Field94L get(final SwiftTagListBlock block) {
	...
	/**
	 * Gets the first instance of Field94L in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field94L in the given message
	...
	/**
	 * Gets a list of all occurrences of the field Field94L from the given block
	 * an empty list is returned if none found.
	 *
	...
	public static List<Field94L> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field94L> result = new ArrayList<Field94L>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field94L object.
