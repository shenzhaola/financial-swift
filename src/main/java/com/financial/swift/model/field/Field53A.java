...
/**
 * <strong>SWIFT MT Field 53A</strong>
 * <p>
 * Model and parser for field 53A of a SWIFT MT message.
 *
...
@Generated
public class Field53A extends Field implements Serializable, BICContainer, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field53A(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field53A(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "53A")) {
			throw new IllegalArgumentException("cannot create field 53A from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field53A newInstance(Field53A source) {
		Field53A cp = new Field53A();
	...
	*/
	 ...
	 */
	public Field53A setComponent3(com.financial.swift.model.BIC component3) {
	 ...
	 */
	public Field53A setBIC(com.financial.swift.model.BIC component3) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field53A.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field53A.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field53A get(final SwiftTagListBlock block) {
		...
		return new Field53A(t) ;
	}
	
	/**
	 * Gets the first instance of Field53A in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field53A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field53A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field53A from the given block
	 * an empty list is returned if none found.
	 *
	...
	public static List<Field53A> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field53A> result = new ArrayList<Field53A>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 3) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 53A");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field53A object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field53A fromJson(final String json) {
		Field53A field = new Field53A();
