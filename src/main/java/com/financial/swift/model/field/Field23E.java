 ...
 * <ul>
 * 		<li>validation pattern: <code>4!c[/30x]</code></li>
...
public class Field23E extends Field implements Serializable {
	 ...
	 */
	public Field23E(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field23E(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "23E")) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field23E.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field23E in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field23E in the given message
	...
	/**
	 * Gets a list of all occurrences of the field Field23E from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field23E> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field23E> result = new ArrayList<Field23E>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field23E object.
