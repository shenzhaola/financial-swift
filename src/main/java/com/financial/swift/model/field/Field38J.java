...
/**
 * <strong>SWIFT MT Field 38J</strong>
 * <p>
 * Model and parser for field 38J of a SWIFT MT message.
 *
 ...
 * <ul>
 * 		<li>validation pattern: <code>&lt;DM&gt;3!n</code></li>
...
public class Field38J extends Field implements Serializable {
	 ...
	 */
	public Field38J(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field38J(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "38J")) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field38J.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field38J.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field38J in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field38J in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field38J> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field38J from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field38J> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field38J> result = new ArrayList<Field38J>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field38J object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field38J fromJson(final String json) {
