...
/**
 * <strong>SWIFT MT Field 88A</strong>
 * <p>
 * Model and parser for field 88A of a SWIFT MT message.
 *
...
@Generated
public class Field88A extends Field implements Serializable, BICContainer, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field88A(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field88A(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "88A")) {
			throw new IllegalArgumentException("cannot create field 88A from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field88A newInstance(Field88A source) {
		Field88A cp = new Field88A();
	...
	*/
	 ...
	 */
	public Field88A setComponent3(com.financial.swift.model.BIC component3) {
	 ...
	 */
	public Field88A setBIC(com.financial.swift.model.BIC component3) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field88A.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field88A.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field88A get(final SwiftTagListBlock block) {
		...
		return new Field88A(t) ;
	}
	
	/**
	 * Gets the first instance of Field88A in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field88A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field88A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field88A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field88A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field88A> result = new ArrayList<Field88A>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field88A(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 3) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 88A");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field88A object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field88A fromJson(final String json) {
		Field88A field = new Field88A();
