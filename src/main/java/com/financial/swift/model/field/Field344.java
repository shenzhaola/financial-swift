 ...
 * <ul>
 * 		<li>validation pattern: <code>1!a[9n]</code></li>
 * 		<li>parser pattern: <code>c[N]</code></li>
...
public class Field344 extends Field implements Serializable {
	 ...
	 */
	public Field344(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field344(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "344")) {
			throw new IllegalArgumentException("cannot create field 344 from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	...
	public void parse(final String value) {
		...
		if (value != null) {
        	if (value.length() >= 1) {
				setComponent1(StringUtils.substring(value, 0, 1));
			}
        	if (value.length() > 1) {
				setComponent2(StringUtils.substring(value, 1));
			}
		}
	}
	 ...
	 * @since 7.7
	 */
	public static Field344 newInstance(Field344 source) {
		Field344 cp = new Field344();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field344.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field344 in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field344 in the given message
	...
	/**
	 * Gets a list of all occurrences of the field Field344 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field344> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field344> result = new ArrayList<Field344>(arr.length);
			for (final Tag f : arr) {
	...
	protected Map<Integer, String> getComponentMap() {
		...
		result.put(2, "messageCategories");
		return result;
	}

	/**
	 * This method deserializes the JSON data into a Field344 object.
	...
	public static Field344 fromJson(final String json) {
		...
		if (jsonObject.get("messageCategories") != null) {
			field.setComponent2(jsonObject.get("messageCategories").getAsString());
		}
		return field;
	}
