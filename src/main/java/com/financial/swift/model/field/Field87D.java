...
/**
 * <strong>SWIFT MT Field 87D</strong>
 * <p>
...
@Generated
public class Field87D extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field87D(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field87D(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "87D")) {
			throw new IllegalArgumentException("cannot create field 87D from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field87D newInstance(Field87D source) {
		Field87D cp = new Field87D();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field87D.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field87D.COMPONENTS_PATTERN
	 */
	@Override
	 ...
	 */ 
	public static List<Field87D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	 ...
	 */ 
	public static List<Field87D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field87D> result = new ArrayList<Field87D>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field87D(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 6) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 87D");
		}
		if (component == 1) {
	 ...
	 */
	public static Field87D fromJson(final String json) {
		Field87D field = new Field87D();
