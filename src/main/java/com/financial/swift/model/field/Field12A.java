 ...
 * <ul>
 * 		<li>validation pattern: <code>:4!c/[8c]/30x</code></li>
...
@Generated
public class Field12A extends Field implements Serializable, com.financial.swift.model.field.GenericField {
	/**
	 ...
	 */
	public Field12A(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field12A(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "12A")) {
			throw new IllegalArgumentException("cannot create field 12A from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field12A newInstance(Field12A source) {
		Field12A cp = new Field12A();
	...
	*/
	...
	/**
	 * Gets the Instrument Code (component3).
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field12A.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field12A in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field12A in the given message
	...
	/**
	 * Gets a list of all occurrences of the field Field12A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field12A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field12A> result = new ArrayList<Field12A>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 3) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 12A");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field12A object.
