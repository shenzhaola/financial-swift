...
/**
 * <strong>SWIFT MT Field 55A</strong>
 * <p>
 * Model and parser for field 55A of a SWIFT MT message.
 *
...
@Generated
public class Field55A extends Field implements Serializable, BICContainer, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field55A(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field55A(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "55A")) {
			throw new IllegalArgumentException("cannot create field 55A from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field55A newInstance(Field55A source) {
		Field55A cp = new Field55A();
	...
	*/
	 ...
	 */
	public Field55A setComponent3(com.financial.swift.model.BIC component3) {
	 ...
	 */
	public Field55A setBIC(com.financial.swift.model.BIC component3) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field55A.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field55A.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field55A get(final SwiftTagListBlock block) {
		...
		return new Field55A(t) ;
	}
	
	/**
	 * Gets the first instance of Field55A in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field55A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field55A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field55A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field55A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field55A> result = new ArrayList<Field55A>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field55A(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 3) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 55A");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field55A object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field55A fromJson(final String json) {
		Field55A field = new Field55A();
