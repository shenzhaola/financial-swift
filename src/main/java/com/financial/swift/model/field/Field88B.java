...
/**
 * <strong>SWIFT MT Field 88B</strong>
 * <p>
 * Model and parser for field 88B of a SWIFT MT message.
 *
...
@Generated
public class Field88B extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field88B(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field88B(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "88B")) {
			throw new IllegalArgumentException("cannot create field 88B from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field88B newInstance(Field88B source) {
		Field88B cp = new Field88B();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field88B.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field88B.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field88B get(final SwiftTagListBlock block) {
		...
		return new Field88B(t) ;
	}
	
	/**
	 * Gets the first instance of Field88B in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field88B in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field88B> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field88B from the given block
	 * an empty list is returned if none found.
	 *
	...
	public static List<Field88B> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field88B> result = new ArrayList<Field88B>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 3) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 88B");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field88B object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field88B fromJson(final String json) {
		Field88B field = new Field88B();
