...
public class Field34R extends Field implements Serializable, CurrencyContainer, DateContainer, AmountContainer {
	 ...
	 */
	public Field34R(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field34R(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "34R")) {
			throw new IllegalArgumentException("cannot create field 34R from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field34R.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field34R.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field34R in the given message.
	 ...
	 */ 
	public static List<Field34R> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return java.util.Collections.emptyList();
	 ...
	 */ 
	public static List<Field34R> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field34R> result = new ArrayList<Field34R>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 3) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 34R");
		}
		if (component == 1) {
			//date
	...
	/**
	 * This method deserializes the JSON data into a Field34R object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field34R fromJson(final String json) {
