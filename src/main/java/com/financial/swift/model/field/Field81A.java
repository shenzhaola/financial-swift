...
@Generated
public class Field81A extends Field implements Serializable, BICContainer, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field81A(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field81A(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "81A")) {
			throw new IllegalArgumentException("cannot create field 81A from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	...
	*/
	 ...
	 */
	public Field81A setComponent3(com.financial.swift.model.BIC component3) {
	 ...
	 */
	public Field81A setBIC(com.financial.swift.model.BIC component3) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field81A.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field81A.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field81A get(final SwiftTagListBlock block) {
		...
		return new Field81A(t) ;
	}
	
	/**
	 * Gets the first instance of Field81A in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field81A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field81A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field81A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field81A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field81A> result = new ArrayList<Field81A>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 3) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 81A");
		}
		if (component == 1) {
