...
/**
 * <strong>SWIFT MT Field 18C</strong>
 * <p>
...
public class Field18C extends Field implements Serializable {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field18C.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field18C> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field18C> result = new ArrayList<Field18C>(arr.length);
			for (final Tag f : arr) {
