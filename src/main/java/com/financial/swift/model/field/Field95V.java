...
@Generated
public class Field95V extends Field implements Serializable, com.financial.swift.model.field.GenericField, com.financial.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field95V> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field95V> result = new ArrayList<Field95V>(arr.length);
			for (final Tag f : arr) {
