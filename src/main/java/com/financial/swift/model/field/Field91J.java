...
/**
 * <strong>SWIFT MT Field 91J</strong>
 * <p>
...
public class Field91J extends Field implements Serializable {
	 ...
	 */
	public Field91J(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field91J(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "91J")) {
			throw new IllegalArgumentException("cannot create field 91J from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field91J newInstance(Field91J source) {
		Field91J cp = new Field91J();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field91J.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field91J.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field91J get(final SwiftTagListBlock block) {
		...
		return new Field91J(t) ;
	}
	
	/**
	 * Gets the first instance of Field91J in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field91J in the given message
	...
	/**
	 * Gets a list of all occurrences of the field Field91J from the given block
	 * an empty list is returned if none found.
	 *
	...
	public static List<Field91J> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field91J> result = new ArrayList<Field91J>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 1) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 91J");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field91J object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field91J fromJson(final String json) {
		Field91J field = new Field91J();
