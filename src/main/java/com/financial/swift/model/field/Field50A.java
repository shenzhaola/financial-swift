...
/**
 * <strong>SWIFT MT Field 50A</strong>
 * <p>
 * Model and parser for field 50A of a SWIFT MT message.
 *
...
@Generated
public class Field50A extends Field implements Serializable, BICContainer, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field50A(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field50A(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "50A")) {
	...
	*/
	 ...
	 */
	public com.financial.swift.model.BIC getComponent2AsBIC() {
	 ...
	 */
	public Field50A setComponent2(com.financial.swift.model.BIC component2) {
	 ...
	 * @see #setComponent2(com.financial.swift.model.BIC)
	 * @param component2 BIC with the BIC content to set
	 */
	public Field50A setBIC(com.financial.swift.model.BIC component2) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field50A.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field50A.COMPONENTS_PATTERN
	 */
	@Override
	 ...
	 */
	public static Field50A get(final SwiftTagListBlock block) {
	...
	/**
	 * Gets the first instance of Field50A in the given message.
	 * @param msg may be empty or null
	 * @return null if not found or msg is empty or null
	 * @see #get(SwiftTagListBlock)
	 */
	public static Field50A get(final SwiftMessage msg) {
	...
	/**
	 * Gets a list of all occurrences of the field Field50A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field50A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field50A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field50A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field50A> result = new ArrayList<Field50A>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field50A object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field50A fromJson(final String json) {
