...
/**
 * <strong>SWIFT MT Field 33F</strong>
 * <p>
 * Model and parser for field 33F of a SWIFT MT message.
 *
...
@Generated
public class Field33F extends Field implements Serializable, CurrencyContainer, AmountContainer {
	/**
	 ...
	 */
    public static final String NAME = "33F";
    /**
	 ...
	 */
	public Field33F(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field33F(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "33F")) {
			throw new IllegalArgumentException("cannot create field 33F from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field33F newInstance(Field33F source) {
		Field33F cp = new Field33F();
	...
	*/
	 ...
	 */
	public Field33F setComponent1(String component1) {
	 ...
	 */
	public Field33F setComponent1(java.util.Currency component1) {
	 ...
	 */
	public Field33F setCurrency(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field33F setCurrency(java.util.Currency component1) {
	 ...
	 */
	public Field33F setComponent2(String component2) {
	 ...
	 */
	public Field33F setComponent2(java.lang.Number component2) {
	 ...
	 */
	public Field33F setAmount(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field33F setAmount(java.lang.Number component2) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field33F.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field33F.COMPONENTS_PATTERN
	 */
	@Override
	 ...
	 */
	public static Field33F get(final SwiftTagListBlock block) {
		...
		return new Field33F(t) ;
	}
	
	/**
	 * Gets the first instance of Field33F in the given message.
	 * @param msg may be empty or null
	 * @return null if not found or msg is empty or null
	 * @see #get(SwiftTagListBlock)
	 */
	public static Field33F get(final SwiftMessage msg) {
	...
	/**
	 * Gets a list of all occurrences of the field Field33F in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field33F> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return java.util.Collections.emptyList();
	...
	/**
	 * Gets a list of all occurrences of the field Field33F from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field33F> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field33F> result = new ArrayList<Field33F>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field33F(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	/**
	 * This method deserializes the JSON data into a Field33F object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field33F fromJson(final String json) {
		Field33F field = new Field33F();
