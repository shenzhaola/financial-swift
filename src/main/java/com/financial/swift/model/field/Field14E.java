...
/**
 * <strong>SWIFT MT Field 14E</strong>
 * <p>
...
public class Field14E extends Field implements Serializable {
   ...
   public String parserPattern() {
	...
	/**
	 * Gets the first instance of Field14E in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field14E in the given message
	...
	/**
	 * Gets a list of all occurrences of the field Field14E from the given block
	 * an empty list is returned if none found.
	 *
	...
	public static List<Field14E> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field14E> result = new ArrayList<Field14E>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field14E object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field14E fromJson(final String json) {
		Field14E field = new Field14E();
