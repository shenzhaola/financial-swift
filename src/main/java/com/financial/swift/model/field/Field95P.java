...
@Generated
public class Field95P extends Field implements Serializable, BICContainer, com.financial.swift.model.field.GenericField {
	/**
	...
	*/
	 ...
	 */
	public Field95P setComponent2(com.financial.swift.model.BIC component2) {
	 ...
	 */
	public Field95P setBIC(com.financial.swift.model.BIC component2) {
   ...
   public String parserPattern() {
	...
	public static List<Field95P> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field95P> result = new ArrayList<Field95P>(arr.length);
			for (final Tag f : arr) {
