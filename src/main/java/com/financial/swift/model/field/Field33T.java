...
/**
 * <strong>SWIFT MT Field 33T</strong>
 * <p>
...
public class Field33T extends Field implements Serializable, AmountContainer {
	 ...
	 */
	public Field33T(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field33T(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "33T")) {
			throw new IllegalArgumentException("cannot create field 33T from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field33T.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field33T.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets a list of all occurrences of the field Field33T in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field33T> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field33T from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field33T> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field33T> result = new ArrayList<Field33T>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field33T(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 2) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 33T");
		}
		if (component == 1) {
	 ...
	 */
	public static Field33T fromJson(final String json) {
		Field33T field = new Field33T();
