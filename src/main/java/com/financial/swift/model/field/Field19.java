...
/**
 * <strong>SWIFT MT Field 19</strong>
 * <p>
...
public class Field19 extends Field implements Serializable, AmountContainer {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field19.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field19> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field19> result = new ArrayList<Field19>(arr.length);
			for (final Tag f : arr) {
	...
	public Field19(Number number) {
		this(com.financial.swift.utils.SwiftFormatUtils.getNumber(number));
	}
}
