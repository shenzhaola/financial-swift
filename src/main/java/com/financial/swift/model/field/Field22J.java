...
/**
 * <strong>SWIFT MT Field 22J</strong>
 * <p>
...
public class Field22J extends Field implements Serializable {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field22J.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field22J> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field22J> result = new ArrayList<Field22J>(arr.length);
			for (final Tag f : arr) {
