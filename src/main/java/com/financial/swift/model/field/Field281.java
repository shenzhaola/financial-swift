...
public class Field281 extends Field implements Serializable {
	...
	*/
	 ...
	 */
	public Field281 setComponent2(com.financial.swift.model.MOR component2) {
	 ...
	 */
	public Field281 setMOR(com.financial.swift.model.MOR component2) {
   ...
   public String parserPattern() {
	...
	public static List<Field281> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field281> result = new ArrayList<Field281>(arr.length);
			for (final Tag f : arr) {
