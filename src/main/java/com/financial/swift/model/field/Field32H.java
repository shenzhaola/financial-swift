...
/**
 * <strong>SWIFT MT Field 32H</strong>
 * <p>
 * Model and parser for field 32H of a SWIFT MT message.
 *
...
public class Field32H extends Field implements Serializable, CurrencyContainer, AmountContainer {
	 ...
	 */
	public Field32H(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field32H(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "32H")) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field32H.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field32H.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field32H in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field32H in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field32H> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return java.util.Collections.emptyList();
	...
	/**
	 * Gets a list of all occurrences of the field Field32H from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field32H> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field32H> result = new ArrayList<Field32H>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field32H object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field32H fromJson(final String json) {
		Field32H field = new Field32H();
