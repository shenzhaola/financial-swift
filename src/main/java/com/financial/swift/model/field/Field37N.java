...
@Generated
public class Field37N extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	...
	*/
	 ...
	 */
	public Field37N setNarrativeLine1(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field37N setNarrativeLine2(String component2) {
	 ...
	 */
	public Field37N setNarrativeLine3(String component3) {
	 ...
	 */
	public Field37N setNarrativeLine4(String component4) {
	 ...
	 */
	public Field37N setNarrativeLine5(String component5) {
	 ...
	 */
	public Field37N setNarrativeLine6(String component6) {
	 ...
	 */
	public Field37N setNarrative(String value) {
		List<String> lines = SwiftParseUtils.getLines(value);
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field37N.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field37N> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field37N> result = new ArrayList<Field37N>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 6) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 37N");
		}
		if (component == 1) {
