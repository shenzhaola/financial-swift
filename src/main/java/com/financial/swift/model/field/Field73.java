...
/**
 * <strong>SWIFT MT Field 73</strong>
 * <p>
...
@Generated
public class Field73 extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	...
	*/
	 ...
	 */
	public Field73 setNarrativeLine1(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field73 setNarrativeLine2(String component2) {
	 ...
	 */
	public Field73 setNarrativeLine3(String component3) {
	 ...
	 */
	public Field73 setNarrativeLine4(String component4) {
	 ...
	 */
	public Field73 setNarrativeLine5(String component5) {
	 ...
	 */
	public Field73 setNarrativeLine6(String component6) {
	 ...
	 */
	public Field73 setNarrative(String value) {
		List<String> lines = SwiftParseUtils.getLines(value);
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field73.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field73> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field73> result = new ArrayList<Field73>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 6) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 73");
		}
		if (component == 1) {
