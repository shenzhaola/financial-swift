...
@Generated
public class Field56D extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field56D(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field56D(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "56D")) {
			throw new IllegalArgumentException("cannot create field 56D from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field56D newInstance(Field56D source) {
		Field56D cp = new Field56D();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field56D.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field56D in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field56D in the given message
	...
	/**
	 * Gets a list of all occurrences of the field Field56D from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field56D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field56D> result = new ArrayList<Field56D>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 6) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 56D");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field56D object.
