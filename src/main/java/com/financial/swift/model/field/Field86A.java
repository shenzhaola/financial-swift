...
/**
 * <strong>SWIFT MT Field 86A</strong>
 * <p>
 * Model and parser for field 86A of a SWIFT MT message.
 *
...
@Generated
public class Field86A extends Field implements Serializable, BICContainer, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field86A(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field86A(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "86A")) {
			throw new IllegalArgumentException("cannot create field 86A from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field86A newInstance(Field86A source) {
		Field86A cp = new Field86A();
	...
	*/
	 ...
	 */
	public Field86A setComponent3(com.financial.swift.model.BIC component3) {
	 ...
	 */
	public Field86A setBIC(com.financial.swift.model.BIC component3) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field86A.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field86A.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field86A get(final SwiftTagListBlock block) {
		...
		return new Field86A(t) ;
	}
	
	/**
	 * Gets the first instance of Field86A in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field86A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field86A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field86A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field86A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field86A> result = new ArrayList<Field86A>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field86A(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 3) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 86A");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field86A object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field86A fromJson(final String json) {
		Field86A field = new Field86A();
