...
/**
 * <strong>SWIFT MT Field 72Z</strong>
 * <p>
 * Model and parser for field 72Z of a SWIFT MT message.
 *
...
@Generated
public class Field72Z extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	...
	/**
	 * Constant with the field name 72Z
	 */
    public static final String NAME = "72Z";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_72Z = "72Z";
	 ...
	 */
	public Field72Z(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field72Z(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "72Z")) {
			throw new IllegalArgumentException("cannot create field 72Z from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field72Z newInstance(Field72Z source) {
		Field72Z cp = new Field72Z();
	...
	*/
	 ...
	 */
	public Field72Z setComponent1(String component1) {
	 ...
	 */
	public Field72Z setNarrativeLine1(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field72Z setNarrativeLine2(String component2) {
	 ...
	 */
	public Field72Z setNarrativeLine3(String component3) {
	 ...
	 */
	public Field72Z setNarrativeLine4(String component4) {
	 ...
	 */
	public Field72Z setNarrativeLine5(String component5) {
	 ...
	 */
	public Field72Z setNarrativeLine6(String component6) {
	 ...
	 */
	public Field72Z setNarrative(String value) {
		List<String> lines = SwiftParseUtils.getLines(value);
	 ...
	 */
	public Field72Z setComponent2(String component2) {
		setComponent(2, component2);
		return this;
	}
	/**
	 ...
	 */
	public Field72Z setComponent3(String component3) {
		setComponent(3, component3);
		return this;
	}
	/**
	 ...
	 */
	public Field72Z setComponent4(String component4) {
		setComponent(4, component4);
		return this;
	}
	/**
	 ...
	 */
	public Field72Z setComponent5(String component5) {
		setComponent(5, component5);
		return this;
	}
	/**
	 ...
	 */
	public Field72Z setComponent6(String component6) {
		setComponent(6, component6);
		return this;
	}
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field72Z.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field72Z.COMPONENTS_PATTERN
	 */
	@Override
	 ...
	 */
	public static Field72Z get(final SwiftTagListBlock block) {
		...
		return new Field72Z(t) ;
	}
	
	/**
	 * Gets the first instance of Field72Z in the given message.
	 * @param msg may be empty or null
	 * @return null if not found or msg is empty or null
	 * @see #get(SwiftTagListBlock)
	 */
	public static Field72Z get(final SwiftMessage msg) {
	...
	/**
	 * Gets a list of all occurrences of the field Field72Z in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field72Z> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field72Z from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field72Z> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field72Z> result = new ArrayList<Field72Z>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field72Z(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 6) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 72Z");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field72Z object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field72Z fromJson(final String json) {
		Field72Z field = new Field72Z();
