...
/**
 * <strong>SWIFT MT Field 92A</strong>
 * <p>
...
@Generated
public class Field92A extends Field implements Serializable, AmountContainer, com.financial.swift.model.field.GenericField {
	/**
	...
	*/
	 ...
	 * @param component3 the Rate Amount to set
	 */
	 ...
	 * @param component3 Number with the Rate Amount content to set
	 */
   ...
   public String parserPattern() {
	...
	public static List<Field92A> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field92A> result = new ArrayList<Field92A>(arr.length);
			for (final Tag f : arr) {
