...
public class Field37J extends Field implements Serializable, AmountContainer {
	 ...
	 */
	public Field37J(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field37J(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "37J")) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field37J.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field37J in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field37J in the given message
	...
	/**
	 * Gets a list of all occurrences of the field Field37J from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field37J> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field37J> result = new ArrayList<Field37J>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field37J object.
