...
/**
 * <strong>SWIFT MT Field 401</strong>
 * <p>
...
public class Field401 extends Field implements Serializable {
	...
	*/
	 ...
	 * @return the Code from component1 converted to Number or null if cannot be converted
	 */
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field401.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field401> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field401> result = new ArrayList<Field401>(arr.length);
			for (final Tag f : arr) {
