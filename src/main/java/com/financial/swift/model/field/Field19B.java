...
/**
 * <strong>SWIFT MT Field 19B</strong>
 * <p>
 * Model and parser for field 19B of a SWIFT MT message.
 *
...
@Generated
public class Field19B extends Field implements Serializable, CurrencyContainer, AmountContainer, com.financial.swift.model.field.GenericField {
	/**
	 ...
	 */
	public Field19B(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field19B(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "19B")) {
			throw new IllegalArgumentException("cannot create field 19B from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field19B newInstance(Field19B source) {
		Field19B cp = new Field19B();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field19B.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field19B.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field19B get(final SwiftTagListBlock block) {
		...
		return new Field19B(t) ;
	}
	
	/**
	 * Gets the first instance of Field19B in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field19B in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field19B> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return java.util.Collections.emptyList();
	...
	/**
	 * Gets a list of all occurrences of the field Field19B from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field19B> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field19B> result = new ArrayList<Field19B>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field19B(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 3) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 19B");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field19B object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field19B fromJson(final String json) {
		Field19B field = new Field19B();
