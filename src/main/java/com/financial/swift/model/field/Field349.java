...
/**
 * <strong>SWIFT MT Field 349</strong>
 * <p>
 * Model and parser for field 349 of a SWIFT MT message.
 *
...
public class Field349 extends Field implements Serializable {
	 ...
	 */
	public Field349(final String value) {
		super(value);
	}
	 ...
	 * @since 7.7
	 */
	public static Field349 newInstance(Field349 source) {
		Field349 cp = new Field349();
	...
	*/
	...
	/**
	 * Gets the Combined Criteria (component1).
	 ...
	 * @return the Combined Criteria from component1 converted to Number or null if cannot be converted
	 */
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field349.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field349.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field349 get(final SwiftTagListBlock block) {
		...
		return new Field349(t) ;
	}
	
	/**
	 * Gets the first instance of Field349 in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field349 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field349> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field349 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field349> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field349> result = new ArrayList<Field349>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field349(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	protected Map<Integer, String> getComponentMap() {
		...
		result.put(1, "combinedCriteria");
		return result;
	}

	/**
	 * This method deserializes the JSON data into a Field349 object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field349 fromJson(final String json) {
		Field349 field = new Field349();
		JsonParser parser = new JsonParser();
		JsonObject jsonObject = (JsonObject) parser.parse(json);
		if (jsonObject.get("combinedCriteria") != null) {
			field.setComponent1(jsonObject.get("combinedCriteria").getAsString());
		}
		return field;
	}
