...
/**
 * <strong>SWIFT MT Field 85J</strong>
 * <p>
...
public class Field85J extends Field implements Serializable {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field85J.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field85J> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field85J> result = new ArrayList<Field85J>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 1) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 85J");
		}
		if (component == 1) {
