...
/**
 * <strong>SWIFT MT Field 56J</strong>
 * <p>
 * Model and parser for field 56J of a SWIFT MT message.
 *
...
public class Field56J extends Field implements Serializable {
	 ...
	 */
	public Field56J(final String value) {
		super(value);
	}
	 ...
	 * @since 7.7
	 */
	public static Field56J newInstance(Field56J source) {
		Field56J cp = new Field56J();
	...
	*/
	 ...
	 */
	public Field56J setPartyIdentification(String component1) {
		setComponent(1, component1);
		return this;
	}
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field56J.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field56J.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field56J get(final SwiftTagListBlock block) {
		...
		return new Field56J(t) ;
	}
	
	/**
	 * Gets the first instance of Field56J in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field56J in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field56J> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field56J from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field56J> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field56J> result = new ArrayList<Field56J>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field56J(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 1) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 56J");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field56J object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field56J fromJson(final String json) {
		Field56J field = new Field56J();
