...
/**
 * <strong>SWIFT MT Field 84B</strong>
 * <p>
...
@Generated
public class Field84B extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field84B(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field84B(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "84B")) {
			throw new IllegalArgumentException("cannot create field 84B from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field84B.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field84B.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets a list of all occurrences of the field Field84B in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field84B> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field84B from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field84B> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field84B> result = new ArrayList<Field84B>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field84B(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 3) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 84B");
		}
		if (component == 1) {
	 ...
	 */
	public static Field84B fromJson(final String json) {
		Field84B field = new Field84B();
