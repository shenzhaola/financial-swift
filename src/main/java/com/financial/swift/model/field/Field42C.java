...
/**
 * <strong>SWIFT MT Field 42C</strong>
 * <p>
 * Model and parser for field 42C of a SWIFT MT message.
 *
...
@Generated
public class Field42C extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field42C(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field42C(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "42C")) {
			throw new IllegalArgumentException("cannot create field 42C from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field42C newInstance(Field42C source) {
		Field42C cp = new Field42C();
	...
	*/
	 ...
	 */
	public Field42C setNarrativeLine1(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field42C setNarrativeLine2(String component2) {
	 ...
	 */
	public Field42C setNarrativeLine3(String component3) {
	 ...
	 */
	public Field42C setNarrative(String value) {
		List<String> lines = SwiftParseUtils.getLines(value);
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field42C.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field42C.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field42C get(final SwiftTagListBlock block) {
		...
		return new Field42C(t) ;
	}
	
	/**
	 * Gets the first instance of Field42C in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field42C in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field42C> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field42C from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field42C> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field42C> result = new ArrayList<Field42C>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field42C(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 3) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 42C");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field42C object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field42C fromJson(final String json) {
		Field42C field = new Field42C();
