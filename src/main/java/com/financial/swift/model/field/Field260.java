...
public class Field260 extends Field implements Serializable, DateContainer {
	...
	*/
	 ...
	 */
	public Field260 setComponent1(com.financial.swift.model.LogicalTerminalAddress component1) {
	 ...
	 */
	public Field260 setLTAddress(com.financial.swift.model.LogicalTerminalAddress component1) {
   ...
   public String parserPattern() {
	...
	public static List<Field260> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field260> result = new ArrayList<Field260>(arr.length);
			for (final Tag f : arr) {
