...
/**
 * <strong>SWIFT MT Field 53J</strong>
 * <p>
 * Model and parser for field 53J of a SWIFT MT message.
 *
...
public class Field53J extends Field implements Serializable {
	 ...
	 */
	public Field53J(final String value) {
		super(value);
	}
	 ...
	 * @since 7.7
	 */
	public static Field53J newInstance(Field53J source) {
		Field53J cp = new Field53J();
	...
	*/
	 ...
	 */
	public Field53J setPartyIdentification(String component1) {
		setComponent(1, component1);
		return this;
	}
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field53J.NAME
	 */
	@Override
	...
	public static Field53J get(final SwiftTagListBlock block) {
		...
		return new Field53J(t) ;
	}
	
	/**
	 * Gets the first instance of Field53J in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field53J in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field53J> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field53J from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field53J> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field53J> result = new ArrayList<Field53J>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field53J(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	/**
	 * This method deserializes the JSON data into a Field53J object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field53J fromJson(final String json) {
		Field53J field = new Field53J();
