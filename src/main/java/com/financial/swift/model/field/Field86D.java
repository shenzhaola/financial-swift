...
/**
 * <strong>SWIFT MT Field 86D</strong>
 * <p>
...
@Generated
public class Field86D extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field86D> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field86D> result = new ArrayList<Field86D>(arr.length);
			for (final Tag f : arr) {
