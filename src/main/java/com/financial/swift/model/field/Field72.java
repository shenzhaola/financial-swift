...
/**
 * <strong>SWIFT MT Field 72</strong>
 * <p>
...
@Generated
public class Field72 extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field72(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field72(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "72")) {
			throw new IllegalArgumentException("cannot create field 72 from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field72 newInstance(Field72 source) {
		Field72 cp = new Field72();
	...
	*/
	 ...
	 */
	public Field72 setNarrativeLine1(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field72 setNarrativeLine2(String component2) {
	 ...
	 */
	public Field72 setNarrativeLine3(String component3) {
	 ...
	 */
	public Field72 setNarrativeLine4(String component4) {
	 ...
	 */
	public Field72 setNarrativeLine5(String component5) {
	 ...
	 */
	public Field72 setNarrativeLine6(String component6) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field72.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field72.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field72 get(final SwiftTagListBlock block) {
		...
		return new Field72(t) ;
	}
	
	/**
	 * Gets the first instance of Field72 in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field72 in the given message
	...
	/**
	 * Gets a list of all occurrences of the field Field72 from the given block
	 * an empty list is returned if none found.
	 *
	...
	public static List<Field72> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field72> result = new ArrayList<Field72>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field72 object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field72 fromJson(final String json) {
		Field72 field = new Field72();
