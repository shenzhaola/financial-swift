...
public class Field259 extends Field implements Serializable, DateContainer {
	...
	*/
	 ...
	 */
	public Field259 setComponent1(com.financial.swift.model.LogicalTerminalAddress component1) {
	 ...
	 */
	public Field259 setLTAddress(com.financial.swift.model.LogicalTerminalAddress component1) {
   ...
   public String parserPattern() {
	...
	public static List<Field259> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field259> result = new ArrayList<Field259>(arr.length);
			for (final Tag f : arr) {
