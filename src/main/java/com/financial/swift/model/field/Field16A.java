...
/**
 * <strong>SWIFT MT Field 16A</strong>
 * <p>
 * Model and parser for field 16A of a SWIFT MT message.
 *
...
public class Field16A extends Field implements Serializable {
	 ...
	 */
	public Field16A(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field16A(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "16A")) {
			throw new IllegalArgumentException("cannot create field 16A from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field16A newInstance(Field16A source) {
		Field16A cp = new Field16A();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field16A.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field16A.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field16A get(final SwiftTagListBlock block) {
		...
		return new Field16A(t) ;
	}
	
	/**
	 * Gets the first instance of Field16A in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field16A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field16A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field16A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field16A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field16A> result = new ArrayList<Field16A>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field16A object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field16A fromJson(final String json) {
		Field16A field = new Field16A();
