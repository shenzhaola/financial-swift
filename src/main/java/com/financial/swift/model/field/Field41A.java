...
@Generated
public class Field41A extends Field implements Serializable, BICContainer, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field41A(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field41A(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "41A")) {
	...
	*/
	 ...
	 */
	public Field41A setComponent1(com.financial.swift.model.BIC component1) {
	 ...
	 */
	public Field41A setBIC(com.financial.swift.model.BIC component1) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field41A.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field41A.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field41A in the given message.
	 ...
	 */ 
	public static List<Field41A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	 ...
	 */ 
	public static List<Field41A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field41A> result = new ArrayList<Field41A>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field41A object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field41A fromJson(final String json) {
