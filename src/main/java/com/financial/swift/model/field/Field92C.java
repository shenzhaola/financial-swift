...
/**
 * <strong>SWIFT MT Field 92C</strong>
 * <p>
 * Model and parser for field 92C of a SWIFT MT message.
 *
 ...
 * <ul>
 * 		<li>validation pattern: <code>:4!c/[8c]/24x</code></li>
...
@Generated
public class Field92C extends Field implements Serializable, com.financial.swift.model.field.GenericField {
	/**
	 ...
	 */
	public Field92C(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field92C(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "92C")) {
			throw new IllegalArgumentException("cannot create field 92C from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field92C newInstance(Field92C source) {
		Field92C cp = new Field92C();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field92C.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field92C.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field92C get(final SwiftTagListBlock block) {
		...
		return new Field92C(t) ;
	}
	
	/**
	 * Gets the first instance of Field92C in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field92C in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field92C> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field92C from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field92C> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field92C> result = new ArrayList<Field92C>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field92C(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 3) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 92C");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field92C object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field92C fromJson(final String json) {
		Field92C field = new Field92C();
