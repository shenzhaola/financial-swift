...
@Generated
public class Field42A extends Field implements Serializable, BICContainer, com.financial.swift.model.field.MultiLineField {
	/**
	...
	*/
	 ...
	 */
	public Field42A setComponent3(com.financial.swift.model.BIC component3) {
	 ...
	 */
	public Field42A setBIC(com.financial.swift.model.BIC component3) {
   ...
   public String parserPattern() {
	...
	public static List<Field42A> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field42A> result = new ArrayList<Field42A>(arr.length);
			for (final Tag f : arr) {
