...
/**
 * <strong>SWIFT MT Field 90L</strong>
 * <p>
 * Model and parser for field 90L of a SWIFT MT message.
 *
...
@Generated
public class Field90L extends Field implements Serializable, AmountContainer, com.financial.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field90L> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field90L> result = new ArrayList<Field90L>(arr.length);
			for (final Tag f : arr) {
