...
/**
 * <strong>SWIFT MT Field 50C</strong>
 * <p>
 * Model and parser for field 50C of a SWIFT MT message.
 *
...
public class Field50C extends Field implements Serializable, BICContainer {
	 ...
	 */
	public Field50C(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field50C(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "50C")) {
			throw new IllegalArgumentException("cannot create field 50C from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field50C newInstance(Field50C source) {
		Field50C cp = new Field50C();
	...
	*/
	 ...
	 */
	public Field50C setComponent1(com.financial.swift.model.BIC component1) {
	 ...
	 */
	public Field50C setBIC(com.financial.swift.model.BIC component1) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field50C.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field50C.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field50C get(final SwiftTagListBlock block) {
		...
		return new Field50C(t) ;
	}
	
	/**
	 * Gets the first instance of Field50C in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field50C in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field50C> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field50C from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field50C> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field50C> result = new ArrayList<Field50C>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field50C(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	/**
	 * This method deserializes the JSON data into a Field50C object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field50C fromJson(final String json) {
		Field50C field = new Field50C();
