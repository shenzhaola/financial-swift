...
/**
 * <strong>SWIFT MT Field 51C</strong>
 * <p>
 * Model and parser for field 51C of a SWIFT MT message.
 *
...
public class Field51C extends Field implements Serializable {
	 ...
	 */
	public Field51C(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field51C(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "51C")) {
			throw new IllegalArgumentException("cannot create field 51C from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field51C newInstance(Field51C source) {
		Field51C cp = new Field51C();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field51C.NAME
	 */
	@Override
	...
	public static Field51C get(final SwiftTagListBlock block) {
		...
		return new Field51C(t) ;
	}
	
	/**
	 * Gets the first instance of Field51C in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field51C in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field51C> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field51C from the given block
	 * an empty list is returned if none found.
	 *
	...
	public static List<Field51C> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field51C> result = new ArrayList<Field51C>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field51C object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field51C fromJson(final String json) {
		Field51C field = new Field51C();
