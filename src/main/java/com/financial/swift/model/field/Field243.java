...
/**
 * <strong>SWIFT MT Field 243</strong>
 * <p>
 * Model and parser for field 243 of a SWIFT MT message.
 *
...
public class Field243 extends Field implements Serializable {
	 ...
	 */
	public Field243(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field243(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "243")) {
			throw new IllegalArgumentException("cannot create field 243 from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field243 newInstance(Field243 source) {
		Field243 cp = new Field243();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field243.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field243.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field243 get(final SwiftTagListBlock block) {
		...
		return new Field243(t) ;
	}
	
	/**
	 * Gets the first instance of Field243 in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field243 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field243> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field243 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field243> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field243> result = new ArrayList<Field243>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field243(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	/**
	 * This method deserializes the JSON data into a Field243 object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field243 fromJson(final String json) {
		Field243 field = new Field243();
