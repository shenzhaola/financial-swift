...
@Generated
public class Field58A extends Field implements Serializable, BICContainer, com.financial.swift.model.field.MultiLineField {
	/**
	...
	*/
	 ...
	 */
	public Field58A setComponent3(com.financial.swift.model.BIC component3) {
	 ...
	 */
	public Field58A setBIC(com.financial.swift.model.BIC component3) {
   ...
   public String parserPattern() {
	...
	public static List<Field58A> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field58A> result = new ArrayList<Field58A>(arr.length);
			for (final Tag f : arr) {
