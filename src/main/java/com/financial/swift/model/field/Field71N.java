...
/**
 * <strong>SWIFT MT Field 71N</strong>
 * <p>
 * Model and parser for field 71N of a SWIFT MT message.
 *
 ...
 * <ul>
 * 		<li>validation pattern: <code>4!c[$35z]0-6</code></li>
...
@Generated
public class Field71N extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	...
	/**
	 * Constant with the field name 71N
	 */
	 ...
	 */
	public Field71N(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field71N(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "71N")) {
	...
	*/
	...
	/**
	 * Gets the Narrative as a concatenation of component1 to component7.
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field71N.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field71N.COMPONENTS_PATTERN
	 */
	@Override
	 ...
	 */
	public static Field71N get(final SwiftTagListBlock block) {
	...
	/**
	 * Gets the first instance of Field71N in the given message.
	 * @param msg may be empty or null
	 * @return null if not found or msg is empty or null
	 * @see #get(SwiftTagListBlock)
	 */
	public static Field71N get(final SwiftMessage msg) {
	...
	/**
	 * Gets a list of all occurrences of the field Field71N in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field71N> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field71N from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field71N> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field71N> result = new ArrayList<Field71N>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field71N object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field71N fromJson(final String json) {
