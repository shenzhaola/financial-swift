...
/**
 * <strong>SWIFT MT Field 35S</strong>
 * <p>
 * Model and parser for field 35S of a SWIFT MT message.
 *
...
public class Field35S extends Field implements Serializable, AmountContainer {
	 ...
	 */
	public Field35S(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field35S(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "35S")) {
			throw new IllegalArgumentException("cannot create field 35S from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field35S newInstance(Field35S source) {
		Field35S cp = new Field35S();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field35S.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field35S.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field35S get(final SwiftTagListBlock block) {
		...
		return new Field35S(t) ;
	}
	
	/**
	 * Gets the first instance of Field35S in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field35S in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field35S> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field35S from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field35S> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field35S> result = new ArrayList<Field35S>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field35S(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 2) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 35S");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field35S object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field35S fromJson(final String json) {
		Field35S field = new Field35S();
