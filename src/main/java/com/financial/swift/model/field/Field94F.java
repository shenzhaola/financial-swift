...
@Generated
public class Field94F extends Field implements Serializable, BICContainer, com.financial.swift.model.field.GenericField {
	/**
	...
	*/
	 ...
	 */
	public Field94F setComponent3(com.financial.swift.model.BIC component3) {
	 ...
	 */
	public Field94F setBIC(com.financial.swift.model.BIC component3) {
   ...
   public String parserPattern() {
	...
	public static List<Field94F> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field94F> result = new ArrayList<Field94F>(arr.length);
			for (final Tag f : arr) {
