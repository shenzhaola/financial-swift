...
@Generated
public class Field69B extends Field implements Serializable, DateContainer, com.financial.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field69B> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field69B> result = new ArrayList<Field69B>(arr.length);
			for (final Tag f : arr) {
