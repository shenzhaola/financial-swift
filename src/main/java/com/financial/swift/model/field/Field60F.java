...
public class Field60F extends Field implements Serializable, DateContainer, AmountContainer {
	 ...
	 */
	public Field60F(final String value) {
		super(value);
	}
	 ...
	 * @since 7.7
	 */
	public static Field60F newInstance(Field60F source) {
		Field60F cp = new Field60F();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field60F.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field60F in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field60F in the given message
	...
	/**
	 * Gets a list of all occurrences of the field Field60F from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field60F> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field60F> result = new ArrayList<Field60F>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 4) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 60F");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field60F object.
