...
/**
 * <strong>SWIFT MT Field 22K</strong>
 * <p>
...
public class Field22K extends Field implements Serializable {
	...
	*/
	...
	/**
	 * Gets the Type Of Event (component1).
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field22K.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field22K> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field22K> result = new ArrayList<Field22K>(arr.length);
			for (final Tag f : arr) {
