...
/**
 * <strong>SWIFT MT Field 171</strong>
 * <p>
 * Model and parser for field 171 of a SWIFT MT message.
 *
...
public class Field171 extends Field implements Serializable, DateContainer {
	 ...
	 */
	public Field171(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field171(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "171")) {
			throw new IllegalArgumentException("cannot create field 171 from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field171 newInstance(Field171 source) {
		Field171 cp = new Field171();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field171.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field171.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field171 get(final SwiftTagListBlock block) {
		...
		return new Field171(t) ;
	}
	
	/**
	 * Gets the first instance of Field171 in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field171 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field171> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field171 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field171> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field171> result = new ArrayList<Field171>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field171 object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field171 fromJson(final String json) {
		Field171 field = new Field171();
