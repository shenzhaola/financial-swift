...
/**
 * <strong>SWIFT MT Field 82D</strong>
 * <p>
...
@Generated
public class Field82D extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field82D(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field82D(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "82D")) {
			throw new IllegalArgumentException("cannot create field 82D from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field82D newInstance(Field82D source) {
		Field82D cp = new Field82D();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field82D.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field82D.COMPONENTS_PATTERN
	 */
	@Override
	 ...
	 */ 
	public static List<Field82D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	 ...
	 */ 
	public static List<Field82D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field82D> result = new ArrayList<Field82D>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field82D(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 6) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 82D");
		}
		if (component == 1) {
	 ...
	 */
	public static Field82D fromJson(final String json) {
		Field82D field = new Field82D();
