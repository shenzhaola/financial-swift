...
/**
 * <strong>SWIFT MT Field 14C</strong>
 * <p>
 * Model and parser for field 14C of a SWIFT MT message.
 *
...
public class Field14C extends Field implements Serializable {
	 ...
	 */
	public Field14C(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field14C(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "14C")) {
			throw new IllegalArgumentException("cannot create field 14C from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field14C newInstance(Field14C source) {
		Field14C cp = new Field14C();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field14C.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field14C.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field14C get(final SwiftTagListBlock block) {
		...
		return new Field14C(t) ;
	}
	
	/**
	 * Gets the first instance of Field14C in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field14C in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field14C> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field14C from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field14C> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field14C> result = new ArrayList<Field14C>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field14C object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field14C fromJson(final String json) {
		Field14C field = new Field14C();
		JsonParser parser = new JsonParser();
		JsonObject jsonObject = (JsonObject) parser.parse(json);
		if (jsonObject.get("year") != null) {
			field.setComponent1(jsonObject.get("year").getAsString());
		}
		return field;
	}
