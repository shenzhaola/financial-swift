...
@Generated
public class Field98E extends Field implements Serializable, DateContainer, com.financial.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field98E> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field98E> result = new ArrayList<Field98E>(arr.length);
			for (final Tag f : arr) {
