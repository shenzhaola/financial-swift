...
/**
 * <strong>SWIFT MT Field 33E</strong>
 * <p>
 * Model and parser for field 33E of a SWIFT MT message.
 *
...
public class Field33E extends Field implements Serializable, CurrencyContainer, AmountContainer {
	 ...
	 */
	public Field33E(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field33E(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "33E")) {
			throw new IllegalArgumentException("cannot create field 33E from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field33E newInstance(Field33E source) {
		Field33E cp = new Field33E();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field33E.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field33E.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field33E get(final SwiftTagListBlock block) {
		...
		return new Field33E(t) ;
	}
	
	/**
	 * Gets the first instance of Field33E in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field33E in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field33E> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return java.util.Collections.emptyList();
	...
	/**
	 * Gets a list of all occurrences of the field Field33E from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field33E> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field33E> result = new ArrayList<Field33E>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field33E(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	/**
	 * This method deserializes the JSON data into a Field33E object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field33E fromJson(final String json) {
		Field33E field = new Field33E();
