...
/**
 * <strong>SWIFT MT Field 37U</strong>
 * <p>
...
public class Field37U extends Field implements Serializable, AmountContainer {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field37U.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field37U> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field37U> result = new ArrayList<Field37U>(arr.length);
			for (final Tag f : arr) {
