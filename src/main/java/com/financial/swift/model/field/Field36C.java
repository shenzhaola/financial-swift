...
/**
 * <strong>SWIFT MT Field 36C</strong>
 * <p>
 * Model and parser for field 36C of a SWIFT MT message.
 *
...
@Generated
public class Field36C extends Field implements Serializable, com.financial.swift.model.field.GenericField {
	/**
	 ...
	 */
	public Field36C(final String value) {
		super(value);
	}
	 ...
	 * @since 7.7
	 */
	public static Field36C newInstance(Field36C source) {
		Field36C cp = new Field36C();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field36C.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field36C.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field36C get(final SwiftTagListBlock block) {
		...
		return new Field36C(t) ;
	}
	
	/**
	 * Gets the first instance of Field36C in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field36C in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field36C> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field36C from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field36C> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field36C> result = new ArrayList<Field36C>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field36C(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 2) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 36C");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field36C object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field36C fromJson(final String json) {
		Field36C field = new Field36C();
