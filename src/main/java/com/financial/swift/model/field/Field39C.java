...
/**
 * <strong>SWIFT MT Field 39C</strong>
 * <p>
 * Model and parser for field 39C of a SWIFT MT message.
 *
...
@Generated
public class Field39C extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field39C(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field39C(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "39C")) {
			throw new IllegalArgumentException("cannot create field 39C from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field39C newInstance(Field39C source) {
		Field39C cp = new Field39C();
	...
	*/
	 ...
	 */
	public Field39C setNarrativeLine1(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field39C setNarrativeLine2(String component2) {
	 ...
	 */
	public Field39C setNarrativeLine3(String component3) {
	 ...
	 */
	public Field39C setNarrativeLine4(String component4) {
	 ...
	 */
	public Field39C setNarrative(String value) {
		List<String> lines = SwiftParseUtils.getLines(value);
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field39C.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field39C.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field39C get(final SwiftTagListBlock block) {
		...
		return new Field39C(t) ;
	}
	
	/**
	 * Gets the first instance of Field39C in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field39C in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field39C> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field39C from the given block
	 * an empty list is returned if none found.
	 *
	...
	public static List<Field39C> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field39C> result = new ArrayList<Field39C>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 4) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 39C");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field39C object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field39C fromJson(final String json) {
		Field39C field = new Field39C();
