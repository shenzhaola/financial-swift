...
/**
 * <strong>SWIFT MT Field 111</strong>
 * <p>
 * Model and parser for field 111 of a SWIFT MT message.
 *
 ...
 * <ul>
 * 		<li>validation pattern: <code>3!n</code></li>
...
@Generated
public class Field111 extends Field implements Serializable {
	/**
	 ...
	 */
	public static final Integer SERVICE_TYPE_IDENTIFIER = 1;
	 ...
	 */
	public Field111(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field111(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "111")) {
			throw new IllegalArgumentException("cannot create field 111 from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field111 newInstance(Field111 source) {
		Field111 cp = new Field111();
	...
	*/
	 ...
	 */
	public Field111 setComponent1(String component1) {
	 ...
	 * @param component1 the Service Type Identifier to set
	 */
	public Field111 setServiceTypeIdentifier(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 * @param component1 Number with the Service Type Identifier content to set
	 */
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field111.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field111.COMPONENTS_PATTERN
	 */
	@Override
	 ...
	 */
	public static Field111 get(final SwiftTagListBlock block) {
		...
		return new Field111(t) ;
	}
	
	/**
	 * Gets the first instance of Field111 in the given message.
	 * @param msg may be empty or null
	 * @return null if not found or msg is empty or null
	 * @see #get(SwiftTagListBlock)
	 */
	public static Field111 get(final SwiftMessage msg) {
	...
	/**
	 * Gets a list of all occurrences of the field Field111 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field111> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field111 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field111> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field111> result = new ArrayList<Field111>(arr.length);
			for (final Tag f : arr) {
	...
	protected List<String> getComponentLabels() {
		...
		result.add("Service Type Identifier");
		return result;
	}
	...
	protected Map<Integer, String> getComponentMap() {
		...
		result.put(1, "serviceTypeIdentifier");
		return result;
	}

	/**
	 * This method deserializes the JSON data into a Field111 object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field111 fromJson(final String json) {
		Field111 field = new Field111();
		JsonParser parser = new JsonParser();
		JsonObject jsonObject = (JsonObject) parser.parse(json);
		if (jsonObject.get("serviceTypeIdentifier") != null) {
			field.setComponent1(jsonObject.get("serviceTypeIdentifier").getAsString());
		}
		return field;
	}
