...
/**
 * <strong>SWIFT MT Field 77D</strong>
 * <p>
 * Model and parser for field 77D of a SWIFT MT message.
 *
...
@Generated
public class Field77D extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field77D(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field77D(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "77D")) {
			throw new IllegalArgumentException("cannot create field 77D from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field77D newInstance(Field77D source) {
		Field77D cp = new Field77D();
	...
	*/
	 ...
	 */
	public Field77D setNarrativeLine1(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field77D setNarrativeLine2(String component2) {
	 ...
	 */
	public Field77D setNarrativeLine3(String component3) {
	 ...
	 */
	public Field77D setNarrativeLine4(String component4) {
	 ...
	 */
	public Field77D setNarrativeLine5(String component5) {
	 ...
	 */
	public Field77D setNarrativeLine6(String component6) {
	 ...
	 */
	public Field77D setNarrative(String value) {
		List<String> lines = SwiftParseUtils.getLines(value);
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field77D.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field77D.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field77D get(final SwiftTagListBlock block) {
		...
		return new Field77D(t) ;
	}
	
	/**
	 * Gets the first instance of Field77D in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field77D in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field77D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field77D from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field77D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field77D> result = new ArrayList<Field77D>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field77D(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 6) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 77D");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field77D object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field77D fromJson(final String json) {
		Field77D field = new Field77D();
