...
public class Field263 extends Field implements Serializable, DateContainer {
	...
	*/
	 ...
	 */
	public Field263 setComponent1(com.financial.swift.model.LogicalTerminalAddress component1) {
	 ...
	 */
	public Field263 setLTAddress(com.financial.swift.model.LogicalTerminalAddress component1) {
   ...
   public String parserPattern() {
	...
	public static List<Field263> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field263> result = new ArrayList<Field263>(arr.length);
			for (final Tag f : arr) {
