...
/**
 * <strong>SWIFT MT Field 14G</strong>
 * <p>
 * Model and parser for field 14G of a SWIFT MT message.
 *
 ...
 * <ul>
 * 		<li>validation pattern: <code>1a/8!a</code></li>
...
public class Field14G extends Field implements Serializable {
	 ...
	 */
	public Field14G(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field14G(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "14G")) {
	...
	*/
	 ...
	 * @param component1 the Frequency to set
	 */
	 ...
	 * @param component2 the Method to set
	 */
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field14G.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field14G.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field14G in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field14G in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field14G> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field14G from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field14G> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field14G> result = new ArrayList<Field14G>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field14G object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field14G fromJson(final String json) {
