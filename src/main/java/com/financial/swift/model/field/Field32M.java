...
/**
 * <strong>SWIFT MT Field 32M</strong>
 * <p>
 * Model and parser for field 32M of a SWIFT MT message.
 *
...
public class Field32M extends Field implements Serializable, CurrencyContainer, AmountContainer {
	 ...
	 */
	public Field32M(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field32M(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "32M")) {
			throw new IllegalArgumentException("cannot create field 32M from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field32M newInstance(Field32M source) {
		Field32M cp = new Field32M();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field32M.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field32M.COMPONENTS_PATTERN
	 */
	@Override
	 ...
	 */ 
	public static List<Field32M> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return java.util.Collections.emptyList();
	 ...
	 */ 
	public static List<Field32M> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field32M> result = new ArrayList<Field32M>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field32M(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
