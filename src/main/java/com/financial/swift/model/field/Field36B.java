 ...
 * <ul>
 * 		<li>validation pattern: <code>:4!c//4!c/&lt;AMOUNT&gt;15</code></li>
...
@Generated
public class Field36B extends Field implements Serializable, AmountContainer, com.financial.swift.model.field.GenericField {
	/**
	 ...
	 */
	public Field36B(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field36B(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "36B")) {
	...
	*/
	 ...
	 * @return the Quantity from component3 converted to Number or null if cannot be converted
	 */
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field36B.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field36B in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field36B in the given message
	...
	/**
	 * Gets a list of all occurrences of the field Field36B from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field36B> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field36B> result = new ArrayList<Field36B>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field36B object.
