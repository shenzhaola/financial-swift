...
/**
 * <strong>SWIFT MT Field 58D</strong>
 * <p>
 * Model and parser for field 58D of a SWIFT MT message.
 *
...
@Generated
public class Field58D extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field58D(final String value) {
		super(value);
	}
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field58D.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field58D.COMPONENTS_PATTERN
	 */
	@Override
	 ...
	 */
	public static Field58D get(final SwiftTagListBlock block) {
	...
	/**
	 * Gets the first instance of Field58D in the given message.
	 * @param msg may be empty or null
	 * @return null if not found or msg is empty or null
	 * @see #get(SwiftTagListBlock)
	 */
	public static Field58D get(final SwiftMessage msg) {
	...
	/**
	 * Gets a list of all occurrences of the field Field58D in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field58D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field58D from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field58D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field58D> result = new ArrayList<Field58D>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field58D object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field58D fromJson(final String json) {
