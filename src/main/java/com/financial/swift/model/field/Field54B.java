...
/**
 * <strong>SWIFT MT Field 54B</strong>
 * <p>
 * Model and parser for field 54B of a SWIFT MT message.
 *
...
@Generated
public class Field54B extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field54B(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field54B(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "54B")) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field54B.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field54B.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field54B in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field54B in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field54B> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field54B from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field54B> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field54B> result = new ArrayList<Field54B>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field54B object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field54B fromJson(final String json) {
		Field54B field = new Field54B();
