...
/**
 * <strong>SWIFT MT Field 99B</strong>
 * <p>
 ...
 * <ul>
 * 		<li>validation pattern: <code>:4!c//3!n</code></li>
...
@Generated
public class Field99B extends Field implements Serializable, com.financial.swift.model.field.GenericField {
	/**
	 ...
	 */
	public Field99B(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field99B(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "99B")) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field99B.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field99B.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets a list of all occurrences of the field Field99B in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field99B> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field99B from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field99B> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field99B> result = new ArrayList<Field99B>(arr.length);
			for (final Tag f : arr) {
	 ...
	 */
	public static Field99B fromJson(final String json) {
		Field99B field = new Field99B();
