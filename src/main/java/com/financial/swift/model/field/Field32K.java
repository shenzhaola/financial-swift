...
public class Field32K extends Field implements Serializable, CurrencyContainer, AmountContainer {
	 ...
	 */
	public Field32K(final String value) {
		super(value);
	}
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field32K.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field32K.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field32K in the given message.
	...
	public static List<Field32K> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field32K> result = new ArrayList<Field32K>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field32K object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field32K fromJson(final String json) {
