...
@Generated
public class Field91A extends Field implements Serializable, BICContainer, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field91A(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field91A(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "91A")) {
			throw new IllegalArgumentException("cannot create field 91A from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	...
	*/
	 ...
	 */
	public Field91A setComponent3(com.financial.swift.model.BIC component3) {
	 ...
	 */
	public Field91A setBIC(com.financial.swift.model.BIC component3) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field91A.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets a list of all occurrences of the field Field91A in the given message
	...
	/**
	 * Gets a list of all occurrences of the field Field91A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field91A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field91A> result = new ArrayList<Field91A>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 3) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 91A");
		}
		if (component == 1) {
