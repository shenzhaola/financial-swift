...
/**
 * <strong>SWIFT MT Field 82A</strong>
 * <p>
 * Model and parser for field 82A of a SWIFT MT message.
 *
...
@Generated
public class Field82A extends Field implements Serializable, BICContainer, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field82A(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field82A(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "82A")) {
			throw new IllegalArgumentException("cannot create field 82A from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field82A newInstance(Field82A source) {
		Field82A cp = new Field82A();
	...
	*/
	 ...
	 */
	public Field82A setComponent3(com.financial.swift.model.BIC component3) {
	 ...
	 */
	public Field82A setBIC(com.financial.swift.model.BIC component3) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field82A.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field82A.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field82A get(final SwiftTagListBlock block) {
		...
		return new Field82A(t) ;
	}
	
	/**
	 * Gets the first instance of Field82A in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field82A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field82A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field82A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field82A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field82A> result = new ArrayList<Field82A>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field82A(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 3) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 82A");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field82A object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field82A fromJson(final String json) {
		Field82A field = new Field82A();
