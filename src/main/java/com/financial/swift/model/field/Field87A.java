...
/**
 * <strong>SWIFT MT Field 87A</strong>
 * <p>
...
@Generated
public class Field87A extends Field implements Serializable, BICContainer, com.financial.swift.model.field.MultiLineField {
	/**
	...
	*/
	 ...
	 */
	public Field87A setComponent3(com.financial.swift.model.BIC component3) {
	 ...
	 */
	public Field87A setBIC(com.financial.swift.model.BIC component3) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field87A.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field87A> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field87A> result = new ArrayList<Field87A>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 3) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 87A");
		}
		if (component == 1) {
