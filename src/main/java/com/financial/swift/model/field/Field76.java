...
@Generated
public class Field76 extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	...
	*/
	 ...
	 */
	public Field76 setNarrativeLine1(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field76 setNarrativeLine2(String component2) {
	 ...
	 */
	public Field76 setNarrativeLine3(String component3) {
	 ...
	 */
	public Field76 setNarrativeLine4(String component4) {
	 ...
	 */
	public Field76 setNarrativeLine5(String component5) {
	 ...
	 */
	public Field76 setNarrativeLine6(String component6) {
	 ...
	 */
	public Field76 setNarrative(String value) {
		List<String> lines = SwiftParseUtils.getLines(value);
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field76.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field76> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field76> result = new ArrayList<Field76>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 6) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 76");
		}
		if (component == 1) {
