...
public class Field252 extends Field implements Serializable {
	...
	*/
	 ...
	 */
	public com.financial.swift.model.MIR getStartMIRAsMIR() {
		return SwiftFormatUtils.getMIR(getComponent(1));
	}
	 ...
	 */
	public Field252 setComponent1(com.financial.swift.model.MIR component1) {
	 ...
	 */
	public Field252 setStartMIR(com.financial.swift.model.MIR component1) {
	 ...
	 */
	public com.financial.swift.model.MIR getEndMIRAsMIR() {
		return SwiftFormatUtils.getMIR(getComponent(2));
	}
	 ...
	 */
	public Field252 setComponent2(com.financial.swift.model.MIR component2) {
	 ...
	 */
	public Field252 setEndMIR(com.financial.swift.model.MIR component2) {
   ...
   public String parserPattern() {
	...
	public static List<Field252> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field252> result = new ArrayList<Field252>(arr.length);
			for (final Tag f : arr) {
