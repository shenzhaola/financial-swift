...
/**
 * <strong>SWIFT MT Field 51A</strong>
 * <p>
...
@Generated
public class Field51A extends Field implements Serializable, BICContainer, com.financial.swift.model.field.MultiLineField {
	/**
	...
	*/
	 ...
	 */
	public Field51A setComponent3(com.financial.swift.model.BIC component3) {
	 ...
	 */
	public Field51A setBIC(com.financial.swift.model.BIC component3) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field51A.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field51A> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field51A> result = new ArrayList<Field51A>(arr.length);
			for (final Tag f : arr) {
