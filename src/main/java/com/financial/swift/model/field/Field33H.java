...
/**
 * <strong>SWIFT MT Field 33H</strong>
 * <p>
 * Model and parser for field 33H of a SWIFT MT message.
 *
...
@Generated
public class Field33H extends Field implements Serializable, CurrencyContainer, AmountContainer {
	/**
	 ...
	 */
    public static final String NAME = "33H";
    /**
	 ...
	 */
	public Field33H(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field33H(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "33H")) {
			throw new IllegalArgumentException("cannot create field 33H from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field33H newInstance(Field33H source) {
		Field33H cp = new Field33H();
	...
	*/
	 ...
	 */
	public Field33H setComponent1(String component1) {
	 ...
	 */
	public Field33H setComponent1(java.util.Currency component1) {
	 ...
	 */
	public Field33H setCurrency(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field33H setCurrency(java.util.Currency component1) {
	 ...
	 */
	public Field33H setComponent2(String component2) {
	 ...
	 */
	public Field33H setComponent2(java.lang.Number component2) {
	 ...
	 */
	public Field33H setAmount(String component2) {
		setComponent(2, component2);
		return this;
	}
	 ...
	 */
	public Field33H setAmount(java.lang.Number component2) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field33H.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field33H.COMPONENTS_PATTERN
	 */
	@Override
	 ...
	 */
	public static Field33H get(final SwiftTagListBlock block) {
		...
		return new Field33H(t) ;
	}
	
	/**
	 * Gets the first instance of Field33H in the given message.
	 * @param msg may be empty or null
	 * @return null if not found or msg is empty or null
	 * @see #get(SwiftTagListBlock)
	 */
	public static Field33H get(final SwiftMessage msg) {
	...
	/**
	 * Gets a list of all occurrences of the field Field33H in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field33H> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return java.util.Collections.emptyList();
	...
	/**
	 * Gets a list of all occurrences of the field Field33H from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field33H> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field33H> result = new ArrayList<Field33H>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field33H(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	/**
	 * This method deserializes the JSON data into a Field33H object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field33H fromJson(final String json) {
		Field33H field = new Field33H();
