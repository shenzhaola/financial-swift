...
/**
 * <strong>SWIFT MT Field 37G</strong>
 * <p>
 * Model and parser for field 37G of a SWIFT MT message.
 *
...
public class Field37G extends Field implements Serializable, AmountContainer {
	 ...
	 */
	public Field37G(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field37G(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "37G")) {
			throw new IllegalArgumentException("cannot create field 37G from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field37G newInstance(Field37G source) {
		Field37G cp = new Field37G();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field37G.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field37G.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field37G get(final SwiftTagListBlock block) {
		...
		return new Field37G(t) ;
	}
	
	/**
	 * Gets the first instance of Field37G in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field37G in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field37G> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field37G from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field37G> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field37G> result = new ArrayList<Field37G>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field37G(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 2) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 37G");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field37G object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field37G fromJson(final String json) {
		Field37G field = new Field37G();
