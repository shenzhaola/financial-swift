...
/**
 * <strong>SWIFT MT Field 77B</strong>
 * <p>
 * Model and parser for field 77B of a SWIFT MT message.
 *
...
@Generated
public class Field77B extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field77B(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field77B(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "77B")) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field77B.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field77B.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field77B in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field77B in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field77B> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field77B from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field77B> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field77B> result = new ArrayList<Field77B>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field77B object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field77B fromJson(final String json) {
