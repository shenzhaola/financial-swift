...
/**
 * <strong>SWIFT MT Field 44D</strong>
 * <p>
 * Model and parser for field 44D of a SWIFT MT message.
 *
 ...
 * <ul>
 * 		<li>validation pattern: <code>65x[$65x]0-5</code></li>
...
@Generated
public class Field44D extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field44D(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field44D(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "44D")) {
			throw new IllegalArgumentException("cannot create field 44D from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field44D newInstance(Field44D source) {
		Field44D cp = new Field44D();
	...
	*/
	 ...
	 */
	public Field44D setNarrativeLine1(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field44D setNarrativeLine2(String component2) {
	 ...
	 */
	public Field44D setNarrativeLine3(String component3) {
	 ...
	 */
	public Field44D setNarrativeLine4(String component4) {
	 ...
	 */
	public Field44D setNarrativeLine5(String component5) {
	 ...
	 */
	public Field44D setNarrativeLine6(String component6) {
	 ...
	 */
	public Field44D setNarrative(String value) {
		List<String> lines = SwiftParseUtils.getLines(value);
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field44D.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field44D.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field44D get(final SwiftTagListBlock block) {
		...
		return new Field44D(t) ;
	}
	
	/**
	 * Gets the first instance of Field44D in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field44D in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field44D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field44D from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field44D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field44D> result = new ArrayList<Field44D>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field44D(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 6) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 44D");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field44D object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field44D fromJson(final String json) {
		Field44D field = new Field44D();
