...
/**
 * <strong>SWIFT MT Field 102</strong>
 * <p>
...
public class Field102 extends Field implements Serializable {
	 ...
	 */
	public Field102(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field102(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "102")) {
			throw new IllegalArgumentException("cannot create field 102 from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field102 newInstance(Field102 source) {
		Field102 cp = new Field102();
	...
	*/
	 ...
	 */
	public Field102 setComponent1(com.financial.swift.model.LogicalTerminalAddress component1) {
	 ...
	 */
	public Field102 setLTAddress(com.financial.swift.model.LogicalTerminalAddress component1) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field102.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field102.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field102 get(final SwiftTagListBlock block) {
		...
		return new Field102(t) ;
	}
	
	/**
	 * Gets the first instance of Field102 in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field102 in the given message
	...
	/**
	 * Gets a list of all occurrences of the field Field102 from the given block
	 * an empty list is returned if none found.
	 *
	...
	public static List<Field102> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field102> result = new ArrayList<Field102>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field102 object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field102 fromJson(final String json) {
