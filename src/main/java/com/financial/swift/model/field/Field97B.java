 ...
 * <ul>
 * 		<li>validation pattern: <code>:4!c/[8c]/4!c/35x</code></li>
...
@Generated
public class Field97B extends Field implements Serializable, com.financial.swift.model.field.GenericField {
	/**
	 ...
	 */
	public Field97B(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field97B(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "97B")) {
			throw new IllegalArgumentException("cannot create field 97B from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field97B newInstance(Field97B source) {
		Field97B cp = new Field97B();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field97B.COMPONENTS_PATTERN
	 */
	@Override
	 ...
	 */ 
	public static List<Field97B> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field97B> result = new ArrayList<Field97B>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 4) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 97B");
		}
		if (component == 1) {
