...
/**
 * <strong>SWIFT MT Field 33G</strong>
 * <p>
...
public class Field33G extends Field implements Serializable, CurrencyContainer, AmountContainer {
	 ...
	 */
	public Field33G(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field33G(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "33G")) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field33G.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field33G.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field33G> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field33G> result = new ArrayList<Field33G>(arr.length);
			for (final Tag f : arr) {
