...
/**
 * <strong>SWIFT MT Field 37M</strong>
 * <p>
...
public class Field37M extends Field implements Serializable, AmountContainer {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field37M.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field37M> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field37M> result = new ArrayList<Field37M>(arr.length);
			for (final Tag f : arr) {
