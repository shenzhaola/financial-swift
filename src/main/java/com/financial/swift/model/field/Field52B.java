...
/**
 * <strong>SWIFT MT Field 52B</strong>
 * <p>
 * Model and parser for field 52B of a SWIFT MT message.
 *
...
@Generated
public class Field52B extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field52B(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field52B(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "52B")) {
			throw new IllegalArgumentException("cannot create field 52B from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field52B newInstance(Field52B source) {
		Field52B cp = new Field52B();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field52B.NAME
	 */
	@Override
	...
	public static Field52B get(final SwiftTagListBlock block) {
		...
		return new Field52B(t) ;
	}
	
	/**
	 * Gets the first instance of Field52B in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field52B in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field52B> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field52B from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field52B> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field52B> result = new ArrayList<Field52B>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field52B(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	/**
	 * This method deserializes the JSON data into a Field52B object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field52B fromJson(final String json) {
		Field52B field = new Field52B();
