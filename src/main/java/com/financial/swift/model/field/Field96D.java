...
/**
 * <strong>SWIFT MT Field 96D</strong>
 * <p>
 * Model and parser for field 96D of a SWIFT MT message.
 *
...
@Generated
public class Field96D extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field96D(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field96D(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "96D")) {
			throw new IllegalArgumentException("cannot create field 96D from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field96D newInstance(Field96D source) {
		Field96D cp = new Field96D();
	...
	*/
	 ...
	 */
	public Field96D setNameAndAddressLine1(String component3) {
		setComponent(3, component3);
		return this;
	}
	 ...
	 */
	public Field96D setNameAndAddressLine2(String component4) {
	 ...
	 */
	public Field96D setNameAndAddressLine3(String component5) {
	 ...
	 */
	public Field96D setNameAndAddressLine4(String component6) {
	 ...
	 */
	public Field96D setNameAndAddress(String value) {
		List<String> lines = SwiftParseUtils.getLines(value);
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field96D.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field96D.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field96D get(final SwiftTagListBlock block) {
		...
		return new Field96D(t) ;
	}
	
	/**
	 * Gets the first instance of Field96D in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field96D in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field96D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field96D from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field96D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field96D> result = new ArrayList<Field96D>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field96D(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 6) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 96D");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field96D object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field96D fromJson(final String json) {
		Field96D field = new Field96D();
