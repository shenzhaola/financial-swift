...
/**
 * <strong>SWIFT MT Field 99C</strong>
 * <p>
 * Model and parser for field 99C of a SWIFT MT message.
 *
 ...
 * <ul>
 * 		<li>validation pattern: <code>:4!c//6!n</code></li>
...
@Generated
public class Field99C extends Field implements Serializable, com.financial.swift.model.field.GenericField {
	/**
	 ...
	 */
	public Field99C(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field99C(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "99C")) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field99C.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field99C.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field99C in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field99C in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field99C> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field99C from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field99C> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field99C> result = new ArrayList<Field99C>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field99C object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field99C fromJson(final String json) {
