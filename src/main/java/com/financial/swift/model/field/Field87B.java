...
/**
 * <strong>SWIFT MT Field 87B</strong>
 * <p>
 * Model and parser for field 87B of a SWIFT MT message.
 *
...
@Generated
public class Field87B extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field87B(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field87B(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "87B")) {
			throw new IllegalArgumentException("cannot create field 87B from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field87B newInstance(Field87B source) {
		Field87B cp = new Field87B();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field87B.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field87B.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field87B get(final SwiftTagListBlock block) {
		...
		return new Field87B(t) ;
	}
	
	/**
	 * Gets the first instance of Field87B in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field87B in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field87B> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field87B from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field87B> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field87B> result = new ArrayList<Field87B>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field87B(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 3) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 87B");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field87B object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field87B fromJson(final String json) {
		Field87B field = new Field87B();
