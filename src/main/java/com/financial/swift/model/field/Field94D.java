...
@Generated
public class Field94D extends Field implements Serializable, com.financial.swift.model.field.GenericField {
	/**
	 ...
	 */
	public Field94D(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field94D(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "94D")) {
			throw new IllegalArgumentException("cannot create field 94D from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field94D.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field94D in the given message.
	 ...
	 */ 
	public static List<Field94D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field94D> result = new ArrayList<Field94D>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 3) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 94D");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field94D object.
	...
	public static Field94D fromJson(final String json) {
		...
		if (jsonObject.get("place") != null) {
			field.setComponent3(jsonObject.get("place").getAsString());
		}
		return field;
	}
