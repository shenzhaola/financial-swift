...
/**
 * <strong>SWIFT MT Field 40B</strong>
 * <p>
...
@Generated
public class Field40B extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field40B> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field40B> result = new ArrayList<Field40B>(arr.length);
			for (final Tag f : arr) {
