...
@Generated
public class Field13B extends Field implements Serializable, com.financial.swift.model.field.GenericField {
	/**
	 ...
	 */
	public Field13B(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field13B(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "13B")) {
			throw new IllegalArgumentException("cannot create field 13B from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field13B newInstance(Field13B source) {
		Field13B cp = new Field13B();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field13B.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field13B in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field13B in the given message
	...
	/**
	 * Gets a list of all occurrences of the field Field13B from the given block
	 * an empty list is returned if none found.
	 *
	...
	public static List<Field13B> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field13B> result = new ArrayList<Field13B>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 3) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 13B");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field13B object.
