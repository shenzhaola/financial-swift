...
/**
 * <strong>SWIFT MT Field 83C</strong>
 * <p>
 * Model and parser for field 83C of a SWIFT MT message.
 *
...
public class Field83C extends Field implements Serializable {
	 ...
	 */
	public Field83C(final String value) {
		super(value);
	}
	 ...
	 * @since 7.7
	 */
	public static Field83C newInstance(Field83C source) {
		Field83C cp = new Field83C();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field83C.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field83C.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field83C get(final SwiftTagListBlock block) {
		...
		return new Field83C(t) ;
	}
	
	/**
	 * Gets the first instance of Field83C in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field83C in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field83C> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field83C from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field83C> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field83C> result = new ArrayList<Field83C>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field83C(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 1) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 83C");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field83C object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field83C fromJson(final String json) {
		Field83C field = new Field83C();
