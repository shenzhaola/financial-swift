...
/**
 * <strong>SWIFT MT Field 32F</strong>
 * <p>
 * Model and parser for field 32F of a SWIFT MT message.
 *
...
public class Field32F extends Field implements Serializable, AmountContainer {
	 ...
	 */
	public Field32F(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field32F(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "32F")) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field32F.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field32F.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field32F in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field32F in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field32F> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field32F from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field32F> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field32F> result = new ArrayList<Field32F>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field32F object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field32F fromJson(final String json) {
		Field32F field = new Field32F();
		JsonParser parser = new JsonParser();
		JsonObject jsonObject = (JsonObject) parser.parse(json);
		if (jsonObject.get("unit") != null) {
			field.setComponent1(jsonObject.get("unit").getAsString());
		}
