...
@Generated
public class Field90A extends Field implements Serializable, AmountContainer, com.financial.swift.model.field.GenericField {
	/**
	...
	*/
	 ...
	 * @return the Price from component4 converted to Number or null if cannot be converted
	 */
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field90A.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field90A> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field90A> result = new ArrayList<Field90A>(arr.length);
			for (final Tag f : arr) {
