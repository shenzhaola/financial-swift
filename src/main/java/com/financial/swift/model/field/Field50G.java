...
@Generated
public class Field50G extends Field implements Serializable, BICContainer, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field50G(final String value) {
		super(value);
	}
	...
	public String getValue() {
		...
		if (getComponent2() != null) {
			result.append(com.financial.swift.io.writer.FINWriterVisitor.SWIFT_EOL).append(getComponent2());
		}
	...
	*/
	 ...
	 */
	public Field50G setComponent2(com.financial.swift.model.BIC component2) {
	 ...
	 */
	public Field50G setBIC(com.financial.swift.model.BIC component2) {
   ...
   public String parserPattern() {
	...
	/**
	 * Gets the first instance of Field50G in the given message.
	...
	public static List<Field50G> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field50G> result = new ArrayList<Field50G>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field50G object.
