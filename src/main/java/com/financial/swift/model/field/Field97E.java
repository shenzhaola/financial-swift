...
/**
 * <strong>SWIFT MT Field 97E</strong>
 * <p>
 * Model and parser for field 97E of a SWIFT MT message.
 *
 ...
 * <ul>
 * 		<li>validation pattern: <code>:4!c//34x</code></li>
...
@Generated
public class Field97E extends Field implements Serializable, com.financial.swift.model.field.GenericField {
	/**
	 ...
	 */
	public Field97E(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field97E(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "97E")) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field97E.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field97E.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field97E in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field97E in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field97E> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field97E from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field97E> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field97E> result = new ArrayList<Field97E>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field97E object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field97E fromJson(final String json) {
