...
/**
 * <strong>SWIFT MT Field 59</strong>
 * <p>
...
@Generated
public class Field59 extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field59.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field59> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field59> result = new ArrayList<Field59>(arr.length);
			for (final Tag f : arr) {
