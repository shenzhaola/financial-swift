...
/**
 * <strong>SWIFT MT Field 21G</strong>
 * <p>
...
public class Field21G extends Field implements Serializable {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field21G.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field21G> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field21G> result = new ArrayList<Field21G>(arr.length);
			for (final Tag f : arr) {
