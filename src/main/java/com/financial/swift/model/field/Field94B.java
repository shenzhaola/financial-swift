...
/**
 * <strong>SWIFT MT Field 94B</strong>
 * <p>
...
@Generated
public class Field94B extends Field implements Serializable, com.financial.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field94B.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field94B> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field94B> result = new ArrayList<Field94B>(arr.length);
			for (final Tag f : arr) {
