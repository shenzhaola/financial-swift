...
@Generated
public class Field29A extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	...
	*/
	 ...
	 */
	public Field29A setNarrativeLine1(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field29A setNarrativeLine2(String component2) {
	 ...
	 */
	public Field29A setNarrativeLine3(String component3) {
	 ...
	 */
	public Field29A setNarrativeLine4(String component4) {
	 ...
	 */
	public Field29A setNarrative(String value) {
		List<String> lines = SwiftParseUtils.getLines(value);
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field29A.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field29A> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field29A> result = new ArrayList<Field29A>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 4) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 29A");
		}
		if (component == 1) {
