...
/**
 * <strong>SWIFT MT Field 264</strong>
 * <p>
 * Model and parser for field 264 of a SWIFT MT message.
 *
...
@Generated
public class Field264 extends Field implements Serializable, DateContainer {
	/**
	 ...
	 */
	public Field264(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field264(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "264")) {
			throw new IllegalArgumentException("cannot create field 264 from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field264 newInstance(Field264 source) {
		Field264 cp = new Field264();
	...
	*/
	 ...
	 */
	public Field264 setComponent1(com.financial.swift.model.LogicalTerminalAddress component1) {
	 ...
	 */
	public Field264 setLTAddress(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field264 setLTAddress(com.financial.swift.model.LogicalTerminalAddress component1) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field264.NAME
	 */
	@Override
	...
	public static Field264 get(final SwiftTagListBlock block) {
		...
		return new Field264(t) ;
	}
	
	/**
	 * Gets the first instance of Field264 in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field264 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field264> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field264 from the given block
	 * an empty list is returned if none found.
	 *
	...
	public static List<Field264> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field264> result = new ArrayList<Field264>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 5) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 264");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field264 object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field264 fromJson(final String json) {
		Field264 field = new Field264();
