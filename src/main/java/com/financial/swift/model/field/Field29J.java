...
/**
 * <strong>SWIFT MT Field 29J</strong>
 * <p>
 * Model and parser for field 29J of a SWIFT MT message.
 *
...
public class Field29J extends Field implements Serializable {
	 ...
	 */
	public Field29J(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field29J(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "29J")) {
			throw new IllegalArgumentException("cannot create field 29J from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field29J newInstance(Field29J source) {
		Field29J cp = new Field29J();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field29J.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field29J.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field29J get(final SwiftTagListBlock block) {
		...
		return new Field29J(t) ;
	}
	
	/**
	 * Gets the first instance of Field29J in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field29J in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field29J> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field29J from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field29J> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field29J> result = new ArrayList<Field29J>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field29J(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 2) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 29J");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field29J object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field29J fromJson(final String json) {
		Field29J field = new Field29J();
