...
/**
 * <strong>SWIFT MT Field 172</strong>
 * <p>
...
public class Field172 extends Field implements Serializable, DateContainer {
   ...
   public String parserPattern() {
	...
	/**
	 * Gets the first instance of Field172 in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field172 in the given message
	...
	/**
	 * Gets a list of all occurrences of the field Field172 from the given block
	 * an empty list is returned if none found.
	 *
	...
	public static List<Field172> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field172> result = new ArrayList<Field172>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field172 object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field172 fromJson(final String json) {
