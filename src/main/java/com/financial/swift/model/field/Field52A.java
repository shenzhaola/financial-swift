...
/**
 * <strong>SWIFT MT Field 52A</strong>
 * <p>
...
@Generated
public class Field52A extends Field implements Serializable, BICContainer, com.financial.swift.model.field.MultiLineField {
	/**
	...
	*/
	 ...
	 */
	public Field52A setComponent3(com.financial.swift.model.BIC component3) {
	 ...
	 */
	public Field52A setBIC(com.financial.swift.model.BIC component3) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field52A.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field52A> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field52A> result = new ArrayList<Field52A>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 3) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 52A");
		}
		if (component == 1) {
