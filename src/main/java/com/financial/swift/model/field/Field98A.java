...
/**
 * <strong>SWIFT MT Field 98A</strong>
 * <p>
...
@Generated
public class Field98A extends Field implements Serializable, DateContainer, com.financial.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field98A> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field98A> result = new ArrayList<Field98A>(arr.length);
			for (final Tag f : arr) {
