...
/**
 * <strong>SWIFT MT Field 70C</strong>
 * <p>
...
@Generated
public class Field70C extends Field implements Serializable, com.financial.swift.model.field.GenericField, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field70C(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field70C(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "70C")) {
	...
	*/
	...
	/**
	 * Gets the Narrative as a concatenation of component2 to component5.
   ...
   public String parserPattern() {
	...
	/**
	 * Gets the first instance of Field70C in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field70C in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field70C> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field70C from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field70C> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field70C> result = new ArrayList<Field70C>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field70C object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field70C fromJson(final String json) {
