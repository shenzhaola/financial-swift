...
/**
 * <strong>SWIFT MT Field 33B</strong>
 * <p>
 * Model and parser for field 33B of a SWIFT MT message.
 *
...
@Generated
public class Field33B extends Field implements Serializable, AmountContainer {
	/**
	 ...
	 */
	public Field33B(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field33B(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "33B")) {
			throw new IllegalArgumentException("cannot create field 33B from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field33B newInstance(Field33B source) {
		Field33B cp = new Field33B();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field33B.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field33B.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field33B get(final SwiftTagListBlock block) {
		...
		return new Field33B(t) ;
	}
	
	/**
	 * Gets the first instance of Field33B in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field33B in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field33B> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field33B from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field33B> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field33B> result = new ArrayList<Field33B>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field33B(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 2) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 33B");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field33B object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field33B fromJson(final String json) {
		Field33B field = new Field33B();
