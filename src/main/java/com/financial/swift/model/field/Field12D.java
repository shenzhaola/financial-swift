...
/**
 * <strong>SWIFT MT Field 12D</strong>
 * <p>
...
public class Field12D extends Field implements Serializable {
	...
	*/
	...
	/**
	 * Gets the Option Type (component1).
	 * @return the Option Type from component1
	 */
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field12D.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field12D> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field12D> result = new ArrayList<Field12D>(arr.length);
			for (final Tag f : arr) {
