 ...
 * <ul>
 * 		<li>validation pattern: <code>&lt;DDHHMM&gt;</code></li>
 * 		<li>parser pattern: <code>S</code></li>
 * 		<li>components pattern: <code>P</code></li>
 * </ul>
 *		 
 * <p>
...
public class Field173 extends Field implements Serializable {
	 ...
	 */
	public Field173(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field173(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "173")) {
			throw new IllegalArgumentException("cannot create field 173 from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field173 newInstance(Field173 source) {
		Field173 cp = new Field173();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field173.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field173 in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field173 in the given message
	...
	/**
	 * Gets a list of all occurrences of the field Field173 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field173> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field173> result = new ArrayList<Field173>(arr.length);
			for (final Tag f : arr) {
	...
	protected Map<Integer, String> getComponentMap() {
		...
		result.put(1, "dayTime");
		return result;
	}

	/**
	 * This method deserializes the JSON data into a Field173 object.
	...
	public static Field173 fromJson(final String json) {
		...
		if (jsonObject.get("dayTime") != null) {
			field.setComponent1(jsonObject.get("dayTime").getAsString());
		}
		return field;
	}
