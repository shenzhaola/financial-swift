...
/**
 * <strong>SWIFT MT Field 272</strong>
 * <p>
 * Model and parser for field 272 of a SWIFT MT message.
 *
...
public class Field272 extends Field implements Serializable {
	 ...
	 */
	public Field272(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field272(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "272")) {
			throw new IllegalArgumentException("cannot create field 272 from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field272 newInstance(Field272 source) {
		Field272 cp = new Field272();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field272.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field272.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field272 get(final SwiftTagListBlock block) {
		...
		return new Field272(t) ;
	}
	
	/**
	 * Gets the first instance of Field272 in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field272 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field272> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field272 from the given block
	 * an empty list is returned if none found.
	 *
	...
	public static List<Field272> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field272> result = new ArrayList<Field272>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 2) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 272");
		}
		if (component == 1) {
			//date + time
	...
	/**
	 * This method deserializes the JSON data into a Field272 object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field272 fromJson(final String json) {
		Field272 field = new Field272();
		JsonParser parser = new JsonParser();
		JsonObject jsonObject = (JsonObject) parser.parse(json);
		if (jsonObject.get("timestamp") != null) {
			field.setComponent1(jsonObject.get("timestamp").getAsString());
		}
		if (jsonObject.get("abort") != null) {
			field.setComponent2(jsonObject.get("abort").getAsString());
		}
		return field;
	}
