...
/**
 * <strong>SWIFT MT Field 57A</strong>
 * <p>
 * Model and parser for field 57A of a SWIFT MT message.
 *
...
@Generated
public class Field57A extends Field implements Serializable, BICContainer, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field57A(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field57A(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "57A")) {
			throw new IllegalArgumentException("cannot create field 57A from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field57A newInstance(Field57A source) {
		Field57A cp = new Field57A();
	...
	*/
	 ...
	 */
	public Field57A setComponent3(com.financial.swift.model.BIC component3) {
	 ...
	 */
	public Field57A setBIC(com.financial.swift.model.BIC component3) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field57A.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field57A.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field57A get(final SwiftTagListBlock block) {
		...
		return new Field57A(t) ;
	}
	
	/**
	 * Gets the first instance of Field57A in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field57A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field57A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field57A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field57A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field57A> result = new ArrayList<Field57A>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field57A(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 3) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 57A");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field57A object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field57A fromJson(final String json) {
		Field57A field = new Field57A();
