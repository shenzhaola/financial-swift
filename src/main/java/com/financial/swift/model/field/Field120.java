...
/**
 * <strong>SWIFT MT Field 120</strong>
 * <p>
 * Model and parser for field 120 of a SWIFT MT message.
 *
...
public class Field120 extends Field implements Serializable {
	 ...
	 */
	public Field120(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field120(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "120")) {
			throw new IllegalArgumentException("cannot create field 120 from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field120 newInstance(Field120 source) {
		Field120 cp = new Field120();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field120.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field120.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field120 get(final SwiftTagListBlock block) {
		...
		return new Field120(t) ;
	}
	
	/**
	 * Gets the first instance of Field120 in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field120 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field120> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field120 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field120> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field120> result = new ArrayList<Field120>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field120 object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field120 fromJson(final String json) {
		Field120 field = new Field120();
