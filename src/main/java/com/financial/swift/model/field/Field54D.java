...
/**
 * <strong>SWIFT MT Field 54D</strong>
 * <p>
 * Model and parser for field 54D of a SWIFT MT message.
 *
...
@Generated
public class Field54D extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field54D(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field54D(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "54D")) {
			throw new IllegalArgumentException("cannot create field 54D from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field54D newInstance(Field54D source) {
		Field54D cp = new Field54D();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field54D.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field54D.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field54D get(final SwiftTagListBlock block) {
		...
		return new Field54D(t) ;
	}
	
	/**
	 * Gets the first instance of Field54D in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field54D in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field54D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field54D from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field54D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field54D> result = new ArrayList<Field54D>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field54D(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 6) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 54D");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field54D object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field54D fromJson(final String json) {
		Field54D field = new Field54D();
