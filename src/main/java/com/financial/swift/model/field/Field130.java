...
@Generated
public class Field130 extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field130> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field130> result = new ArrayList<Field130>(arr.length);
			for (final Tag f : arr) {
