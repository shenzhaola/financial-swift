...
public class Field255 extends Field implements Serializable, DateContainer {
	...
	*/
	 ...
	 */
	public Field255 setComponent1(com.financial.swift.model.LogicalTerminalAddress component1) {
	 ...
	 */
	public Field255 setLTAddress(com.financial.swift.model.LogicalTerminalAddress component1) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field255.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field255> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field255> result = new ArrayList<Field255>(arr.length);
			for (final Tag f : arr) {
