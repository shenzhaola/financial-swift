...
/**
 * <strong>SWIFT MT Field 37C</strong>
 * <p>
 * Model and parser for field 37C of a SWIFT MT message.
 *
...
public class Field37C extends Field implements Serializable, DateContainer, AmountContainer {
	 ...
	 */
	public Field37C(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field37C(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "37C")) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field37C.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field37C.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field37C in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field37C in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field37C> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field37C from the given block
	 * an empty list is returned if none found.
	 *
	...
	public static List<Field37C> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field37C> result = new ArrayList<Field37C>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field37C object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field37C fromJson(final String json) {
