...
/**
 * <strong>SWIFT MT Field 98B</strong>
 * <p>
 * Model and parser for field 98B of a SWIFT MT message.
 *
...
@Generated
public class Field98B extends Field implements Serializable, com.financial.swift.model.field.GenericField {
	/**
	 ...
	 */
	public Field98B(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field98B(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "98B")) {
			throw new IllegalArgumentException("cannot create field 98B from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field98B newInstance(Field98B source) {
		Field98B cp = new Field98B();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field98B.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field98B.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field98B get(final SwiftTagListBlock block) {
		...
		return new Field98B(t) ;
	}
	
	/**
	 * Gets the first instance of Field98B in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field98B in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field98B> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field98B from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field98B> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field98B> result = new ArrayList<Field98B>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field98B(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 3) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 98B");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field98B object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field98B fromJson(final String json) {
		Field98B field = new Field98B();
