...
/**
 * <strong>SWIFT MT Field 69C</strong>
 * <p>
 * Model and parser for field 69C of a SWIFT MT message.
 *
 ...
 * <ul>
 * 		<li>validation pattern: <code>:4!c//&lt;DATE4&gt;/4!c</code></li>
 * 		<li>parser pattern: <code>:S//S/S</code></li>
 * 		<li>components pattern: <code>SDS</code></li>
 * </ul>
 *		 
 * <p>
...
@Generated
public class Field69C extends Field implements Serializable, DateContainer, com.financial.swift.model.field.GenericField {
	/**
	 ...
	 */
	public Field69C(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field69C(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "69C")) {
			throw new IllegalArgumentException("cannot create field 69C from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field69C newInstance(Field69C source) {
		Field69C cp = new Field69C();
	...
	*/
	...
	/**
	 * Gets the Date Code (component3).
	 * @return the Date Code from component3
	 */
	 ...
	 */
	public Field69C setDateCode(String component3) {
		setComponent(3, component3);
		return this;
	}
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field69C.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field69C.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field69C get(final SwiftTagListBlock block) {
		...
		return new Field69C(t) ;
	}
	
	/**
	 * Gets the first instance of Field69C in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field69C in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field69C> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field69C from the given block
	 * an empty list is returned if none found.
	 *
	...
	public static List<Field69C> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field69C> result = new ArrayList<Field69C>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 3) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 69C");
		}
		if (component == 1) {
	...
	protected Map<Integer, String> getComponentMap() {
		...
		result.put(2, "date");
		result.put(3, "dateCode");
		return result;
	}

	/**
	 * This method deserializes the JSON data into a Field69C object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field69C fromJson(final String json) {
		Field69C field = new Field69C();
		...
		if (jsonObject.get("dateCode") != null) {
			field.setComponent3(jsonObject.get("dateCode").getAsString());
		}
		return field;
	}
