...
/**
 * <strong>SWIFT MT Field 93D</strong>
 * <p>
...
@Generated
public class Field93D extends Field implements Serializable, AmountContainer, com.financial.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field93D.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field93D> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field93D> result = new ArrayList<Field93D>(arr.length);
			for (final Tag f : arr) {
