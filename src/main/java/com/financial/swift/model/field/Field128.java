...
public class Field128 extends Field implements Serializable, BICContainer {
	...
	*/
	 ...
	 */
	public Field128 setComponent2(com.financial.swift.model.BIC component2) {
	 ...
	 */
	public Field128 setBIC(com.financial.swift.model.BIC component2) {
   ...
   public String parserPattern() {
	...
	public static List<Field128> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field128> result = new ArrayList<Field128>(arr.length);
			for (final Tag f : arr) {
