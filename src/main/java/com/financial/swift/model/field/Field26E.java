...
/**
 * <strong>SWIFT MT Field 26E</strong>
 * <p>
...
public class Field26E extends Field implements Serializable {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field26E.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field26E> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field26E> result = new ArrayList<Field26E>(arr.length);
			for (final Tag f : arr) {
