...
/**
 * <strong>SWIFT MT Field 136</strong>
 * <p>
 * Model and parser for field 136 of a SWIFT MT message.
 *
...
public class Field136 extends Field implements Serializable {
	 ...
	 */
	public Field136(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field136(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "136")) {
			throw new IllegalArgumentException("cannot create field 136 from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field136 newInstance(Field136 source) {
		Field136 cp = new Field136();
	...
	*/
	 ...
	 */
	public Field136 setBroadcastIndicator(String component1) {
		setComponent(1, component1);
		return this;
	}
	/**
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field136.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field136.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field136 get(final SwiftTagListBlock block) {
		...
		return new Field136(t) ;
	}
	
	/**
	 * Gets the first instance of Field136 in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field136 in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field136> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field136 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field136> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field136> result = new ArrayList<Field136>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field136 object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field136 fromJson(final String json) {
		Field136 field = new Field136();
