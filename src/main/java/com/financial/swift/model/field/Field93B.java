...
@Generated
public class Field93B extends Field implements Serializable, AmountContainer, com.financial.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field93B> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field93B> result = new ArrayList<Field93B>(arr.length);
			for (final Tag f : arr) {
