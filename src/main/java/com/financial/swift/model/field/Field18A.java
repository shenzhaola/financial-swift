...
/**
 * <strong>SWIFT MT Field 18A</strong>
 * <p>
...
public class Field18A extends Field implements Serializable {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field18A.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field18A> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field18A> result = new ArrayList<Field18A>(arr.length);
			for (final Tag f : arr) {
