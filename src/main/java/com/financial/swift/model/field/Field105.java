...
public class Field105 extends Field implements Serializable {
	 ...
	 */
	public Field105(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field105(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "105")) {
			throw new IllegalArgumentException("cannot create field 105 from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field105 newInstance(Field105 source) {
		Field105 cp = new Field105();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field105.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field105 in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field105 in the given message
	...
	/**
	 * Gets a list of all occurrences of the field Field105 from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field105> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field105> result = new ArrayList<Field105>(arr.length);
			for (final Tag f : arr) {
	...
	protected List<String> getComponentLabels() {
		...
		result.add("Delivery Monitoring");
		return result;
	}
	...
	protected Map<Integer, String> getComponentMap() {
		...
		result.put(1, "deliveryMonitoring");
		return result;
	}

	/**
	 * This method deserializes the JSON data into a Field105 object.
	...
	public static Field105 fromJson(final String json) {
		...
		if (jsonObject.get("deliveryMonitoring") != null) {
			field.setComponent1(jsonObject.get("deliveryMonitoring").getAsString());
		}
		return field;
	}
