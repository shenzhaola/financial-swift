...
public class Field22A extends Field implements Serializable {
	 ...
	 */
	public Field22A(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field22A(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "22A")) {
			throw new IllegalArgumentException("cannot create field 22A from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field22A newInstance(Field22A source) {
		Field22A cp = new Field22A();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field22A.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field22A in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field22A in the given message
	...
	/**
	 * Gets a list of all occurrences of the field Field22A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field22A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field22A> result = new ArrayList<Field22A>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 1) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 22A");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field22A object.
