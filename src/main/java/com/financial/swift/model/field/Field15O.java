...
public class Field15O extends Field implements Serializable {
	 ...
	 */
	public Field15O(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field15O(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "15O")) {
			throw new IllegalArgumentException("cannot create field 15O from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field15O.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field15O in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field15O in the given message
	...
	/**
	 * Gets a list of all occurrences of the field Field15O from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field15O> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field15O> result = new ArrayList<Field15O>(arr.length);
			for (final Tag f : arr) {
	...
	/**
	 * This method deserializes the JSON data into a Field15O object.
