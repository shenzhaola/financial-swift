...
@Generated
public class Field61 extends Field implements Serializable, AmountContainer, com.financial.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field61> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field61> result = new ArrayList<Field61>(arr.length);
			for (final Tag f : arr) {
