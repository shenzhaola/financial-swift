...
/**
 * <strong>SWIFT MT Field 73A</strong>
 * <p>
 * Model and parser for field 73A of a SWIFT MT message.
 *
 ...
 * <ul>
 * 		<li>validation pattern: <code>35z[$35z]0-5</code></li>
...
@Generated
public class Field73A extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	...
	/**
	 * Constant with the field name 73A
	 */
    public static final String NAME = "73A";
    /**
     * same as NAME, intended to be clear when using static imports
     */
    public static final String F_73A = "73A";
	 ...
	 */
	public Field73A(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field73A(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "73A")) {
			throw new IllegalArgumentException("cannot create field 73A from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field73A newInstance(Field73A source) {
		Field73A cp = new Field73A();
	...
	*/
	 ...
	 */
	public Field73A setComponent1(String component1) {
	 ...
	 */
	public Field73A setNarrativeLine1(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field73A setNarrativeLine2(String component2) {
	 ...
	 */
	public Field73A setNarrativeLine3(String component3) {
	 ...
	 */
	public Field73A setNarrativeLine4(String component4) {
	 ...
	 */
	public Field73A setNarrativeLine5(String component5) {
	 ...
	 */
	public Field73A setNarrativeLine6(String component6) {
	 ...
	 */
	public Field73A setNarrative(String value) {
		List<String> lines = SwiftParseUtils.getLines(value);
	 ...
	 */
	public Field73A setComponent2(String component2) {
		setComponent(2, component2);
		return this;
	}
	/**
	 ...
	 */
	public Field73A setComponent3(String component3) {
		setComponent(3, component3);
		return this;
	}
	/**
	 ...
	 */
	public Field73A setComponent4(String component4) {
		setComponent(4, component4);
		return this;
	}
	/**
	 ...
	 */
	public Field73A setComponent5(String component5) {
		setComponent(5, component5);
		return this;
	}
	/**
	 ...
	 */
	public Field73A setComponent6(String component6) {
		setComponent(6, component6);
		return this;
	}
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field73A.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field73A.COMPONENTS_PATTERN
	 */
	@Override
	 ...
	 */
	public static Field73A get(final SwiftTagListBlock block) {
		...
		return new Field73A(t) ;
	}
	
	/**
	 * Gets the first instance of Field73A in the given message.
	 * @param msg may be empty or null
	 * @return null if not found or msg is empty or null
	 * @see #get(SwiftTagListBlock)
	 */
	public static Field73A get(final SwiftMessage msg) {
	...
	/**
	 * Gets a list of all occurrences of the field Field73A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field73A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field73A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field73A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field73A> result = new ArrayList<Field73A>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field73A(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 6) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 73A");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field73A object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field73A fromJson(final String json) {
		Field73A field = new Field73A();
