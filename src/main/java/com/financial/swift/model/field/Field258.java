...
public class Field258 extends Field implements Serializable, DateContainer {
	...
	*/
	 ...
	 */
	public Field258 setComponent1(com.financial.swift.model.LogicalTerminalAddress component1) {
	 ...
	 */
	public Field258 setLTAddress(com.financial.swift.model.LogicalTerminalAddress component1) {
   ...
   public String parserPattern() {
	...
	public static List<Field258> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field258> result = new ArrayList<Field258>(arr.length);
			for (final Tag f : arr) {
