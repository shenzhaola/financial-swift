...
@Generated
public class Field19A extends Field implements Serializable, CurrencyContainer, AmountContainer, com.financial.swift.model.field.GenericField {
	/**
	 ...
	 */
	public Field19A(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field19A(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "19A")) {
	...
	public void parse(final String value) {
		...
		if (alpha != null && alpha.length() >= 4) {
			//optional letter
			setComponent2(StringUtils.substring(alpha, 0, 1));
			//remaining string
			setComponent3(StringUtils.substring(alpha, 1));
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field19A.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field19A.COMPONENTS_PATTERN
	 */
	@Override
	...
	/**
	 * Gets the first instance of Field19A in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field19A in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field19A> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return java.util.Collections.emptyList();
	...
	/**
	 * Gets a list of all occurrences of the field Field19A from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field19A> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field19A> result = new ArrayList<Field19A>(arr.length);
			for (final Tag f : arr) {
