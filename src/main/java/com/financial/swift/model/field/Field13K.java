...
/**
 * <strong>SWIFT MT Field 13K</strong>
 * <p>
...
@Generated
public class Field13K extends Field implements Serializable, AmountContainer, com.financial.swift.model.field.GenericField {
	/**
   ...
   public String parserPattern() {
	...
	public static List<Field13K> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field13K> result = new ArrayList<Field13K>(arr.length);
			for (final Tag f : arr) {
