...
/**
 * <strong>SWIFT MT Field 71D</strong>
 * <p>
 * Model and parser for field 71D of a SWIFT MT message.
 *
...
@Generated
public class Field71D extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field71D(final String value) {
		super(value);
	}
	...
	*/
	 ...
	 */
	public Field71D setNarrativeLine1(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field71D setNarrativeLine2(String component2) {
	 ...
	 */
	public Field71D setNarrativeLine3(String component3) {
	 ...
	 */
	public Field71D setNarrativeLine4(String component4) {
	 ...
	 */
	public Field71D setNarrativeLine5(String component5) {
	 ...
	 */
	public Field71D setNarrativeLine6(String component6) {
	 ...
	 */
	public Field71D setNarrative(String value) {
		List<String> lines = SwiftParseUtils.getLines(value);
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field71D.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field71D.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field71D get(final SwiftTagListBlock block) {
		...
		return new Field71D(t) ;
	}
	
	/**
	 * Gets the first instance of Field71D in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field71D in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field71D> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field71D from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field71D> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field71D> result = new ArrayList<Field71D>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field71D(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 6) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 71D");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field71D object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field71D fromJson(final String json) {
		Field71D field = new Field71D();
