...
/**
 * <strong>SWIFT MT Field 80C</strong>
 * <p>
 * Model and parser for field 80C of a SWIFT MT message.
 *
...
@Generated
public class Field80C extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
	 ...
	 */
	public Field80C(final String value) {
		super(value);
	}
	 ...
	 * @since 7.7
	 */
	public static Field80C newInstance(Field80C source) {
		Field80C cp = new Field80C();
	...
	*/
	 ...
	 */
	public Field80C setNarrativeLine1(String component1) {
		setComponent(1, component1);
		return this;
	}
	 ...
	 */
	public Field80C setNarrativeLine2(String component2) {
	 ...
	 */
	public Field80C setNarrativeLine3(String component3) {
	 ...
	 */
	public Field80C setNarrativeLine4(String component4) {
	 ...
	 */
	public Field80C setNarrativeLine5(String component5) {
	 ...
	 */
	public Field80C setNarrativeLine6(String component6) {
	 ...
	 */
	public Field80C setNarrative(String value) {
		List<String> lines = SwiftParseUtils.getLines(value);
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field80C.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field80C.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field80C get(final SwiftTagListBlock block) {
		...
		return new Field80C(t) ;
	}
	
	/**
	 * Gets the first instance of Field80C in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field80C in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field80C> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
	...
	/**
	 * Gets a list of all occurrences of the field Field80C from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field80C> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field80C> result = new ArrayList<Field80C>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field80C(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 6) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 80C");
		}
		if (component == 1) {
	...
	/**
	 * This method deserializes the JSON data into a Field80C object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field80C fromJson(final String json) {
		Field80C field = new Field80C();
