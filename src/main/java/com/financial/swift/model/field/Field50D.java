...
@Generated
public class Field50D extends Field implements Serializable, com.financial.swift.model.field.MultiLineField {
	/**
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field50D.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static List<Field50D> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field50D> result = new ArrayList<Field50D>(arr.length);
			for (final Tag f : arr) {
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 6) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 50D");
		}
		if (component == 1) {
