 ...
 * <ul>
 * 		<li>validation pattern: <code>&lt;DC&gt;[&lt;N&gt;]&lt;AMOUNT&gt;12</code></li>
 * 		<li>parser pattern: <code>c[c]N</code></li>
...
public class Field37H extends Field implements Serializable, AmountContainer {
	 ...
	 */
	public Field37H(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field37H(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "37H")) {
	...
	public void parse(final String value) {
		...
		if (toparse != null && toparse.length() > 1) {
			setComponent1(StringUtils.substring(toparse, 0, toparse.length()-1));
			setComponent2(StringUtils.substring(toparse, toparse.length()-1));
		} else {
			setComponent1(toparse);
		}
	...
	*/
	 ...
	 */
	public Field37H setComponent3(java.lang.Number component3) {
	 ...
	 * @param component3 Number with the Rate content to set
	 */
	public Field37H setRate(java.lang.Number component3) {
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field37H.COMPONENTS_PATTERN
	 */
	@Override
	 ...
	 */ 
	public static List<Field37H> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field37H> result = new ArrayList<Field37H>(arr.length);
			for (final Tag f : arr) {
