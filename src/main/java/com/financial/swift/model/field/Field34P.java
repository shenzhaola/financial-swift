...
/**
 * <strong>SWIFT MT Field 34P</strong>
 * <p>
 * Model and parser for field 34P of a SWIFT MT message.
 *
...
public class Field34P extends Field implements Serializable, CurrencyContainer, DateContainer, AmountContainer {
	 ...
	 */
	public Field34P(final String value) {
		super(value);
	}
	 ...
	 * @since 7.8
	 */
	public Field34P(final Tag tag) {
		this();
		if (tag == null) {
			throw new IllegalArgumentException("tag cannot be null.");
		}
		if (!StringUtils.equals(tag.getName(), "34P")) {
			throw new IllegalArgumentException("cannot create field 34P from tag "+tag.getName()+", tagname must match the name of the field.");
		}
		parse(tag.getValue());
	}
	 ...
	 * @since 7.7
	 */
	public static Field34P newInstance(Field34P source) {
		Field34P cp = new Field34P();
   ...
   public String parserPattern() {
	 ...
	 * @return the static value of Field34P.NAME
	 */
	@Override
	 ...
	 * @return the static value of Field34P.COMPONENTS_PATTERN
	 */
	@Override
	...
	public static Field34P get(final SwiftTagListBlock block) {
		...
		return new Field34P(t) ;
	}
	
	/**
	 * Gets the first instance of Field34P in the given message.
	...
	/**
	 * Gets a list of all occurrences of the field Field34P in the given message
	 * an empty list is returned if none found.
	 * @param msg may be empty or null in which case an empty list is returned
	 * @see #getAll(SwiftTagListBlock)
	 */ 
	public static List<Field34P> getAll(final SwiftMessage msg) {
		if (msg == null || msg.getBlock4()==null || msg.getBlock4().isEmpty())
			return java.util.Collections.emptyList();
	...
	/**
	 * Gets a list of all occurrences of the field Field34P from the given block
	 * an empty list is returned if none found.
	 *
	 * @param block may be empty or null in which case an empty list is returned 
	 */ 
	public static List<Field34P> getAll(final SwiftTagListBlock block) {
		if (block == null || block.isEmpty()) {
			return java.util.Collections.emptyList();
		}
		final Tag[] arr = block.getTagsByName(NAME);
		if (arr != null && arr.length > 0) {
			final List<Field34P> result = new ArrayList<Field34P>(arr.length);
			for (final Tag f : arr) {
				result.add( new Field34P(f));
			}
			return result;
		}
		return java.util.Collections.emptyList();
	...
	public String getValueDisplay(int component, Locale locale) {
		if (component < 1 || component > 3) {
			throw new IllegalArgumentException("invalid component number "+component+" for field 34P");
		}
		if (component == 1) {
			//date
	...
	/**
	 * This method deserializes the JSON data into a Field34P object.
	 * @param json JSON structure including tuples with label and value for all field components
	 * @return a new field instance with the JSON data parsed into field components or an empty field id the JSON is invalid
	 * @since 7.10.3
	 * @see Field#fromJson(String)
	 */
	public static Field34P fromJson(final String json) {
		Field34P field = new Field34P();
