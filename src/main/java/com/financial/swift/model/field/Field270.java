...
/**
 * <strong>SWIFT MT Field 270</strong>
 * <p>
...
public class Field270 extends Field implements Serializable {
	...
	*/
	...
	/**
	 * Gets the Login Block (component2).
   ...
   public String parserPattern() {
	...
	public static List<Field270> getAll(final SwiftTagListBlock block) {
		...
		if (arr != null && arr.length > 0) {
			final List<Field270> result = new ArrayList<Field270>(arr.length);
			for (final Tag f : arr) {
