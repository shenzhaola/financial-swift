...
import com.financial.swift.io.parser.SwiftParserConfiguration;
...
import com.financial.swift.model.mt.*;
import com.financial.swift.utils.IMessageVisitor;
...
public class SwiftMessage implements Serializable, JsonSerializable {
	...
	public AbstractMT toMT() {
		...
		if (type == null) {
			...
			className.append("com.financial.swift.model.mt.mt");
