...
public interface SchemeConstantsI {
    ...
    public final static String ISDI = "ISDI";
    public final static String INBR = "INBR";
    public final static String INDX = "INDX";
    public final static String INCA = "INCA";
    public final static String INTM = "INTM";
    public final static String INOU = "INOU";
    public final static String INIM = "INIM";
    public final static String INDA = "INDA";
    ...
    public final static String INMH = "INMH";
    public final static String INPOS = "INPOS";
    public final static String INBA = "INBA";
    public final static String INTP = "INTP";
    public final static String INDM = "INDM";
    public final static String INCE = "INCE";
    public final static String INCO = "INCO";
    public final static String INCR = "INCR";
    public final static String INFA = "INFA";
    public final static String INFO = "INFO";
    public final static String ISAG = "ISAG";
    public final static String INTSEC = "INTSEC";
    public final static String IDFX = "IDFX";
    public final static String IFIX = "IFIX";
