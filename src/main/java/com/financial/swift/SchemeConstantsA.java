...
public interface SchemeConstantsA {
    ...
    public final static String AVSF = "AVSF";
    ...
    public final static String AEXP = "AEXP";
    public final static String AVAL = "AVAL";
    public final static String ALMR = "ALMR";
    public final static String AFFM = "AFFM";
    public final static String AFCA = "AFCA";
    ...
    public final static String ADVD = "ADVD";
    public final static String ALAM = "ALAM";
    public final static String ADEX = "ADEX";
    public final static String AREV = "AREV";
    public final static String ACCTINFO = "ACCTINFO";
    public final static String ACIN = "ACIN";
    public final static String ATAX = "ATAX";
    public final static String AFFB = "AFFB";
    public final static String ADSR = "ADSR";
    public final static String APLI = "APLI";
    public final static String ADDB = "ADDB";
    ...
    public final static String ALLDET = "ALLDET";
    public final static String ALLE = "ALLE";
    public final static String ALUM = "ALUM";
    public final static String ALLOC = "ALLOC";
    public final static String AMEG = "AMEG";
    public final static String ANUG = "ANUG";
